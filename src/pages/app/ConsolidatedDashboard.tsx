    ...
    <div className="container-fluid space-y-8 py-6">
      ...
      >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {
                              domain.metrics.filter((m) => m.health === "good")
                                .length
                            }
                            /{domain.metrics.length} métricas saudáveis
                          </p>
                        </div>
                      </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-sm text-green-700">
                      Receita cresceu 18% com margem saudável de 15.8%,
                      indicando crescimento sustentável
                    </p>
                  </div>
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">
                      Taxa de execução de 76% mostra boa capacidade de entrega
                      das iniciativas
                    </p>
                  </div>
                  ...
                  <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <p className="text-sm text-yellow-700">
                      Domínio estratégico precisa de atenção: taxa de
                      iniciativas concluídas abaixo da meta
                    </p>
                  </div>
                </div>
        ...
        <TabsContent value="domains" className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold">
              {t("dashboard.sections.metrics_by_domain")}
            </h2>
            <Button asChild>
              <Link to="/app/metrics">
        ...
        <TabsContent value="trends" className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold">
              {t("dashboard.sections.trends_analysis")}
            </h2>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium">
                            R${(trend.revenue / 1000000).toFixed(1)}M
                          </p>
                          <p className="text-sm text-muted-foreground">
                            Margem: {trend.margin}%
                          </p>
        ...
        <TabsContent value="insights" className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold">
              {t("dashboard.sections.strategic_insights")}
            </h2>
            <div className="flex gap-2">
              <Button variant="outline" size="sm">
