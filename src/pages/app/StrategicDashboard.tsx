      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Acompanhamento de objetivos e iniciativas estratégicas
          </p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {mockObjectives.slice(0, 3).map((objective) => (
                    <div key={objective.id} className="space-y-2">
                      ...
                      <div className="flex items-center justify-between text-xs text-muted-foreground">
                        <span>
                          {objective.completed}/{objective.initiatives}{" "}
                          iniciativas
                        </span>
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Atenção:</strong> 2 objetivos estão em risco e requerem
                ação imediata da liderança.
