-- =====================================================
-- METRICS LIBRARY UNIFICATION v1.0 - FIXED
-- Based on Cascade.app patterns
-- Fixed: DATE_TRUNC type casting issue
-- =====================================================
...
-- View: Metric values by period with aggregations - FIXED VERSION
    ...
    CASE 
        ...
        WHEN ml.total_is = 'last_value' THEN (
            ...
            WHERE mv2.metric_id = mv.metric_id 
              ...
              AND DATE_TRUNC(ml.group_data_period::text, mv2.period_start) = DATE_TRUNC(ml.group_data_period::text, mv.period_start)
