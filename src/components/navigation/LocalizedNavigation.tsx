...
export const LocalizedNavigation: React.FC<LocalizedNavigationProps> = ({
  ...
  const navigationMap = {
    "pt-BR": [
      ...
      {
        name: t("nav.decision_panel", { defaultValue: "Painel de Decisão" }),
      ...
      {
        name: t("nav.consolidated", { defaultValue: "Consolidado" }),
        href: "/pt-BR/app/consolidado",
        icon: TrendingUp,
      },
      {
        name: t("nav.priorities", { defaultValue: "Prioridades" }),
        href: "/pt-BR/app/prioridades",
        icon: Target,
      },
      {
        name: t("nav.action_plan", { defaultValue: "Plano de Ação" }),
        href: "/pt-BR/app/plano-acao",
        icon: ListChecks,
      },
      {
        name: t("nav.reports", { defaultValue: "Relatórios" }),
        href: "/pt-BR/app/relatorios",
        icon: FileText,
      },
      {
        name: t("nav.data", { defaultValue: "Meus Dados" }),
    ...
    "en-US": [
      ...
      {
        name: t("nav.decision_panel", { defaultValue: "Decision Panel" }),
      ...
      {
        name: t("nav.consolidated", { defaultValue: "Consolidated" }),
        href: "/en-US/app/consolidated",
        icon: TrendingUp,
      },
      {
        name: t("nav.priorities", { defaultValue: "Priorities" }),
        href: "/en-US/app/priorities",
        icon: Target,
      },
      {
        name: t("nav.action_plan", { defaultValue: "Action Plan" }),
        href: "/en-US/app/action-plan",
        icon: ListChecks,
      },
      {
        name: t("nav.reports", { defaultValue: "Reports" }),
        href: "/en-US/app/reports",
        icon: FileText,
      },
      {
        name: t("nav.data", { defaultValue: "My Data" }),
    ...
    "es-ES": [
      ...
      {
        name: t("nav.decision_panel", { defaultValue: "Panel de Decisión" }),
      ...
      {
        name: t("nav.action_plan", { defaultValue: "Plan de Acción" }),
        href: "/es-ES/app/plan-accion",
        icon: ListChecks,
      },
      {
        name: t("nav.reports", { defaultValue: "Informes" }),
        href: "/es-ES/app/informes",
        icon: FileText,
      },
      {
        name: t("nav.data", { defaultValue: "Mis Datos" }),
  ...
  const navigation =
    navigationMap[currentLanguage as keyof typeof navigationMap] ||
    navigationMap["pt-BR"];
