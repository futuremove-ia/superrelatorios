...
export function QuickStatsCard({
  ...
  return (
    <Card className={cn('border-l-4 transition-all hover:shadow-md', colors.border, className)}>
      <CardContent className="p-3">
        <div className="flex items-center gap-3">
          <div className={cn('rounded-lg flex items-center justify-center', colors.bg, sizes.iconWrapper)}>
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-2">
              <span className={cn('text-muted-foreground truncate', sizes.label)}>
                {label}
              </span>
              {trend && (
