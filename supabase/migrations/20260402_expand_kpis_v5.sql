-- Migration script for SuperRelatorios KPIs expansion
-- Version 4: Updated for all production database constraints
-- Date: 2026-04-02

-- Step 1: Drop both constraints
...
-- Step 2: Add new constraints with expanded values
...
-- Step 3: Insert new KPIs (Education, Real Estate, Media - 23 KPIs total)
