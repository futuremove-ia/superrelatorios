-- =====================================================
-- SEED COMPLETO V4 - FINAL CORRIGIDO
-- Sem dependências de auth.users
-- Todas as constraints NOT NULL respeitadas
...
-- 4. DIAGNÓSTICOS (9 - 6 riscos + 3 oportunidades)
...
('DIAG_OPORTUNIDADE_VENDAS', 'Oportunidade de Vendas', 'Sales Opportunity', 'Base de clientes subutilizada sem cross-sell ou upsell', 'Underutilized customer base without cross-sell or upsell', 'Receita potencial não capturada da base existente', 'Uncaptured revenue potential from existing base', 'Falta de estratégia de expansão de conta', 'Lack of account expansion strategy', null, 'commercial', 'low', true),
('DIAG_OPORTUNIDADE_PRECO', 'Oportunidade de Precificação', 'Pricing Opportunity', 'Preços abaixo do mercado e da concorrência', 'Prices below market and competition', 'Margem de lucro abaixo do potencial', 'Profit margin below potential', 'Precificação baseada em custo sem análise de mercado', 'Cost-based pricing without market analysis', null, 'finance', 'low', true),
('DIAG_OPORTUNIDADE_MKT', 'Oportunidade de Marketing', 'Marketing Opportunity', 'Processos manuais de nutrição e conversão de leads', 'Manual lead nurturing and conversion processes', 'Conversão abaixo do potencial e perda de leads', 'Below-potential conversion and lead loss', 'Falta de automação e fluxos de nutrição', 'Lack of automation and nurturing flows', null, 'marketing', 'low', true)
ON CONFLICT (code) DO NOTHING;
...
INSERT INTO radar_items (id, organization_id, type, title, diagnosis_code, impact_code, timeframe_code, complexity_code, severity, domain, status, detected_at, ai_confidence_score, custom_notes) VALUES
('00000000-0000-0000-0000-000000000020', '00000000-0000-0000-0000-000000000001', 'risk', 'Churn de Clientes Premium', 'DIAG_CHURN_RETENCAO', 'IMPACTO_RECEITA', 'TF_30DIAS', 'CX_BAIXA', 'high', 'commercial', 'detected', NOW() - INTERVAL '3 days', 0.85, '5 clientes premium não renovaram nos últimos 30 dias'),
('00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000001', 'risk', 'Margem Comprimida por Custos', 'DIAG_MARGEM_CUSTOS', 'IMPACTO_LUCRO', 'TF_60DIAS', 'CX_MEDIA', 'high', 'finance', 'detected', NOW() - INTERVAL '5 days', 0.92, 'Custos operacionais subiram 15% sem aumento proporcional de receita'),
('00000000-0000-0000-0000-000000000022', '00000000-0000-0000-0000-000000000001', 'risk', 'Inadimplência em Alta', 'DIAG_INADIMPLENCIA_COBRANCA', 'IMPACTO_CAIXA', 'TF_15DIAS', 'CX_BAIXA', 'critical', 'finance', 'acknowledged', NOW() - INTERVAL '7 days', 0.95, 'Inadimplência atingiu 8.5%, acima do limite de 5%'),
('00000000-0000-0000-0000-000000000023', '00000000-0000-0000-0000-000000000001', 'risk', 'Rotatividade de Desenvolvedores', 'DIAG_CLIMA_ORGANIZACIONAL', 'IMPACTO_PRODUTIVIDADE', 'TF_90DIAS', 'CX_ALTA', 'medium', 'people', 'detected', NOW() - INTERVAL '10 days', 0.78, '2 desenvolvedores seniores saíram no último trimestre'),
('00000000-0000-0000-0000-000000000030', '00000000-0000-0000-0000-000000000001', 'opportunity', 'Upsell para Base Existente', 'DIAG_OPORTUNIDADE_VENDAS', 'IMPACTO_RECEITA', 'TF_30DIAS', 'CX_BAIXA', 'medium', 'commercial', 'detected', NOW() - INTERVAL '2 days', 0.82, '60% dos clientes usam apenas 1 serviço - potencial para cross-sell'),
('00000000-0000-0000-0000-000000000031', '00000000-0000-0000-0000-000000000001', 'opportunity', 'Otimização de Preços', 'DIAG_OPORTUNIDADE_PRECO', 'IMPACTO_LUCRO', 'TF_60DIAS', 'CX_MEDIA', 'high', 'finance', 'acknowledged', NOW() - INTERVAL '4 days', 0.88, 'Análise mostra que preços estão 12% abaixo da concorrência'),
('00000000-0000-0000-0000-000000000032', '00000000-0000-0000-0000-000000000001', 'opportunity', 'Automação de Marketing', 'DIAG_OPORTUNIDADE_MKT', 'IMPACTO_CONVERSAO', 'TF_90DIAS', 'CX_MEDIA', 'medium', 'marketing', 'detected', NOW() - INTERVAL '1 day', 0.75, 'Implementar fluxos de nutrição pode aumentar conversão em 25%')
