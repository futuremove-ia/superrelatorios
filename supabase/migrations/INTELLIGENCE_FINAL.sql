-- =====================================================
-- SCRIPT FINAL DE MOTOR DE INTELIGÊNCIA
...
-- =====================================================
-- 2. FUNÇÃO DETECÇÃO AUTOMÁTICA DE DESAFIOS
-- =====================================================
...
BEGIN
    ...
    SELECT 
        ...
        ROUND((0.8 * lc.severity_default * 10))::INT as recommendation_priority
...
-- =====================================================
-- 5. VIEW: RECOMENDAÇÕES PRIORIZADAS
-- =====================================================
...
-- =====================================================
-- 7. VIEW: DASHBOARD ESTRATÉGICO COM INTELIGÊNCIA
-- =====================================================
...
FROM detect_challenges_auto('00000000-0000-0000-0000-000000000001'::UUID, 0.6) dc
LEFT JOIN prioritized_recommendations pr ON true
GROUP BY '00000000-0000-0000-0000-000000000001'::UUID;
...
SELECT * FROM detect_challenges_auto('00000000-0000-0000-0000-000000000001'::UUID, 0.7) LIMIT 3;
