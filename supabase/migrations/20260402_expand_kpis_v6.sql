...
-- Version 5: Domain corrected to only use allowed values
-- Allowed domains: commercial, finance, marketing, operations, people, strategy
-- Date: 2026-04-02
...
-- Insert new KPIs with corrected domain mappings
