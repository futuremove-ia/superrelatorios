-- =====================================================
-- SCRIPT SIMPLES DE SETUP - SEM BLOCOS DO
-- Criação direta das tabelas e KPIs essenciais
-- =====================================================

-- =====================================================
-- 1. CRIAR TABELAS BASE (SQL DIRETO)
-- =====================================================

-- Criar kpi_master_library se não existir
CREATE TABLE IF NOT EXISTS kpi_master_library (
...
-- Criar library_challenges se não existir
...
-- Criar library_goals se não existir
...
-- Criar strategic_templates se não existir
CREATE TABLE IF NOT EXISTS strategic_templates (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Criar library_levers se não existir
CREATE TABLE IF NOT EXISTS library_levers (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Criar library_actions se não existir
...
CREATE INDEX IF NOT EXISTS idx_levers_category ON library_levers(category);
CREATE INDEX IF NOT EXISTS idx_levers_active ON library_levers(is_active);
CREATE INDEX IF NOT EXISTS idx_actions_lever ON library_actions(lever_id);
CREATE INDEX IF NOT EXISTS idx_actions_priority ON library_actions(priority_score);
CREATE INDEX IF NOT EXISTS idx_actions_active ON library_actions(is_active);

-- =====================================================
-- 3. CRIAR TABELA KPI_MASTER_UNIFIED
-- =====================================================
...
-- =====================================================
-- 5. CRIAR ÍNDICES DA TABELA UNIFICADA
-- =====================================================
...
WHERE is_active = true 
GROUP BY domain;
SELECT '=== PRÓXIMO PASSO: STRATEGIC_TEMPLATES_COMPLETION.sql ===' as next_step;
