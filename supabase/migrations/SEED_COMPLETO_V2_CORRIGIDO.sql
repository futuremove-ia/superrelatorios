-- =====================================================
-- SEED COMPLETO V2 - CORRIGIDO
-- Usa ON CONFLICT DO NOTHING para evitar duplicatas
-- Executar no Supabase SQL Editor
-- =====================================================

-- =====================================================
-- 1. BIBLIOTECA DE KPIs (30 KPIs - 6 por domínio)
-- =====================================================
...
-- =====================================================
-- 2. BIBLIOTECA DE CHALLENGES (10 desafios)
-- =====================================================
...
-- =====================================================
-- 3. BIBLIOTECA DE LEVERS (12 alavancas)
-- =====================================================
...
-- =====================================================
-- 4. BIBLIOTECA DE DIAGNÓSTICOS (6 diagnósticos)
-- =====================================================
...
-- =====================================================
-- 7. REPORTS DE EXEMPLO (3 relatórios)
-- =====================================================
...
-- =====================================================
-- 8. RADAR ITEMS (7 itens: 4 riscos + 3 oportunidades)
-- =====================================================
...
('00000000-0000-0000-0000-000000000020', '00000000-0000-0000-0000-000000000001', 'risk', 'Churn de Clientes Premium', 'DIAG_CHURN_RETENCAO', null, null, null, 'high', 8, 'commercial', 'detected', NOW() - INTERVAL '3 days', 0.85, '5 clientes premium não renovaram nos últimos 30 dias'),
('00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000001', 'risk', 'Margem Comprimida por Custos', 'DIAG_MARGEM_CUSTOS', null, null, null, 'high', 9, 'finance', 'detected', NOW() - INTERVAL '5 days', 0.92, 'Custos operacionais subiram 15% sem aumento proporcional de receita'),
('00000000-0000-0000-0000-000000000022', '00000000-0000-0000-0000-000000000001', 'risk', 'Inadimplência em Alta', 'DIAG_INADIMPLENCIA_COBRANCA', null, null, null, 'critical', 10, 'finance', 'acknowledged', NOW() - INTERVAL '7 days', 0.95, 'Inadimplência atingiu 8.5%, acima do limite de 5%'),
('00000000-0000-0000-0000-000000000023', '00000000-0000-0000-0000-000000000001', 'risk', 'Rotatividade de Desenvolvedores', 'DIAG_CLIMA_ORGANIZACIONAL', null, null, null, 'medium', 6, 'people', 'detected', NOW() - INTERVAL '10 days', 0.78, '2 desenvolvedores seniores saíram no último trimestre'),
('00000000-0000-0000-0000-000000000030', '00000000-0000-0000-0000-000000000001', 'opportunity', 'Upsell para Base Existente', null, null, null, null, 'medium', 7, 'commercial', 'detected', NOW() - INTERVAL '2 days', 0.82, '60% dos clientes usam apenas 1 serviço - potencial para cross-sell'),
('00000000-0000-0000-0000-000000000031', '00000000-0000-0000-0000-000000000001', 'opportunity', 'Otimização de Preços', null, null, null, null, 'high', 8, 'finance', 'acknowledged', NOW() - INTERVAL '4 days', 0.88, 'Análise mostra que preços estão 12% abaixo da concorrência'),
('00000000-0000-0000-0000-000000000032', '00000000-0000-0000-0000-000000000001', 'opportunity', 'Automação de Marketing', null, null, null, null, 'medium', 6, 'marketing', 'detected', NOW() - INTERVAL '1 day', 0.75, 'Implementar fluxos de nutrição pode aumentar conversão em 25%')
ON CONFLICT (id) DO NOTHING;

-- =====================================================
-- 9. ACTION ITEMS (6 ações)
-- =====================================================
...
-- =====================================================
-- 10. ORGANIZATION KPIs (36 valores: 12 KPIs × 3 meses)
-- =====================================================
