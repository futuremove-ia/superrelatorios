  ...
  (
    ...
    r.createElement(
      "svg",
      {
        ...
        className: l("lucide", k),
        ...i,
      },
      [
        ...s.map(([o, p]) => r.createElement(o, p)),
        ...(Array.isArray(c) ? c : [c]),
      ],
    ),
);
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ const e = (t, a) => {
  const y = r.forwardRef(({ className: h, ...k }, c) =>
    r.createElement(M, {
      ref: c,
      iconNode: a,
      className: l(`lucide-${n(t)}`, h),
      ...k,
    }),
  );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const H = e("ChartNoAxesColumnIncreasing", [
