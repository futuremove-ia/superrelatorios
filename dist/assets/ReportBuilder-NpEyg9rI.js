...
var He = (e, t, r) =>
  t in e
    ...
    : (e[t] = r);
var se = (e, t, r) => He(e, typeof t != "symbol" ? t + "" : t, r);
import { j as s, u as Ge } from "./vendor-data-DuuuwLk5.js";
import { r as b, i as $e, d as Be } from "./vendor-react-DfYPWlel.js";
import { C as N, b as O, c as I, a as T, d as H } from "./card-CTs8HHrG.js";
import { s as re, B as q, u as P, d as Fe, c as Ye } from "./index-CaCe4Bjh.js";
import {
  a as We,
  g as Ke,
  e as Qe,
...
import { a as es } from "./useReports-7Zge8qVG.js";
import { A as _e, a as ve } from "./alert-DSCI8Aob.js";
import { B as ee } from "./badge-Dl11-P0M.js";
import {
  L as oe,
  g as Se,
  f as pe,
...
import { I as le } from "./input-D9BHdvW6.js";
import { L as Z } from "./label-DVbglEJw.js";
import { T as Ie } from "./textarea-BtgKkYBH.js";
import { m as ke } from "./mockReports-3cW05Ka2.js";
import {
  S as gs,
  a as hs,
  b as fs,
  c as xs,
  d as B,
} from "./select-NitbrCX6.js";
import { D as De, a as _s } from "./DiagnosticSection-h2LLoPD5.js";
import { P as vs } from "./PriorityCard-D6jZ79tp.js";
...
import "./vendor-charts-BOYeCxEi.js";
const Me = b.createContext(void 0),
  ys = ({ children: e }) => {
    const [t, r] = b.useState(1),
      ...
      K = b.useCallback(async () => {
        if (!v && !p && !f) {
          M("Nenhum dado fornecido para análise.");
          return;
        }
        (_(!0), M(null));
        try {
          const Q = v ? v.rows : [{ content: p || f }],
            he = `Objetivo: ${a.description}. Categoria: ${a.category}. Template: ${i}`,
            [fe, xe] = await Promise.all([We(Q, he), Ke(Q, he)]),
            Le = Qe(fe);
          L(Le);
          const Ve = { ...xe, ...Ze(xe.diagnostic) };
          $(Ve);
          const Pe = {
          ...
          (console.error("Erro na análise da IA:", Q),
            M(Q.message || "Erro ao processar dados com IA."));
        } finally {
          _(!1);
        }
      }, [v, p, f, a, i]);
    return s.jsx(Me.Provider, {
      value: {
        step: t,
        setStep: r,
        selectedTemplate: i,
  ...
  bs = ({ fileData: e, onTemplateSelected: t }) => {
    const [r, i] = b.useState(null),
      ...
      { data: o = [] } = Ge({
        ...
        queryFn: async () => {
          const { data: m } = await re.rpc("find_best_template", {
            p_file_structure: {
      ...
      d = b.useCallback(async () => {
        ...
        try {
          const m = p(e.headers),
            l = u(e.headers),
            { data: v } = await re.rpc("find_best_template", {
              p_file_structure: {
      ...
      g = (m, l) => {
        ...
        const E = /^-?\d+\.?\d*$/;
        return v.every((w) => E.test(w.toString()))
          ? "number"
          : v.every((w) =>
      ...
      f = (m, l) => {
        ...
        const v = [],
          y =
            ((R = l.file_structure) == null ? void 0 : R.required_columns) ||
            [],
          E = m.headers.map((S) => S.toLowerCase().trim());
        y.forEach((S) => {
          E.includes(S.name.toLowerCase().trim()) ||
            v.push(`Coluna obrigatória ausente: ${S.name}`);
        });
        const w = ((M = l.file_structure) == null ? void 0 : M.min_rows) || 1;
        m.rows.length < w &&
          v.push(
        ...
        m.rows.length > k &&
          v.push(`Arquivo tem muitas linhas. Máximo permitido: ${k}`);
        const D =
          ((F = l.file_structure) == null ? void 0 : F.file_types) || [];
        return (
          D.length > 0 &&
            !D.includes(m.fileType) &&
            v.push(
              `Tipo de arquivo não permitido. Tipos aceitos: ${D.join(", ")}`,
            ),
          v
        );
      },
      x = (m, l) => {
        ...
        const v = [],
          ...
          E = m.headers.filter((R) => !y.includes(R.toLowerCase()));
        E.length > 0 &&
          v.push(`Colunas não mapeadas serão ignoradas: ${E.join(", ")}`);
        const w = m.rows.filter((R) =>
          R.every((M) => !M || M.toString().trim() === ""),
        );
        return (
      ...
      _ = () => {
        r != null &&
          r.template &&
          t &&
          (re.rpc("increment_template_usage", { p_template_id: r.template.id }),
          t(r.template));
      };
    return s.jsxs("div", {
      className: "space-y-4",
        ...
        s.jsx("div", {
          ...
          children: s.jsx(q, {
            ...
            children: n
              ...
              : s.jsxs(s.Fragment, {
                  children: [
                    s.jsx(oe, { className: "w-4 h-4 mr-2" }),
                ...
                children: [
                  ...
                  r.errors &&
                    ...
                    s.jsxs(_e, {
                      ...
                      children: [
                        s.jsx(ye, { className: "h-4 w-4 text-red-600" }),
                        s.jsxs(ve, {
                  ...
                  r.warnings &&
                    ...
                    s.jsxs(_e, {
                      ...
                      children: [
                        s.jsx(ye, { className: "h-4 w-4 text-yellow-600" }),
                        s.jsxs(ve, {
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsxs("h4", {
                          ...
                          children: [
                            s.jsx(oe, { className: "w-4 h-4 text-gray-600" }),
  ...
  h = (e, t, r = 0, i = 100) => {
    ...
    return isNaN(n) || !isFinite(n)
      ...
      : { value: n, status: "success", warnings: [] };
  },
  z = (e, t) => {
    if (!e || e.length === 0)
      return {
    ...
    switch (
      (r.length < e.length &&
        n.push(`${e.length - r.length} valores inválidos foram ignorados`),
      t)
    ) {
      case "sum":
    ...
    return { value: i, status: "success", warnings: n };
  },
  c = (e, t) => {
    const i =
      e.filter((n) => t[n] !== void 0 && t[n] !== null).length / e.length;
    return i >= 0.9
      ? "high"
      : i >= 0.6
        ? "medium"
  ...
  J = {
    ...
    "TECH-NPS-001": {
      ...
      calculation: (e) => {
        ...
        const n = ((t || 0) / i) * 100,
          a = ((r || 0) / i) * 100;
        return { value: n - a, status: "success", warnings: [] };
      },
  ...
  X = (e) => {
    ...
    return Object.values(J).filter((i) => r.some((n) => i.code.startsWith(n)));
  },
  js = [
    {
      name: "revenue",
  ...
  ws = (e, t) => {
    for (const r of t) {
      if (ue(r.name) === e) return r;
      for (const i of r.aliases) if (ue(i) === e) return r;
    }
  },
  ie = (e, t) => {
    const r = [...js, ...(t ? Ns[t] : [])],
    ...
    return (
      ...
      { mapped: i, unmapped: n, aliasesResolved: a, confidence: p, warnings: o }
    );
  },
  Te = (e, t) => {
    const r = {};
  ...
  Ce = (e, t, r) => {
    ...
    const { critical: i, warning: n, good: a } = t;
...
class Ee {
  constructor(t, r = {}, i = []) {
    ...
    ((this.context = { ...t, period: t.period || "monthly" }),
      (this.options = r),
      (this.kpiLibrary = new Map(i.map((n) => [n.code, n]))));
  }
  calculateSingle(t, r) {
    var _;
    const i = qe(t),
      n = this.kpiLibrary.get(t);
    if (!i)
      return this.createErrorResult(
        t,
        "not_applicable",
        `Fórmula não encontrada para ${t}`,
        (n == null ? void 0 : n.title) || t,
      );
    const a = ie(r, this.context.sector),
      o = Te(
        a,
        i.requiredFields.map((m) => m.name),
      ),
      d = i.requiredFields.map((m) => m.name);
    if (!d.every((m) => o[m] !== void 0)) {
      const m = d.filter((l) => o[l] === void 0);
      return this.createInsufficientDataResult(
        t,
        m,
        (n == null ? void 0 : n.title) || i.description,
      );
    }
    const p = i.calculation(o),
      u = i.getConfidence(o),
      f = (_ = i.getThresholds) == null ? void 0 : _.call(i),
      x = Ce(p.value, f, n == null ? void 0 : n.trend_direction);
    return {
      code: t,
      title: (n == null ? void 0 : n.title) || i.description,
      value: p.value,
      unit: (n == null ? void 0 : n.unit) || "percent",
      status: x,
      trend: "unknown",
      confidence: u,
  ...
  calculateMultiple(t, r) {
    const i = Date.now(),
      n = [];
    for (const a of t) {
      const o = this.calculateSingle(a, r);
      n.push(o);
    }
    return {
      kpis: n,
  ...
  calculateAllForSector(t) {
    ...
    const n = (r ? X(r) : Object.values(J)).map((a) => a.code);
    return this.calculateMultiple(n, t);
  }
  calculateFromMappedData(t, r) {
    ...
    for (const a of r) {
      ...
      const g = Te(
          t,
          o.requiredFields.map((_) => _.name),
        ),
        p = o.requiredFields.map((_) => _.name);
      if (!p.every((_) => g[_] !== void 0)) {
        ...
        i.push(
          this.createInsufficientDataResult(
            a,
            _,
            (d == null ? void 0 : d.title) || o.description,
          ),
        );
        continue;
      }
      const f = o.calculation(g),
        x = (n = o.getThresholds) == null ? void 0 : n.call(o),
        j = Ce(f.value, x, d == null ? void 0 : d.trend_direction);
      i.push({
        code: a,
        title: (d == null ? void 0 : d.title) || o.description,
        value: f.value,
        unit: (d == null ? void 0 : d.unit) || "percent",
        status: j,
        trend: "unknown",
        confidence: o.getConfidence(g),
  ...
  getAvailableKPIs(t) {
    const r = this.context.sector,
      i = r ? X(r) : Object.values(J),
      n = ie(t, r);
    return i
      .map((a) => {
        const o = a.requiredFields.map((u) => u.name),
          d = o.filter((u) => n.mapped[u] !== void 0),
          g = o.length > 0 ? d.length / o.length : 0,
...
const qs = {
  ...
  Cs = () => {
    const [e, t] = b.useState({
      ...
      r = b.useCallback(async (a) => {
        t((o) => ({ ...o, isAnalyzing: !0, error: null }));
        try {
          const { headers: o, rows: d } = a,
          ...
          const { sector: f, confidence: x } = Ts(o, p);
          if (!f) {
            t((C) => ({
              ...C,
              isAnalyzing: !1,
          ...
          const j = {
            ...
            E = ie(u, f),
            w = Object.keys(E.mapped),
            k = new Set();
          m.forEach((C) => {
            C.requiredFields.forEach((F) => k.add(F.name));
          });
          const D = Array.from(k).filter((C) => !w.includes(C)),
            R = Ae(y, f);
          t({
            isAnalyzing: !1,
            data: {
          ...
          const d = o instanceof Error ? o.message : "Erro ao analisar dados";
    ...
    return { ...e, analyze: r, reset: i, setSectorManually: n };
  },
  me = {
  ...
  As = ({ status: e }) => {
    switch (e) {
      case "good":
        return s.jsx(Oe, { className: "h-4 w-4 text-green-500" });
      case "warning":
        return s.jsx(ce, { className: "h-4 w-4 text-yellow-500" });
      case "critical":
        return s.jsx(rs, { className: "h-4 w-4 text-red-500" });
      default:
        return s.jsx(ce, { className: "h-4 w-4 text-gray-400" });
    }
  },
  Rs = ({ kpi: e }) => {
    const { t } = P(),
                ...
                s.jsxs("div", {
                  ...
                  children: [
                    s.jsxs(q, {
                      ...
                      className: "flex-1",
                      children: [
                        s.jsx(pe, { className: "h-4 w-4 mr-2" }),
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsxs(q, {
                          ...
                          variant: "outline",
                          children: [
                            s.jsx(ne, { className: "h-4 w-4 mr-2" }),
                ...
                children: [
                  s.jsxs(O, {
                    ...
                    children: [
                      ...
                      f && s.jsx(Re, { currentSector: a.sector, onSelect: _ }),
                      s.jsx(H, {
                        children: i(
          ...
          children: [
            ...
            s.jsx(N, {
              ...
              children: s.jsxs(O, {
                className: "text-center",
                children: [
                  s.jsx(be, { className: "w-8 h-8 mx-auto mb-2 text-primary" }),
                  s.jsx(I, {
                    className: "text-lg",
                ...
                r &&
                  s.jsx("div", {
                    ...
                    children: s.jsxs("div", {
                      className: "flex items-center gap-2",
                      children: [
                        s.jsx(ae, { className: "w-5 h-5 text-success" }),
                        s.jsxs("p", {
                ...
                children: [
                  ...
                  s.jsxs("div", {
                    ...
                    children: [
                      ...
                      s.jsxs(gs, {
                        value: e.category,
                        onValueChange: (i) => t((n) => ({ ...n, category: i })),
                        children: [
                          s.jsx(hs, {
                            children: s.jsx(fs, {
                              placeholder: r(
              ...
              s.jsxs("div", {
                ...
                children: [
                  ...
                  s.jsx(Ie, {
                    ...
                    value: e.description,
                    onChange: (i) =>
                      t((n) => ({ ...n, description: i.target.value })),
                    placeholder: r(
  ...
  te = [
    { id: 1, text: "Lendo e estruturando dados brutos...", icon: ds },
    { id: 2, text: "Cruzando tendências e métricas...", icon: de },
    { id: 3, text: "Identificando gatilhos de crescimento...", icon: pe },
    { id: 4, text: "Redigindo recomendações estratégicas...", icon: ge },
  ...
  Ds = ({ isProcessing: e }) => {
    ...
    return (
      b.useEffect(() => {
        ...
        const a = setInterval(() => {
          r((o) =>
            o < te.length - 1 ? (n((d) => [...d, te[o].id]), o + 1) : o,
          );
        }, 2500);
        ...
        children: [
          s.jsxs("div", {
            ...
            children: [
              ...
              t.category &&
                s.jsx(ee, { variant: "secondary", children: t.category }),
            ],
          }),
              ...
              children: [
                s.jsx(O, {
                  ...
                  children: s.jsxs(I, {
                    ...
                    children: [
                      s.jsx(oe, { className: "w-5 h-5 text-primary" }),
                        ...
                        children: [
                          ...
                          s.jsx(q, {
                            ...
                            children: a
                              ...
                              : s.jsxs(s.Fragment, {
                                  children: [
                                    s.jsx(de, { className: "mr-2 h-5 w-5" }),
  ...
  Ls = () => {
    const [e] = $e(),
      ...
      ],
      {
        ...
        blocks: w,
        extractedKPIs: k,
        enrichedDiagnostic: D,
        runAIAnalysis: R,
      } = Y(),
      { mutateAsync: M } = es();
    b.useEffect(() => {
      const A = e.get("template");
      if (A) {
        g(A);
        const L =
          templates == null ? void 0 : templates.find((V) => V.id === A);
                      ...
                      children: s.jsx("div", {
                        ...
                        children: n.map((A, L) => {
                          ...
                          return s.jsxs(
                            "div",
                            {
                              className: `flex items-start gap-3 p-3 rounded-lg transition-all ${$ ? "bg-primary/10 border border-primary/20 shadow-sm" : K ? "bg-success/5" : "bg-background/50 text-muted-foreground"}`,
                              children: [
                                s.jsx("div", {
                                  className: `w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium flex-shrink-0 ${K ? "bg-success text-success-foreground" : $ ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`,
                                  children: K
                                    ? s.jsx(ae, { className: "w-4 h-4" })
                                    : V,
                                }),
                                s.jsxs("div", {
            ...
            children: [
              a > 1 &&
                s.jsxs(q, {
                  ...
                  className: "flex-1",
                  children: [
                    s.jsx(we, { className: "mr-2 h-4 w-4" }),
                    i("common.back"),
                  ],
                }),
              a < 5
