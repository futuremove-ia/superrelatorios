import { d as $, u as Z, j as e, B as n } from "./index-BNBvVWlM.js";
import { r as F } from "./router-C2uYhr1z.js";
import { C as l, b as d, c as o, d as m, a as x } from "./card-ChPN7OiP.js";
import { I as p } from "./input-Cqi0Zq_u.js";
import { L as a } from "./label-8Qqntpp1.js";
import { S as B } from "./switch-C_Nhx7N5.js";
import { S as f, a as v, b as N, c as y, d as c } from "./select-CsZXrG8a.js";
import { A as H, a as J, b as O } from "./avatar-B58mbYRW.js";
import { B as V } from "./badge-BPr2YYbt.js";
import { S as g } from "./separator-DzfmiBe7.js";
import {
  a8 as A,
  ac as z,
  ad as I,
          ...
          children: [
            e.jsxs(d, {
              children: [
                ...
                e.jsx(m, { children: s("settings.profile.desc") }),
              ],
            }),
            e.jsxs(x, {
              className: "space-y-6",
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsxs(H, {
                      ...
                      children: [
                        e.jsx(J, { src: "/placeholder-avatar.jpg" }),
                        e.jsx(O, { className: "text-lg", children: "UD" }),
                      ],
                    }),
                    e.jsxs("div", {
                      className: "space-y-2",
          ...
          children: [
            e.jsxs(d, {
              children: [
                ...
                e.jsx(m, { children: s("settings.notifications.desc") }),
              ],
            }),
            e.jsxs(x, {
              className: "space-y-6",
          ...
          children: [
            e.jsxs(d, {
              children: [
                ...
                e.jsx(m, { children: s("settings.appearance.description") }),
              ],
            }),
            e.jsxs(x, {
              className: "space-y-6",
          ...
          children: [
            e.jsxs(d, {
              children: [
                ...
                e.jsx(m, { children: s("settings.security.desc") }),
              ],
            }),
            e.jsxs(x, {
              className: "space-y-6",
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx(V, {
                          variant: r.privacy.twoFactor
                            ? "default"
                            : "secondary",
                          children: r.privacy.twoFactor
                            ? s("common.active")
                            : s("common.inactive"),
                        }),
                        e.jsx(B, {
                          checked: r.privacy.twoFactor,
                          onCheckedChange: (t) =>
                            h((i) => ({
                              ...i,
            ...
            e.jsxs(d, {
              children: [
                e.jsxs(o, {
                  className: "flex items-center gap-2",
                  children: [
                    e.jsx(T, { className: "h-5 w-5 text-primary" }),
                    s("settings.plan.title"),
                  ],
                }),
                e.jsx(m, { children: s("settings.plan.desc") }),
              ],
            }),
            e.jsxs(x, {
              className: "space-y-6",
      ...
      children: [
        ...
        e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("div", { className: "flex-1 min-w-0", children: L() }),
          ],
        }),
      ],
    }),
