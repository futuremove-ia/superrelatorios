...
import { u as l, a as $, B as n, H as w } from "./index-DF8MdIXV.js";
import { S as A, a as P, b as T } from "./sheet-DOdT24WH.js";
import { L as r } from "./vendor-react-Ju9LKgAZ.js";
import { B as h } from "./BrandName-sIh5L74l.js";
import { L as v } from "./LogoIcon-CsykDNA-.js";
import { D as q, a as R, b as E, c as D } from "./dropdown-menu-B3wKDJFI.js";
import {
  G as L,
  C as y,
  M as B,
...
import { C as o, a as f } from "./card-BOBgEvG6.js";
import { P as N } from "./paper-BunoanzT.js";
...
const Q = ({
      ...
      children: [
        e.jsx(R, {
          ...
          children: e.jsxs(n, {
            variant: a,
            size: t,
            className: `flex items-center gap-2 px-3 hover:bg-white/10 transition-all duration-200 ${s}`,
            children: [
              e.jsx(L, { className: "h-4 w-4 text-white/70" }),
              e.jsx("span", {
        ...
        e.jsx(E, {
          ...
          children: g.map((c) =>
            e.jsxs(
              D,
              {
                className: `flex items-center justify-between cursor-pointer focus:bg-primary/10 transition-colors ${x === c.code ? "font-bold text-primary" : "text-foreground/70"}`,
                onClick: () => d(c.code),
                children: [
                  e.jsx("span", { children: c.label }),
                  x === c.code && e.jsx(y, { className: "h-4 w-4 ml-2" }),
                ],
              },
              c.code,
            ),
          ...
          e.jsxs("nav", {
            ...
            children: [
              e.jsx("a", {
                ...
                children: s("landing.nav_links.features"),
              }),
              e.jsx("a", {
                href: "#como-funciona",
                className:
                  "text-muted-foreground hover:text-foreground transition-colors",
                children: s("landing.nav_links.how_it_works"),
              }),
              e.jsx("a", {
                href: "#precos",
                className:
                  "text-muted-foreground hover:text-foreground transition-colors",
                children: s("landing.nav_links.pricing"),
              }),
            ],
          }),
          e.jsxs("div", {
            ...
            children: [
              e.jsx(Q, { variant: "ghost", size: "sm", className: "mr-2" }),
              e.jsx(n, {
                variant: "accent",
                ...
                children: e.jsx(r, {
                  ...
                  children: s("landing.nav_links.cta"),
                }),
              }),
              e.jsxs(A, {
                children: [
                  e.jsx(P, {
                    ...
                    children: e.jsx(n, {
                      ...
                      size: "icon",
                      className: "md:hidden",
                      "aria-label": s("landing.nav_links.aria_menu"),
                      children: e.jsx(B, { className: "h-5 w-5" }),
                    }),
                  }),
                  e.jsx(T, {
                    side: "right",
    ...
    return e.jsxs("section", {
      ...
      children: [
        e.jsx("div", {
          ...
          children: e.jsx("div", { className: "w-full h-full bg-white/5" }),
        }),
        e.jsx("div", {
          className:
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsx(n, {
                    ...
                    asChild: !0,
                    children: e.jsx(r, {
                      to: `/${a.language}/app/reports/new?template=executive-quarterly`,
                      children: s("landing.hero.cta_main"),
                    }),
                  }),
                  e.jsxs(n, {
                    variant: "outline",
                    ...
                    onClick: () => {
                      var t;
                      return (t = document.getElementById("exemplos")) == null
                        ? void 0
                        : t.scrollIntoView({ behavior: "smooth" });
                    },
                    children: [
                      e.jsx(I, { className: "w-5 h-5 mr-2" }),
                      s("landing.hero.cta_sec"),
                    ],
                  }),
                ],
              }),
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs("div", {
                    className: "flex items-center gap-2",
                    children: [
                      e.jsx(m, { className: "w-4 h-4 text-accent" }),
                      e.jsx("span", {
                        children: s("landing.hero.features.clicks"),
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(m, { className: "w-4 h-4 text-accent" }),
                      e.jsx("span", {
                        children: s("landing.hero.features.insights"),
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(m, { className: "w-4 h-4 text-accent" }),
                      e.jsx("span", {
                        children: s("landing.hero.features.security"),
                      }),
                    ],
                  }),
                ],
  ...
  se = () => {
    const { t: s } = l(),
      a = [
        {
          icon: M,
          title: s("landing.features_section.items.context.title"),
          description: s("landing.features_section.items.context.desc"),
        },
        {
          icon: u,
          title: s("landing.features_section.items.decisions.title"),
          description: s("landing.features_section.items.decisions.desc"),
        },
        {
          icon: k,
          title: s("landing.features_section.items.privacy.title"),
          description: s("landing.features_section.items.privacy.desc"),
        },
      ];
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                ...
                children: s("landing.features_section.title", {
                  brand: e.jsx(h, { variant: "default" }),
                }),
              }),
              e.jsx("p", {
                className: "text-xl text-muted-foreground max-w-2xl mx-auto",
                children: s("landing.features_section.subtitle"),
              }),
            ],
          }),
          e.jsx("div", {
      ...
      a = [
        {
          step: 1,
          icon: F,
          title: s("landing.how_it_works.steps.upload.title"),
          description: s("landing.how_it_works.steps.upload.desc"),
        },
        {
          step: 2,
          icon: O,
          title: s("landing.how_it_works.steps.target.title"),
          description: s("landing.how_it_works.steps.target.desc"),
        },
        {
          step: 3,
          icon: b,
          title: s("landing.how_it_works.steps.receive.title"),
          description: s("landing.how_it_works.steps.receive.desc"),
        },
      ];
    return e.jsx("section", {
      id: "como-funciona",
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                className:
                  "text-3xl md:text-4xl font-bold text-foreground mb-4",
                children: s("landing.how_it_works.title"),
              }),
              e.jsx("p", {
                className: "text-xl text-muted-foreground max-w-2xl mx-auto",
                children: s("landing.how_it_works.subtitle"),
              }),
            ],
          }),
          e.jsx("div", {
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h3", {
                ...
                children: s("landing.how_it_works.quick_start.title"),
              }),
              e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx(n, {
                          ...
                          children: e.jsx(r, {
                            ...
                            children: s("landing.how_it_works.quick_start.cta"),
                          }),
                        }),
                      ],
                    }),
  ...
  ae = () => {
    const { t: s } = l(),
      a = {
        title: s("landing.examples.main.title"),
        subtitle: s("landing.examples.main.subtitle"),
        sections: [
          {
            title: s("landing.examples.main.sections.summary.title"),
            icon: _,
            content: s("landing.examples.main.sections.summary.desc"),
          },
          {
            title: s("landing.examples.main.sections.highlights.title"),
            icon: m,
            content: s("landing.examples.main.sections.highlights.desc"),
          },
          {
            title: s("landing.examples.main.sections.analysis.title"),
            icon: C,
            content: s("landing.examples.main.sections.analysis.desc"),
          },
          {
            title: s("landing.examples.main.sections.risks.title"),
            icon: J,
            content: s("landing.examples.main.sections.risks.desc"),
          },
          {
            title: s("landing.examples.main.sections.insights.title"),
            icon: U,
            content: s("landing.examples.main.sections.insights.desc"),
          },
          {
            title: s("landing.examples.main.sections.checklist.title"),
            icon: G,
            content: s("landing.examples.main.sections.checklist.desc"),
          },
        ],
      },
      t = [
        {
          icon: j,
          title: s("landing.examples.others.sales.title"),
          description: s("landing.examples.others.sales.desc"),
          color: "bg-primary",
          template: "sales-monthly",
        },
        {
          icon: z,
          title: s("landing.examples.others.clients.title"),
          description: s("landing.examples.others.clients.desc"),
          color: "bg-accent",
          template: "executive-quarterly",
        },
        {
          icon: V,
          title: s("landing.examples.others.financial.title"),
          description: s("landing.examples.others.financial.desc"),
        ...
        children: [
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                className: "mb-4",
                children: s("landing.examples.title"),
              }),
              e.jsx("p", {
                className: "text-xl text-muted-foreground max-w-3xl mx-auto",
                children: s("landing.examples.subtitle"),
              }),
            ],
          }),
          e.jsxs("div", {
                        ...
                        e.jsx("div", {
                          ...
                          children: e.jsx(n, {
                            ...
                            children: e.jsxs(r, {
                              to: "/app/novo-relatorio",
                              children: [
                                e.jsx(u, { className: "w-5 h-5 mr-2" }),
                                s("landing.examples.main.cta"),
                              ],
                            }),
                          }),
                        }),
                ...
                children: t.map((i, d) =>
                  e.jsxs(
                    o,
                    {
                      ...
                      children: [
                        e.jsx("div", {
                          className: `${i.color} p-6 text-white`,
                          children: e.jsxs("div", {
                            className: "flex items-center gap-3",
                            children: [
                              e.jsx("div", {
                          ...
                          children: e.jsxs("div", {
                            ...
                            children: [
                              e.jsx(n, {
                                ...
                                asChild: !0,
                                children: e.jsxs(r, {
                                  to: `/app/novo-relatorio?template=${i.template}`,
                                  children: [
                                    e.jsx(S, { className: "w-4 h-4 mr-2" }),
                                    s("landing.examples.others.view"),
                                  ],
                                }),
                              }),
                              e.jsx(n, {
            ...
            children: [
              e.jsx(n, {
                ...
                children: e.jsxs(r, {
                  ...
                  children: [
                    e.jsx(u, { className: "w-5 h-5 mr-2" }),
                    s("landing.examples.footer_cta"),
                  ],
                }),
              }),
              e.jsx("p", {
                className: "text-sm text-muted-foreground mt-3",
                children: s("landing.examples.footer_hint"),
              }),
            ],
          }),
        ],
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                className:
                  "text-3xl md:text-4xl font-bold text-foreground mb-4",
                children: s("landing.showcase.title"),
              }),
              e.jsx("p", {
                className: "text-xl text-muted-foreground max-w-2xl mx-auto",
                children: s("landing.showcase.subtitle"),
              }),
            ],
          }),
          e.jsxs("div", {
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("h3", {
                    ...
                    children: s("landing.showcase.portrait.title"),
                  }),
                  e.jsxs(N, {
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("h4", {
                            ...
                            children: s("landing.showcase.portrait.header"),
                          }),
                          e.jsx("p", {
                            className: "text-sm text-muted-foreground",
                            children: s("landing.showcase.portrait.analysis"),
                          }),
                        ],
                      }),
                      e.jsxs("div", {
                      ...
                      e.jsx("div", {
                        ...
                        children: e.jsxs("p", {
                          ...
                          children: [
                            s("landing.showcase.portrait.generated"),
                            " • ",
                            e.jsx(h, { variant: "default" }),
                          ],
                        }),
                      }),
                    ],
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("h3", {
                    className: "text-xl font-semibold text-center",
                    children: s("landing.showcase.landscape.title"),
                  }),
                  e.jsxs(N, {
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs("span", {
                            ...
                            children: [
                              s("landing.showcase.landscape.ai_footer"),
                              " • ",
                              e.jsx(h, { variant: "default" }),
                            ],
                          }),
          ...
          e.jsx("div", {
            ...
            children: e.jsx(n, {
              ...
              children: e.jsxs(r, {
                to: "/app/novo-relatorio",
                children: [
                  e.jsx(b, { className: "w-5 h-5 mr-2" }),
                  s("landing.showcase.cta"),
                ],
              }),
            }),
          }),
  ...
  ne = () => {
    const { t: s } = l(),
      a = [
        {
          icon: Z,
          title: s("landing.benefits.items.speed.title"),
          description: s("landing.benefits.items.speed.desc"),
        },
        {
          icon: j,
          title: s("landing.benefits.items.action.title"),
          description: s("landing.benefits.items.action.desc"),
        },
        {
          icon: u,
          title: s("landing.benefits.items.design.title"),
          description: s("landing.benefits.items.design.desc"),
        },
        {
          icon: _,
          title: s("landing.benefits.items.viz.title"),
          description: s("landing.benefits.items.viz.desc"),
        },
        {
          icon: S,
          title: s("landing.benefits.items.narrative.title"),
          description: s("landing.benefits.items.narrative.desc"),
        },
        {
          icon: K,
          title: s("landing.benefits.items.security.title"),
          description: s("landing.benefits.items.security.desc"),
        },
      ];
    return e.jsx("section", {
      className: "py-20 bg-background",
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                className:
                  "text-3xl md:text-4xl font-bold text-foreground mb-4",
                children: s("landing.benefits.title"),
              }),
              e.jsx("p", {
                className: "text-xl text-muted-foreground max-w-3xl mx-auto",
                children: s("landing.benefits.subtitle"),
              }),
            ],
          }),
          e.jsx("div", {
  ...
  le = () => {
    const { t: s } = l(),
      a = [
        {
          icon: k,
          title: s("landing.trust_section.items.privacy.title"),
          description: s("landing.trust_section.items.privacy.desc"),
          highlight: s("landing.trust_section.items.privacy.tag"),
        },
        {
          icon: z,
          title: s("landing.trust_section.items.support.title"),
          description: s("landing.trust_section.items.support.desc"),
          highlight: s("landing.trust_section.items.support.tag"),
        },
        {
          icon: W,
          title: s("landing.trust_section.items.roadmap.title"),
          description: s("landing.trust_section.items.roadmap.desc"),
          highlight: s("landing.trust_section.items.roadmap.tag"),
        },
      ];
    return e.jsx("section", {
      className: "py-20 bg-secondary/30",
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                className:
                  "text-3xl md:text-4xl font-bold text-foreground mb-4",
                children: s("landing.trust_section.title"),
              }),
              e.jsx("p", {
                className: "text-xl text-muted-foreground max-w-2xl mx-auto",
                children: s("landing.trust_section.subtitle"),
              }),
            ],
          }),
          e.jsx("div", {
  ...
  re = () => {
    const { t: s } = l(),
      a = [
        {
          name: s("landing.pricing.plans.free.name"),
          price: "R$ 0",
          period: s("landing.pricing.plans.free.period"),
          description: s("landing.pricing.plans.free.desc"),
          features: Array.isArray(s("landing.pricing.plans.free.features"))
            ? s("landing.pricing.plans.free.features")
            : [],
          cta: s("landing.pricing.plans.free.cta"),
          highlighted: !1,
          href: "/app/novo-relatorio",
        },
        {
          name: s("landing.pricing.plans.pro.name"),
          price: "R$ 59",
          period: s("landing.pricing.plans.pro.period"),
          description: s("landing.pricing.plans.pro.desc"),
          features: Array.isArray(s("landing.pricing.plans.pro.features"))
            ? s("landing.pricing.plans.pro.features")
            : [],
          cta: s("landing.pricing.plans.pro.cta"),
          highlighted: !0,
          href: "/app/novo-relatorio",
        },
        {
          name: s("landing.pricing.plans.business.name"),
          price: "R$ 149",
          period: s("landing.pricing.plans.business.period"),
          description: s("landing.pricing.plans.business.desc"),
          features: Array.isArray(s("landing.pricing.plans.business.features"))
            ? s("landing.pricing.plans.business.features")
            : [],
          cta: s("landing.pricing.plans.business.cta"),
          highlighted: !1,
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                className:
                  "text-3xl md:text-4xl font-bold text-foreground mb-4",
                children: s("landing.pricing.title"),
              }),
              e.jsx("p", {
                className:
                  "text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto",
                children: s("landing.pricing.subtitle"),
              }),
            ],
          }),
          e.jsx("div", {
            ...
            children: a.map((t, i) =>
              e.jsxs(
                o,
                {
                  className: `p-6 sm:p-8 border-2 transition-all duration-300 ${t.highlighted ? "border-accent bg-card shadow-xl relative" : "border-border bg-card hover:border-primary/20 hover:shadow-lg"}`,
                  children: [
                    t.highlighted &&
                      e.jsx("div", {
                        className:
                          "absolute -top-3 left-1/2 -translate-x-1/2 bg-accent text-accent-foreground text-xs font-semibold px-3 py-1 rounded-full",
                        children: s("landing.pricing.recommended"),
                      }),
                    e.jsxs("div", {
                    ...
                    e.jsx(n, {
                      ...
                      size: "lg",
                      asChild: !0,
                      children: e.jsx(r, { to: t.href, children: t.cta }),
                    }),
                  ],
                },
                i,
          ...
          children: e.jsxs("div", {
            ...
            children: [
              e.jsx("h2", {
                ...
                children: s("landing.cta.title"),
              }),
              e.jsx("p", {
                className: "text-xl text-white/90 mb-8 max-w-2xl mx-auto",
                children: s("landing.cta.subtitle", {
                  brand: e.jsx(h, { variant: "default" }),
                }),
              }),
              e.jsx(n, {
                ...
                children: [
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(m, { className: "w-4 h-4 text-accent" }),
                      e.jsx("span", {
                        children: s("landing.cta.features.no_card"),
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(m, { className: "w-4 h-4 text-accent" }),
                      e.jsx("span", {
                        children: s("landing.cta.features.cancel_anytime"),
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(m, { className: "w-4 h-4 text-accent" }),
                      e.jsx("span", {
                        children: s("landing.cta.features.fast_setup"),
                      }),
                    ],
                  }),
                ],
      ...
      children: e.jsxs("div", {
        ...
        children: [
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(v, { size: "sm", variant: "white" }),
                      e.jsx(h, { variant: "on-dark" }),
                    ],
                  }),
                  e.jsx("p", {
                    className: "text-sm text-white/70 leading-relaxed",
                    children: s("landing.footer.mission"),
                  }),
                ],
              }),
              e.jsxs("div", {
                children: [
                  e.jsx("h4", {
                    ...
                    children: s("landing.footer.sections.product.title"),
                  }),
                  e.jsxs("ul", {
              ...
              e.jsxs("div", {
                children: [
                  e.jsx("h4", {
                    className: "font-semibold mb-4",
                    children: s("landing.footer.sections.support.title"),
                  }),
                  e.jsxs("ul", {
                    className: "space-y-3 text-sm text-white/70",
                    children: [
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.support.help"),
                        }),
                      }),
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.support.docs"),
                        }),
                      }),
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.support.status"),
                        }),
                      }),
                      e.jsx("li", {
                        children: e.jsx("a", {
              ...
              e.jsxs("div", {
                children: [
                  e.jsx("h4", {
                    className: "font-semibold mb-4",
                    children: s("landing.footer.sections.legal.title"),
                  }),
                  e.jsxs("ul", {
                    className: "space-y-3 text-sm text-white/70",
                    children: [
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.legal.privacy"),
                        }),
                      }),
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.legal.terms"),
                        }),
                      }),
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.legal.security"),
                        }),
                      }),
                      e.jsx("li", {
                        children: e.jsx("a", {
                          ...
                          className:
                            "hover:text-white transition-colors py-1 inline-block",
                          children: s("landing.footer.sections.legal.cookies"),
                        }),
                      }),
                    ],
                  }),
          ...
          e.jsx("div", {
            ...
            children: s("landing.footer.copyright", {
              year: a,
              brand: e.jsx(h, { variant: "on-dark" }),
            }),
          }),
        ],
      }),
  ...
  oe = ({ title: s, description: a, canonicalUrl: t }) => {
    const { t: i } = l(),
      d = i("brand.super") + i("brand.reports"),
      x = `${d} - Relatórios Inteligentes em 3 Cliques`,
      g =
    ...
    return e.jsxs(w, {
      children: [
        e.jsx("title", { children: p }),
        e.jsx("meta", { name: "description", content: c }),
        e.jsx("meta", { property: "og:type", content: "website" }),
        e.jsx("meta", { property: "og:title", content: p }),
        e.jsx("meta", { property: "og:description", content: c }),
        e.jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
        e.jsx("meta", { name: "twitter:title", content: p }),
        e.jsx("meta", { name: "twitter:description", content: c }),
        t && e.jsx("link", { rel: "canonical", href: t }),
      ],
    });
  },
  xe = () => {
    const { t: s } = l(),
      a = s("brand.super") + s("brand.reports"),
      t = {
  ...
  ye = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [
        e.jsx(oe, {
          title: s("seo.index_title"),
          description: s("seo.index_desc"),
        }),
        e.jsx(xe, {}),
        e.jsx(X, {}),
        e.jsx(ee, {}),
