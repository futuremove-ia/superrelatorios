...
import { l as de, j as t, d as $, B as Ne } from "./index-D2W-YaK1.js";
import { C as B, b as Ae, c as we, d as Ce, a as Oe } from "./card-38iTbfya.js";
import {
  c as Pe,
  $ as Se,
  J as Ee,
...
import {
  ...
  r as Ue,
  s as qe,
} from "./PieChart-CyyypTNR.js";
import { b as h, r as xe } from "./vendor-BgR6OOld.js";
import { B as Je } from "./badge-BXC9IUk2.js";
var Ze = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"],
  Qe = ["key"],
  fe;
function z(e) {
...
C(D, "renderDotItem", function (e, a) {
  ...
  if (h.isValidElement(e)) r = h.cloneElement(e, a);
    ...
    var n = de("recharts-area-dot", typeof e != "boolean" ? e.className : ""),
      s = a.key,
      i = ve(a, Qe);
    r = h.createElement(He, R({}, i, { key: s, className: n }));
  }
  return r;
});
var lt = We({
                  ...
                  children: [
                    ...
                    i.change &&
                      t.jsxs("span", {
                        ...
                        children: [
                          l && t.jsx(Pe, { className: "h-3 w-3 mr-0.5" }),
                          c && t.jsx(Se, { className: "h-3 w-3 mr-0.5" }),
                          i.change,
                        ],
                      }),
                  ],
    ...
    return t.jsxs("div", {
      ...
      children: [
        t.jsxs("h3", {
          ...
          children: [
            t.jsx(Ee, { className: "h-5 w-5 text-primary" }),
            e.content.title,
          ],
        }),
        t.jsx("div", {
            ...
            t.jsxs("div", {
              ...
              children: [
                t.jsx("u", {
                  ...
                  children: t.jsx(Be, { className: "h-4 w-4" }),
                }),
                t.jsx("h3", {
