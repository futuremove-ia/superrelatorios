...
import { C as i, b as m, c as n, d as u, a as o } from "./card-CTs8HHrG.js";
import { B as x } from "./badge-Dl11-P0M.js";
import { u as g, B as h } from "./index-CaCe4Bjh.js";
import { t as b, T as f, O as j, Z as p } from "./vendor-utils-CGetvm_l.js";
const T = ({ priority: s, onAction: t, onValidate: l }) => {
  const { t: a } = g(),
    d = (r) => {
      switch (r) {
        case "high":
    ...
    c = (r) => {
      switch (r) {
        ...
        case "validated":
          return e.jsx(j, { className: "h-4 w-4 text-green-500" });
        case "dismissed":
          return e.jsx(f, { className: "h-4 w-4 text-slate-400" });
      }
    };
  return e.jsxs(i, {
    ...
    children: [
      e.jsxs(m, {
        ...
        children: [
          ...
          e.jsx(u, { className: "line-clamp-2", children: s.explanation }),
        ],
      }),
      e.jsx(o, {
        className: "pt-0",
