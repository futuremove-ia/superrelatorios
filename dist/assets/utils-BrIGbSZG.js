 ...
 * See the LICENSE file in the root directory of this source tree.
 */ const r = (t, e) => {
  const a = D.forwardRef(({ className: n, ...s }, c) =>
    D.createElement(U, {
      ref: c,
      iconNode: e,
      className: _(`lucide-${X(t)}`, n),
      ...s,
    }),
  );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const Ct = r("ChartNoAxesColumnIncreasing", [
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const Wa = r("Minus", [["path", { d: "M5 12h14", key: "1ays0h" }]]);
/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Z(t, e) {
  ...
  const n = a.getDate(),
    s = m(t, a.getTime());
  s.setMonth(a.getMonth() + e + 1, 0);
  const c = s.getDate();
  return n >= c ? s : (a.setFullYear(s.getFullYear(), s.getMonth(), n), a);
}
const Y = 6048e5,
  J = 864e5;
let $ = {};
  ...
  oe = (t, e, a) => {
    ...
    return (
      typeof s == "string"
        ...
        : e === 1
          ? (n = s.one)
          : (n = s.other.replace("{{count}}", e.toString())),
      a != null && a.addSuffix
...
const ke = {
  ...
  be = {
    ...
    month: C({ values: pe, defaultWidth: "wide" }),
    day: C({ values: ge, defaultWidth: "wide" }),
    dayPeriod: C({
      values: Me,
      defaultWidth: "wide",
      formattingValues: we,
...
function O(t) {
  return (e, a = {}) => {
    ...
    const i = c[0],
      ...
      u = Array.isArray(d) ? Ce(d, (p) => p.test(i)) : ve(d, (p) => p.test(i));
    let y;
...
function G(t, e) {
  ...
  const a = o(t),
    ...
    c =
      ...
      ((p = (l = e == null ? void 0 : e.locale) == null ? void 0 : l.options) ==
      null
        ? void 0
        : p.firstWeekContainsDate) ??
      s.firstWeekContainsDate ??
      ((v = (b = s.locale) == null ? void 0 : b.options) == null
        ? void 0
...
function _e(t, e) {
  ...
  const a = P(),
    ...
    s = G(t, e),
    c = m(t, 0);
  return (c.setFullYear(s, 0, n), c.setHours(0, 0, 0, 0), w(c, e));
}
function Re(t, e) {
  const a = o(t),
    n = +w(a, e) - +_e(a, e);
...
const g = {
  ...
  j = {
    ...
    w: function (t, e, a, n) {
      const s = Re(t, n);
      return e === "wo" ? a.ordinalNumber(s, { unit: "week" }) : h(s, e.length);
    },
    I: function (t, e, a) {
      const n = Ve(t);
...
function N(t, e = "") {
  const a = t > 0 ? "-" : "+",
    ...
    s = Math.trunc(n / 60),
    c = n % 60;
  return c === 0 ? a + String(s) : a + String(s) + e + h(c, 2);
}
function E(t, e) {
...
const V = (t, e) => {
  ...
  Be = (t, e) => {
    ...
    return c.replace("{{date}}", V(n, e)).replace("{{time}}", I(s, e));
  },
  Ge = { p: I, P: Be },
  Ie = /^D+$/,
  Xe = /^Y+$/,
...
function Je(t, e, a) {
  const n = $e(t, e, a);
  if ((console.warn(n), Qe.includes(t))) throw new RangeError(n);
}
function $e(t, e, a) {
...
function P1(t, e, a) {
  var l, p, b, v, z, A, H, F;
  const n = P(),
    s = (a == null ? void 0 : a.locale) ?? n.locale ?? Ne,
    c =
      (a == null ? void 0 : a.firstWeekContainsDate) ??
      ((p = (l = a == null ? void 0 : a.locale) == null ? void 0 : l.options) ==
      null
        ? void 0
        : p.firstWeekContainsDate) ??
    ...
    i =
      ...
      ((A = (z = a == null ? void 0 : a.locale) == null ? void 0 : z.options) ==
      null
        ? void 0
        : A.weekStartsOn) ??
      n.weekStartsOn ??
      ((F = (H = n.locale) == null ? void 0 : H.options) == null
        ? void 0
        : F.weekStartsOn) ??
      0,
    d = o(t);
  ...
  s.localize.preprocessor && (u = s.localize.preprocessor(d, u));
  const y = { firstWeekContainsDate: c, weekStartsOn: i, locale: s };
  return u
    .map((k) => {
...
function st(t) {
  const e = o(t),
    ...
    n = e.getMonth(),
    s = m(t, 0);
  return (s.setFullYear(a, n + 1, 0), s.setHours(0, 0, 0, 0), s.getDate());
}
function q1(t) {
...
function A1(t, e) {
  ...
  const i = st(c);
  return (a.setMonth(e, Math.min(s, i)), a);
}
function H1(t, e) {
  const a = o(t);
