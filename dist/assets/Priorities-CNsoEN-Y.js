...
import { u as K } from "./useQuery-lOGkLDRM.js";
import { B as S } from "./badge-BRPjZ132.js";
import { K as u } from "./kpi-card-2KiS0ncW.js";
import { I as F } from "./input-CPyHEH_p.js";
import { T as G, a as R, b as C } from "./tabs-CCpnioNr.js";
import { P as Z } from "./PriorityCard-B7YAkcVC.js";
import {
  D as H,
  a as J,
  b as Q,
...
import { S as X } from "./slider-DrVEWdQs.js";
import { L as Y } from "./label-DRsHM5zl.js";
import {
  a4 as ee,
  b as v,
  q as se,
...
import { E as de, g as ne } from "./supabaseBusinessService-tIav5a1W.js";
import { u as ce } from "./useCurrentOrganization-QE33f3lM.js";
import "./router-Db_Yswnp.js";
import "./card-Ekw6AZkO.js";
        ...
        children: [
          e.jsxs(Q, {
            children: [
              ...
              e.jsx($, { className: "text-2xl", children: s.title }),
              e.jsx(U, {
  ...
  Ie = () => {
    ...
    const m = d.useMemo(
      ...
      A = (t, j) => {
        (r((E) =>
          E.map((b) =>
            b.id === t ? { ...b, status: "validated", score: j } : b,
          ),
        ),
          n({
