import { s as O, j as e, B as i, u as re } from "./index-BNBvVWlM.js";
import { r as v, L as b, R as le } from "./router-C2uYhr1z.js";
import { C as j, b as g, c as f, a as p } from "./card-ChPN7OiP.js";
import { B as y } from "./badge-BPr2YYbt.js";
import { K as ne } from "./kpi-card-DRAZrA7z.js";
import { P as ie } from "./progress-s8Y2MQeY.js";
import { S as M, a as R, b as A, c as L, d as x } from "./select-CsZXrG8a.js";
import { I as ce } from "./input-Cqi0Zq_u.js";
import { S as m } from "./skeleton-DsGlvn4y.js";
import { A as de, a as oe } from "./alert-DWgHhQNS.js";
import { u as he } from "./useMetricsLibrary-DQHbUNSS.js";
import { u as H } from "./useQuery-Dm69hO1k.js";
import {
  E as P,
  a0 as xe,
  T as k,
...
const De = (t) =>
    H({
      ...
      queryFn: async () => {
        const { data: n, error: r } = await O.from("latest_metric_values")
          .select("*")
  ...
  $e = (t) =>
    H({
      ...
      queryFn: async () => {
        const { data: n, error: r } = await O.from(
  ...
  Qe = () => {
    const { t } = re(),
      ...
      { analytics: Re, isLoading: Y } = $e("default-org"),
      Z = G || X || Y,
      Q = [
        {
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsxs(M, {
                      ...
                      onValueChange: r,
                      children: [
                        e.jsx(R, { className: "w-40", children: e.jsx(A, {}) }),
                        e.jsxs(L, {
                          children: [
                            e.jsx(x, {
                              value: "all",
