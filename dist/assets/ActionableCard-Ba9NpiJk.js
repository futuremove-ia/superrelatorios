...
import { c as t, u as y, B as b } from "./index-DF8MdIXV.js";
import { a as w } from "./DomainTag-BVQlWMxA.js";
import {
  l as N,
  bu as C,
  bv as T,
...
import { C as z, b as O, a as E } from "./card-BOBgEvG6.js";
...
const S = {
        ...
        i &&
          e.jsx("span", {
            className: t(
              ...
              ((m = g[r.color]) == null ? void 0 : m.color) ||
  ...
  Q = ({ item: a, onAddToPlan: i, onDismiss: o, onClick: d, className: c }) => {
    y();
    const r = a.type === "risk",
      s = a.alert,
      l = r
    ...
    return e.jsxs(z, {
      className: t(
        ...
        "border-l-4",
        r ? "border-l-red-500" : "border-l-emerald-500",
        c,
      ),
      children: [
        e.jsx(O, {
                ...
                children: [
                  e.jsx("div", {
                    className: t(
                      ...
                      r ? "bg-red-100" : "bg-emerald-100",
                    ),
                    children: e.jsx(x, {
                      className: t(
                        "h-5 w-5",
                        r ? "text-red-600" : "text-emerald-600",
                      ),
                    }),
                  }),
                  e.jsxs("div", {
                  ...
                  children: [
                    e.jsxs("div", {
                      className:
                        "text-xs font-bold text-foreground mb-1 flex items-center gap-1",
                      children: [
                        e.jsx(I, { className: "h-3.5 w-3.5 text-red-500" }),
                        "Efeito no Negócio",
                      ],
                    }),
                    e.jsx("p", {
