import { c as J } from "./vendor-utils-CGetvm_l.js";
import { c as Ai, g as oe, r as L, b as S } from "./vendor-react-DfYPWlel.js";
var Dm = Array.isArray,
  Fe = Dm,
  Nm = typeof Ai == "object" && Ai && Ai.Object === Object && Ai,
  Gh = Nm,
  Rm = Gh,
...
var Qh = I0,
  ...
  R0 = Qh;
function L0(e, t) {
  return k0(e) ? e : D0(e, t) ? [e] : N0(R0(e));
}
var ed = L0,
  B0 = rn;
function F0(e) {
...
function U0(e, t) {
  t = W0(t, e);
  for (var r = 0, n = t.length; e != null && r < n; ) e = e[z0(t[r++])];
...
var V0 = _t,
  ...
  Z0 = "[object String]";
function J0(e) {
  return typeof e == "string" || (!X0(e) && Y0(e) && V0(e) == Z0);
}
var Q0 = J0;
const ir = oe(Q0);
var rd = { exports: {} },
...
var rx = rd.exports,
  ...
  ax = "[object Number]";
function ox(e) {
  return typeof e == "number" || (ix(e) && nx(e) == ax);
}
var id = ox;
const ux = oe(id);
var cx = id;
...
var Ie = function (t) {
  ...
  Zt = function (t) {
    return ir(t) && t.indexOf("%") === t.length - 1;
  },
  R = function (t) {
    return ux(t) && !cn(t);
  },
...
var vx = ["viewBox", "children"],
  ...
  No = { svg: vx, polygon: tl, polyline: tl },
  Kc = [
  ...
  Gc = function e(t) {
    ...
    return (
      L.Children.forEach(t, function (n) {
        Y(n) ||
          (rx.isFragment(n) ? (r = r.concat(e(n.props.children))) : r.push(n));
      }),
      (Ro = r),
      (il = t),
      r
...
var al = function (t) {
  ...
  Ox = function (t) {
    return t && t.type && ir(t.type) && wx.indexOf(t.type) >= 0;
  },
  Ax = function (t) {
  ...
  Sx = function (t, r, n, i) {
    var a,
      o = (a = No == null ? void 0 : No[i]) !== null && a !== void 0 ? a : [];
    return (
      r.startsWith("data-") ||
      (!V(t) && ((i && o.includes(r)) || yx.includes(r))) ||
      (n && Kc.includes(r))
    );
  },
  H = function (t, r, n) {
    ...
    return (
      Object.keys(i).forEach(function (o) {
        var u;
        Sx((u = i) === null || u === void 0 ? void 0 : u[o], o, r, n) &&
          (a[o] = i[o]);
      }),
      a
    );
...
function Nx(e, t, r) {
  var n = e.length;
  return ((r = r === void 0 ? n : r), !t && r >= n ? e : Dx(e, t, r));
}
var Rx = Nx,
  Lx = "\\ud800-\\udfff",
  Bx = "\\u0300-\\u036f",
...
var Vx = Gx,
  ...
  ld = tw + "?",
  fd = "[" + Qx + "]?",
  nw = "(?:" + rw + "(?:" + [ud, cd, sd].join("|") + ")" + fd + ld + ")*",
  iw = fd + ld + nw,
  aw = "(?:" + [ud + vu + "?", vu, cd, sd, ew].join("|") + ")",
  ow = RegExp(yu + "(?=" + yu + ")|" + aw + iw, "g");
function uw(e) {
  return e.match(ow) || [];
}
var cw = uw,
...
function gw(e) {
  return function (t) {
    t = mw(t);
    var r = vw(t) ? yw(t) : void 0,
      n = r ? r[0] : t.charAt(0),
      i = r ? dw(r, 1).join("") : t.slice(1);
    return n[e]() + i;
  };
}
var bw = gw,
...
function Jw() {
  var e = se([]),
    ...
    n = Yw;
  function i(a) {
    var o = Array.from(e.apply(this, arguments), Zw),
      u,
      c = o.length,
      s = -1,
      f;
...
var Ve = 32,
  Jc = (function (e) {
    function t() {
      return (hO(this, t), yO(this, t, arguments));
    }
    return (
      bO(t, e),
      vO(t, [
...
function Gi(e) {
  var t = -1,
    r = e == null ? 0 : e.length;
  for (this.__data__ = new GO(); ++t < r; ) this.add(e[t]);
}
Gi.prototype.add = Gi.prototype.push = VO;
Gi.prototype.has = XO;
var Cd = Gi;
function YO(e, t) {
...
function n1(e, t, r, n, i, a) {
  ...
  for (a.set(e, t), a.set(t, e); ++l < u; ) {
    ...
    if (h) {
      if (
        !QO(t, function (b, w) {
          if (!e1(h, w) && (v === b || i(v, b, r, n, a))) return h.push(w);
        })
      ) {
        p = !1;
        break;
...
function $1(e, t, r, n, i, a, o) {
  switch (r) {
    ...
    case O1:
      var c = n & d1;
      if ((u || (u = h1), e.size != t.size && !c)) return !1;
      var s = o.get(e);
      if (s) return s == t;
      ((n |= v1), o.set(e, t));
      var f = f1(u(e), u(t), n, i, a, o);
      return (o.delete(e), f);
    case S1:
...
var Y1 = X1,
  ...
  Z1 = $t,
  Rd = Object.prototype,
  J1 = Rd.hasOwnProperty,
  Q1 = Rd.propertyIsEnumerable,
  eA = bl(
    (function () {
      return arguments;
    })(),
    ...
    ? bl
    : function (e) {
        return Z1(e) && J1.call(e, "callee") && !Q1.call(e, "callee");
      },
  es = eA,
  Vi = { exports: {} };
function tA() {
...
pe[fA] =
  ...
  pe[AA] =
    !1;
function DA(e) {
  return lA(e) && sA(e.length) && !!pe[cA(e)];
}
var NA = DA;
function RA(e) {
  return function (t) {
...
function QA(e) {
  var t = e && e.constructor,
    r = (typeof t == "function" && t.prototype) || JA;
  return e === r;
}
var eS = QA;
function tS(e, t) {
...
function sS(e) {
  if (!aS(e)) return oS(e);
  var t = [];
  for (var r in Object(e)) cS.call(e, r) && r != "constructor" && t.push(r);
  return t;
}
var lS = sS,
  fS = Rc,
  pS = rs;
function hS(e) {
  return e != null && pS(e.length) && !fS(e);
}
var mi = hS,
  dS = ZA,
  vS = lS,
...
function _S(e, t, r, n, i, a) {
  ...
  for (var l = c; l--; ) {
    var p = u[l];
    if (!(o ? p in t : PS.call(t, p))) return !1;
  }
  var h = a.get(e),
    v = a.get(t);
...
var $S = _S,
  ...
  VS = fn(Tu),
  Vt = Ud;
((Su && Vt(new Su(new ArrayBuffer(1))) != $l) ||
  (Pu && Vt(new Pu()) != Al) ||
  (_u && Vt(_u.resolve()) != Sl) ||
  ($u && Vt(new $u()) != Pl) ||
  (Tu && Vt(new Tu()) != _l)) &&
...
function rP(e, t, r, n, i, a) {
  ...
  if (p && !f)
    return (
      a || (a = new Wo()),
      o || QS(e) ? YS(e, t, r, n, i, a) : ZS(e, t, c, r, n, i, a)
    );
  if (!(r & eP)) {
  ...
  return p ? (a || (a = new Wo()), JS(e, t, r, n, i, a)) : !1;
}
var nP = rP,
  iP = nP,
  kl = $t;
...
function sP(e, t, r, n) {
  ...
  for (; ++i < a; ) {
    ...
    if (o && u[2]) {
      ...
      if (!(p === void 0 ? oP(f, s, uP | cP, n, l) : p)) return !1;
    }
  }
  return !0;
}
...
function MP(e, t, r) {
  ...
  return a || ++n != i
    ? a
    : ((i = e == null ? 0 : e.length),
      !!i && EP(i) && TP(o, i) && ($P(e) || _P(e)));
}
var CP = MP,
  IP = SP,
  kP = CP;
function DP(e, t) {
  return e != null && kP(e, t, IP);
}
var NP = DP,
  RP = ns,
  LP = td,
...
function KP(e, t) {
  return FP(e) && WP(t)
    ...
    : function (r) {
        var n = LP(r, e);
        return n === void 0 && n === t ? BP(r, e) : RP(t, n, qP | HP);
      };
}
var GP = KP;
function VP(e) {
...
var z_ = W_,
  ...
  q_ = z_;
function H_(e, t) {
  return e && e.length ? q_(e, U_(t)) : [];
}
var K_ = H_;
const Dl = oe(K_);
function Vd(e, t, r) {
  return t === !0 ? Dl(e, r) : V(t) ? Dl(e, t) : e;
}
function Cr(e) {
  "@babel/helpers - typeof";
  return (
          ...
          },
          {
            ...
            value: function () {
              ...
              return S.createElement(
                ...
                i$(a, dt(dt({}, this.props), {}, { payload: Vd(f, s, n$) })),
              );
            },
          },
        ],
...
function OT(e, t, r) {
  if (!wT(r)) return !1;
  var n = typeof t;
  return (n == "number" ? bT(r) && xT(t, r.length) : n == "string" && t in r)
    ? gT(r[t], e)
    : !1;
}
var oo = OT,
  ...
  return (
    o.height > 0 && o.width > 0 && r
      ? ((f = Gl({
        ...
        (s = zT({ translateX: f, translateY: l, useTranslate3d: u })))
      : (s = FT),
    {
      cssProperties: s,
      cssClasses: WT({ translateX: f, translateY: l, coordinate: r }),
    }
  );
}
function Ir(e) {
    ...
    rE(t, [
      {
        ...
        value: function () {
          ...
          return S.createElement(
            ...
            sE(s, Jl(Jl({}, this.props), {}, { payload: m })),
          );
        },
      },
    ])
...
var vE = dE,
  ...
  mE = /^\s+/;
function gE(e) {
  return e && e.slice(0, yE(e) + 1).replace(mE, "");
}
var bE = gE,
  xE = bE,
  Ql = Nt,
...
function _E(e) {
  ...
  e = xE(e);
  var r = AE.test(e);
  return r || SE.test(e) ? PE(e.slice(2), r ? 2 : 8) : OE.test(e) ? ef : +e;
}
var ov = _E,
  $E = Nt,
  Ho = pE,
...
function ME(e, t, r) {
  var n,
    ...
    l = !1,
    p = !0;
  if (typeof e != "function") throw new TypeError(TE);
  ((t = tf(t) || 0),
    $E(r) &&
      ((f = !!r.leading),
      (l = "maxWait" in r),
      (a = l ? EE(tf(r.maxWait) || 0, t) : a),
...
function NE(e, t, r) {
  var n = !0,
    i = !0;
  if (typeof e != "function") throw new TypeError(DE);
  return (
    kE(r) &&
      ((n = "leading" in r ? !!r.leading : n),
      (i = "trailing" in r ? !!r.trailing : i)),
    IE(e, t, { leading: n, maxWait: t, trailing: i })
  );
}
var RE = NE;
const uv = oe(RE);
...
var lz = L.forwardRef(function (e, t) {
    var r = e.aspect,
    ...
    var A = L.useState({ containerWidth: i.width, containerHeight: i.height }),
      ...
      $ = L.useCallback(function (M, I) {
        E(function (C) {
          var k = Math.round(M),
            D = Math.round(I);
          return C.containerWidth === k && C.containerHeight === D
            ? C
            : { containerWidth: k, containerHeight: D };
        });
      }, []);
    L.useEffect(
      function () {
    ...
    var T = L.useMemo(
      function () {
       ...
       height and width.`,
        ...
        var D = !Array.isArray(h) && xt(h.type).endsWith("Chart");
...
var En = function (t) {
    ...
    if (t == null || fr.isSsr) return { width: 0, height: 0 };
    var n = ZE(r),
    ...
    try {
      ...
      return (
        (mr.widthCache[i] = c),
        ++mr.cacheCount > XE && ((mr.cacheCount = 0), (mr.widthCache = {})),
        c
      );
    } catch {
...
function cf(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      (n.configurable = !0),
      "value" in n && (n.writable = !0),
      Object.defineProperty(e, aj(n.key), n));
  }
}
function ij(e, t, r) {
  return (
...
var sf = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,
  ...
  uj = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/,
  cj = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/,
  cv = {
    cm: 96 / 2.54,
    mm: 96 / 25.4,
...
var Ti = (function () {
  function e(t, r) {
    (nj(this, e),
      ...
      r !== "" && !uj.test(r) && ((this.num = NaN), (this.unit = "")),
      sj.includes(r) && ((this.num = lj(t, r)), (this.unit = "px")));
  }
  return ij(
    e,
    [
...
var dj = [
  ...
  vj = ["dx", "dy", "angle", "className", "breakAll"];
function Du() {
  return (
    (Du = Object.assign
      ? Object.assign.bind()
...
class mf extends Map {
  ...
  set(t, r) {
    return super.set($j(this, t), r);
  }
  delete(t) {
    return super.delete(Tj(this, t));
  }
}
...
var Un = 0.7,
  ...
  ct = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
  Rj = /^#([0-9a-f]{3,8})$/,
  Lj = new RegExp(`^rgb\\(${$r},${$r},${$r}\\)$`),
  Bj = new RegExp(`^rgb\\(${ct},${ct},${ct}\\)$`),
  Fj = new RegExp(`^rgba\\(${$r},${$r},${$r},${qn}\\)$`),
  Wj = new RegExp(`^rgba\\(${ct},${ct},${ct},${qn}\\)$`),
  zj = new RegExp(`^hsl\\(${qn},${ct},${ct}\\)$`),
  Uj = new RegExp(`^hsla\\(${qn},${ct},${ct},${qn}\\)$`),
  wf = {
    aliceblue: 15792383,
...
function Fu(e, t, r, n) {
  return arguments.length === 1 ? Kj(e) : new Be(e, t, r, n ?? 1);
}
function Be(e, t, r, n) {
...
ls(
  ...
  yv(bi, {
    ...
    clamp() {
      return new Be(rr(this.r), rr(this.g), rr(this.b), ra(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function Zj(e) {
  return (e = +e) == 1
    ? gv
    : function (t, r) {
        return r - t ? Yj(t, r, e) : fs(isNaN(t) ? r : t);
      };
}
function gv(e, t) {
  var r = t - e;
  return r ? Xj(e, r) : fs(isNaN(e) ? t : e);
}
...
function uo() {
  ...
  return (
    ...
    (l.clamp = function (p) {
      return arguments.length ? ((o = p ? !0 : De), f()) : o !== De;
    }),
...
var dM =
  /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Kn(e) {
  if (!(t = dM.exec(e))) throw new Error("invalid format: " + e);
  var t;
  return new ds({
    fill: t[1],
    align: t[2],
...
function mM(e) {
  var t =
      e.grouping === void 0 || e.thousands === void 0
        ? If
        : pM(kf.call(e.grouping, Number), e.thousands + ""),
    r = e.currency === void 0 ? "" : e.currency[0] + "",
    n = e.currency === void 0 ? "" : e.currency[1] + "",
    i = e.decimal === void 0 ? "." : e.decimal + "",
    a = e.numerals === void 0 ? If : hM(kf.call(e.numerals, String)),
  ...
  function f(l, p) {
    var h = s(((l = Kn(l)), (l.type = "f"), l)),
      v = Math.max(-8, Math.min(8, Math.floor(Dr(p) / 3))) * 3,
      d = Math.pow(10, -v),
      y = Df[8 + v / 3];
    return function (b) {
      return h(d * b) + y;
...
var Mi, vs, xv;
gM({ thousands: ",", grouping: [3], currency: ["$", ""] });
function gM(e) {
  return ((Mi = mM(e)), (vs = Mi.format), (xv = Mi.formatPrefix), Mi);
}
function bM(e) {
...
function wv(e, t, r, n) {
  ...
  switch (((n = Kn(n ?? ",f")), n.type)) {
    case "s": {
      ...
      return (
        n.precision == null && !isNaN((a = xM(i, o))) && (n.precision = a),
        xv(n, o)
      );
    }
    case "":
    ...
    case "r": {
      n.precision == null &&
        !isNaN((a = wM(i, Math.max(Math.abs(e), Math.abs(t))))) &&
...
function PM(e) {
  return e === 10 ? SM : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function _M(e) {
  return e === Math.E
    ? Math.log
...
function ys(e) {
  ...
  function o() {
    return (
      (i = _M(n)),
      (a = PM(n)),
      r()[0] < 0 ? ((i = Lf(i)), (a = Lf(a)), e(OM, AM)) : e(Nf, Rf),
      t
    );
  }
  return (
    ...
    (t.ticks = (u) => {
      ...
      if (!(n % 1) && h - p < y) {
        ...
        b.length * 2 < y && (b = Nu(s, f, y));
      } else b = Nu(p, h, Math.min(h - p, y)).map(a);
...
function gs(e) {
  var t = e(De, De),
    r = 1;
  function n() {
    return r === 1 ? e(De, De) : r === 0.5 ? e($M, TM) : e(Wf(r), Wf(1 / r));
  }
  return (
...
const As = _e(
  (e) => {
    e.setTime(
      e - e.getMilliseconds() - e.getSeconds() * mt - e.getMinutes() * Ye,
    );
  },
  (e, t) => {
    e.setTime(+e + t * gt);
...
const wi = _e(
  ...
  (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * Ye) / At,
  (e) => e.getDate() - 1,
);
wi.range;
const co = _e(
...
const [BM, FM] = Mv(Pt, _s, lo, jv, Ss, Os),
  [WM, zM] = Mv(St, Ps, so, wi, As, ws);
function Jo(e) {
  if (0 <= e.y && e.y < 100) {
    ...
    return function (Q) {
      ...
      for (Q instanceof Date || (Q = new Date(+Q)); ++ve < xe; )
        W.charCodeAt(ve) === 37 &&
          ...
          N.push(we),
          (te = ve + 1));
      return (N.push(W.slice(te, ve)), N.join(""));
    };
  }
  function A(W, Z) {
    return function (Q) {
      var N = wn(1900, void 0, 1),
        ve = P(N, W, (Q += ""), 0),
        te,
        xe;
      ...
      if (
        ...
        ("W" in N || "U" in N) &&
          ...
          (xe =
            "Z" in N
              ? Qo(wn(N.y, 0, 1)).getUTCDay()
              : Jo(wn(N.y, 0, 1)).getDay()),
          (N.m = 0),
          (N.d =
            "W" in N
              ? ((N.w + 6) % 7) + N.W * 7 - ((xe + 5) % 7)
              : N.w + N.U * 7 - ((xe + 6) % 7)));
      return "Z" in N
        ? ((N.H += (N.Z / 100) | 0), (N.M += N.Z % 100), Qo(N))
        : Jo(N);
    };
  }
  function P(W, Z, Q, N) {
    for (var ve = 0, te = Z.length, xe = Q.length, we, Re; ve < te; ) {
      ...
      if (((we = Z.charCodeAt(ve++)), we === 37)) {
        if (
          ...
          return -1;
      } else if (we != Q.charCodeAt(N++)) return -1;
    }
    return N;
  }
  function _(W, Z, Q) {
    var N = s.exec(Z.slice(Q));
    return N ? ((W.p = f.get(N[0].toLowerCase())), Q + N[0].length) : -1;
  }
  function E(W, Z, Q) {
    var N = h.exec(Z.slice(Q));
    return N ? ((W.w = v.get(N[0].toLowerCase())), Q + N[0].length) : -1;
  }
  function $(W, Z, Q) {
    var N = l.exec(Z.slice(Q));
    return N ? ((W.w = p.get(N[0].toLowerCase())), Q + N[0].length) : -1;
  }
  function T(W, Z, Q) {
    var N = b.exec(Z.slice(Q));
    return N ? ((W.m = w.get(N[0].toLowerCase())), Q + N[0].length) : -1;
  }
  function M(W, Z, Q) {
    var N = d.exec(Z.slice(Q));
    return N ? ((W.m = y.get(N[0].toLowerCase())), Q + N[0].length) : -1;
  }
  function I(W, Z, Q) {
    return P(W, t, Z, Q);
  }
...
function On(e) {
  return new RegExp("^(?:" + e.map(KM).join("|") + ")", "i");
}
function An(e) {
...
function fC(e, t) {
  return re(1 + wi.count(St(e), e), t, 3);
}
function Cv(e, t) {
...
function mC(e, t) {
  return re(so.count(St(e) - 1, e), t, 2);
}
function Iv(e) {
  var t = e.getDay();
...
function gC(e, t) {
  return ((e = Iv(e)), re(Nr.count(St(e), e) + (St(e).getDay() === 4), t, 2));
}
function bC(e) {
  return e.getDay();
}
function xC(e, t) {
  return re(ca.count(St(e) - 1, e), t, 2);
}
function wC(e, t) {
...
function TC(e, t) {
  return re(1 + co.count(Pt(e), e), t, 3);
}
function kv(e, t) {
...
function kC(e, t) {
  return re(lo.count(Pt(e) - 1, e), t, 2);
}
function Dv(e) {
  var t = e.getUTCDay();
...
function DC(e, t) {
  return (
    (e = Dv(e)),
    re(Rr.count(Pt(e), e) + (Pt(e).getUTCDay() === 4), t, 2)
  );
}
function NC(e) {
  return e.getUTCDay();
...
function RC(e, t) {
  return re(sa.count(Pt(e) - 1, e), t, 2);
}
function LC(e, t) {
  return re(e.getUTCFullYear() % 100, t, 2);
}
function BC(e, t) {
  return ((e = Dv(e)), re(e.getUTCFullYear() % 100, t, 2));
}
function FC(e, t) {
...
function $s(e, t, r, n, i, a, o, u, c, s) {
  ...
  return (
    ...
    (f.domain = function (g) {
      return arguments.length ? p(Array.from(g, HC)) : p().map(qC);
    }),
    (f.ticks = function (g) {
      var A = p();
...
function KC() {
  return et.apply(
    $s(WM, zM, St, Ps, so, wi, As, ws, Qt, Nv).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
...
function GC() {
  return et.apply(
    $s(BM, FM, Pt, _s, lo, co, Ss, Os, Qt, Rv).domain([
      Date.UTC(2e3, 0, 1),
      Date.UTC(2e3, 0, 2),
    ]),
    arguments,
...
function Fv() {
  ...
  return (
    (e.copy = function () {
      return Lt(e, Fv()).constant(e.constant());
    }),
    Tt.apply(e, arguments)
  );
}
function Ts() {
  ...
  return (
    (e.copy = function () {
      return Lt(e, Ts()).exponent(e.exponent());
    }),
    Tt.apply(e, arguments)
  );
}
...
function qv() {
  ...
  return (
    (e.copy = function () {
      return Lt(e, qv()).constant(e.constant());
    }),
    Tt.apply(e, arguments)
  );
}
function Es() {
  ...
  return (
    (e.copy = function () {
      return Lt(e, Es()).exponent(e.exponent());
    }),
    Tt.apply(e, arguments)
  );
}
...
function ZC(e, t, r) {
  for (var n = -1, i = e.length; ++n < i; ) {
    var a = e[n],
      o = t(a);
    if (o != null && (u === void 0 ? o === o && !YC(o) : r(o, u)))
      var u = o,
        c = a;
  }
  return c;
...
var Hv = JC,
  ...
  tI = pn;
function rI(e) {
  return e && e.length ? QC(e, tI, eI) : void 0;
}
var nI = rI;
const It = oe(nI);
function iI(e, t) {
...
var Kv = iI,
  ...
  uI = pn;
function cI(e) {
  return e && e.length ? aI(e, uI, oI) : void 0;
}
var sI = cI;
const vo = oe(sI);
var lI = zc,
...
U.logarithm = U.log = function (e) {
  ...
  return r.eq(qe)
    ? new n(0)
    : ((de = !1), (t = wt(Gn(r, a), Gn(e, a), a)), (de = !0), ue(t, i));
};
...
U.modulo = U.mod = function (e) {
  ...
  return r.s
    ? ((de = !1), (t = wt(r, e, 0, 1).times(e)), (de = !0), r.minus(t))
    : ue(new n(r), i);
};
...
U.toPrecision = function (e, t) {
  ...
  return (
    e === void 0
      ? ((r = be(i)), (n = ur(i, r <= a.toExpNeg || r >= a.toExpPos)))
      : (lt(e, 1, dn),
        t === void 0 ? (t = a.rounding) : lt(t, 0, 8),
        (i = ue(new a(i), e, t)),
        (r = be(i)),
        (n = ur(i, e <= r || r <= a.toExpNeg, e))),
    n
  );
};
U.toSignificantDigits = U.tosd = function (e, t) {
  ...
  return (
    e === void 0
      ...
      : (lt(e, 1, dn), t === void 0 ? (t = n.rounding) : lt(t, 0, 8)),
    ue(new n(r), e, t)
  );
};
U.toString =
...
function lt(e, t, r) {
  if (e !== ~~e || e < t || e > r) throw Error(nr + e);
}
function ot(e) {
  var t,
    r,
  ...
  if (i > 0) {
    for (a += o, t = 1; t < i; t++)
      ((n = e[t] + ""), (r = he - n.length), r && (a += Mt(r)), (a += n));
    ((o = e[t]), (n = o + ""), (r = he - n.length), r && (a += Mt(r)));
...
function Xv(e, t) {
  ...
  for (de = !1, u = l, o = new f(0.03125); e.abs().gte(0.1); )
    ((e = e.times(o)), (s += 5));
  for (
    n = ((Math.log(Xt(2, s)) / Math.LN10) * 2 + 5) | 0,
      u += n,
      r = i = a = new f(qe),
      f.precision = u;
    ;
...
function Gn(e, t) {
  ...
  for (
    u = o = h = wt(h.minus(qe), h.plus(qe), s), f = ue(h.times(h), s), i = 3;
    ;
  ) {
    if (
      ((o = ue(o.times(f), s)),
      (c = u.plus(wt(o, new d(i), s))),
...
function ue(e, t, r) {
          ...
          : u > 5 ||
            (u == 5 &&
              (r == 4 ||
                c ||
                (r == 6 &&
                  ((n > 0 ? (i > 0 ? s / Xt(10, o - i) : 0) : l[f - 1]) % 10) &
                    1) ||
                r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !l[0])
  )
  ...
  if (
    (n == 0
      ...
      : ((l.length = f + 1),
        (a = Xt(10, he - n)),
        (l[f] = i > 0 ? (((s / Xt(10, o - i)) % Xt(10, i)) | 0) * a : 0)),
    c)
  )
    for (;;)
      if (f == 0) {
...
function ur(e, t, r) {
  ...
  return (
    t
      ? (r && (n = r - o) > 0
          ? (a = a.charAt(0) + "." + a.slice(1) + Mt(n))
          : o > 1 && (a = a.charAt(0) + "." + a.slice(1)),
        (a = a + (i < 0 ? "e" : "e+") + i))
      : i < 0
        ? ((a = "0." + Mt(-i - 1) + a), r && (n = r - o) > 0 && (a += Mt(n)))
        : i >= o
          ? ((a += Mt(i + 1 - o)),
            r && (n = r - i - 1) > 0 && (a = a + "." + Mt(n)))
          : ((n = i + 1) < o && (a = a.slice(0, n) + "." + a.slice(n)),
            r && (n = r - o) > 0 && (i + 1 === o && (a += "."), (a += Mt(n)))),
    e.s < 0 ? "-" + a : a
  );
}
function rp(e, t) {
          ...
          return o >= t
            ...
            : e(
                ...
                np(function () {
                  ...
                  return r.apply(void 0, $I(f).concat(c));
                }),
              );
        });
  },
...
var LI = yo(function (e, t, r) {
    var n = +e,
      i = +t;
    return n + r * (i - n);
  }),
  BI = yo(function (e, t, r) {
    var n = t - +e;
    return ((n = n || 1 / 0), (r - e) / n);
  }),
  FI = yo(function (e, t, r) {
    var n = t - +e;
...
const mo = {
  rangeStep: RI,
  getDigitCount: NI,
  interpolateNumber: LI,
  uninterpolateNumber: BI,
  uninterpolateTruncation: FI,
};
function Ku(e) {
  return UI(e) || zI(e) || ty(e) || WI();
}
function WI() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var go = (function (e) {
  function t() {
    return (uk(this, t), lk(this, t, arguments));
  }
  return (
    hk(t, e),
    sk(t, [
      {
        ...
        value: function () {
          var n = this.props,
            ...
            p = ak(n, QI),
            h = H(p, !1);
          this.props.direction === "x" && f.type !== "number" && cr();
...
var cy = function (t) {
  ...
  return (
    ...
    qt(qt(qt({}, c), _r.getWithHeight(o, i)), {}, { payload: s, item: o })
  );
};
function Yn(e) {
  "@babel/helpers - typeof";
...
function Mn(e, t, r, n) {
  ...
  if (r === "number") {
    ...
    return a.length ? [vo(a), It(a)] : [1 / 0, -1 / 0];
  }
  var o = n
    ? i.filter(function (u) {
        return !Y(u);
...
var Sk = function (t) {
      ...
      for (
        ...
        var v = f[l[p]],
          ...
          b = d.filter(function (A) {
            return xt(A.type).indexOf("Bar") >= 0;
          });
        if (b && b.length) {
  ...
  sy = function (t, r, n, i, a) {
    var o = r.props.children,
      u = Ze(o, go).filter(function (s) {
        return Tk(i, a, s.props.direction);
      });
    if (u && u.length) {
      ...
      return t.reduce(
        function (s, f) {
          var l = Se(f, n);
          if (Y(l)) return s;
          var p = Array.isArray(l) ? [vo(l), It(l)] : [l, l],
            h = c.reduce(
              function (v, d) {
                var y = Se(f, d, 0),
  ...
  vy = function (t, r) {
    ...
    if (a && i === "number" && o && (o[0] === "auto" || o[1] === "auto")) {
      ...
      var f = YI(s, a, u);
      return (t.domain([vo(f), It(f)]), { niceTicks: f });
    }
    if (a && i === "number") {
      var l = t.domain(),
        p = ZI(l, a, u);
...
var lp = function (t) {
  ...
  Bk = function (t) {
    return t.reduce(
      function (r, n) {
        return [vo(n.concat([r[0]]).filter(R)), It(n.concat([r[1]]).filter(R))];
      },
      [1 / 0, -1 / 0],
    );
  },
...
var da = Math.PI / 180,
  ...
  Vk = function (t, r, n, i, a) {
    ...
    return d.reduce(function (y, b) {
      ...
      var $ = vy(E, yt(yt({}, w), {}, { realScaleType: _ })),
        T = yt(
          yt(yt({}, w), $),
          {},
          {
  ...
  Yk = function (t, r) {
    var n = t.x,
      ...
      a = r.cx,
      o = r.cy,
      u = Xk({ x: n, y: i }, { x: a, y: o });
    if (u <= 0) return { radius: u };
    var c = (n - a) / u,
      s = Math.acos(c);
    return (
      i > o && (s = 2 * Math.PI - s),
      { radius: u, angle: Gk(s), angleInRadian: s }
    );
  },
  Zk = function (t) {
    var r = t.startAngle,
  ...
  yp = function (t, r) {
    ...
    return v ? yt(yt({}, r), {}, { radius: o, angle: Jk(h, r) }) : null;
  },
  xy = function (t) {
              ...
              : a === "insideTopRight"
                ...
                : a === "insideBottomLeft"
                  ...
                  : a === "insideBottomRight"
                    ...
                    : nn(a) && (R(a.x) || Zt(a.x)) && (R(a.y) || Zt(a.y))
                      ? Ae(
                          {
                            x: u + ke(a.x, s),
                            y: c + ke(a.y, f),
...
var wy = function (t) {
  ...
  m2 = function (t, r) {
    ...
    if (!n) return o;
    var u = y2(t.label, r || a);
    return [u].concat(e2(o));
  };
Te.parseViewBox = wy;
Te.renderCallByParent = m2;
function g2(e) {
...
var w2 = ["valueAccessor"],
  O2 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function A2(e) {
  return $2(e) || _2(e) || P2(e) || S2();
}
function S2() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var C2 = function (t) {
  return Array.isArray(t.value) ? x2(t.value) : t.value;
};
function Ot(e) {
...
function I2(e, t) {
  return e
    ? e === !0
      ? S.createElement(Ot, { key: "labelList-implicit", data: t })
...
function k2(e, t) {
  ...
  var n = e.children,
    i = Ze(n, Ot).map(function (o, u) {
      return L.cloneElement(o, { data: t, key: "labelList-".concat(u) });
    });
  if (!r) return i;
  var a = I2(e.label, t);
  return [a].concat(A2(i));
}
Ot.renderCallByParent = k2;
function ti(e) {
  "@babel/helpers - typeof";
  return (
    (ti =
...
var Pp = {
  ...
  Sy = { exports: {} },
  K2 = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",
  G2 = K2,
  V2 = G2;
function Py() {}
function _y() {}
...
function $y(e, t, r, n) {
  return (n === nD || n === rD || n === tD) && (e.$$typeof || t.$$typeof)
    ? !0
    : eD(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
var dD = "[object Arguments]",
  ...
  Cp =
    typeof ArrayBuffer == "function" && ArrayBuffer.isView
      ...
      : null,
  Ip = Object.assign,
  _D = Object.prototype.toString.call.bind(Object.prototype.toString);
function $D(e) {
...
function TD(e) {
  var t = e.circular,
    ...
    n = e.strict,
    i = {
      areArraysEqual: n ? _n : iD,
      areDatesEqual: aD,
      areErrorsEqual: oD,
      areFunctionsEqual: uD,
      areMapsEqual: n ? _p(jp, _n) : jp,
      areNumbersEqual: cD,
      areObjectsEqual: n ? _n : sD,
      arePrimitiveWrappersEqual: lD,
      areRegExpsEqual: fD,
      areSetsEqual: n ? _p(Mp, _n) : Mp,
      areTypedArraysEqual: n ? _n : pD,
      areUrlsEqual: hD,
    };
  if ((r && (i = Ip({}, i, r(i))), t)) {
    var a = Di(i.areArraysEqual),
      o = Di(i.areMapsEqual),
      u = Di(i.areObjectsEqual),
      c = Di(i.areSetsEqual);
    i = Ip({}, i, {
      areArraysEqual: a,
      areMapsEqual: o,
...
var WD = function (t, r) {
  ...
  Lp = function (t, r, n) {
    return t
      .map(function (i) {
        return "".concat(UD(i), " ").concat(r, "ms ").concat(n);
      })
      .join(",");
  };
function qD(e, t) {
  return GD(e) || KD(e, t) || Ey(e, t) || HD();
}
function HD() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      },
      {
        ...
        value: function (i) {
          ...
          if (u) {
            ...
            if (!(MD(i.to, f) && i.canBegin && i.isActive)) {
      ...
      },
      {
        ...
        value: function (i) {
          var a = this,
            ...
            h = fN(o, u, eN(s), c, this.changeStyle),
            v = function () {
              a.stopJSAnimation = h();
            };
        ...
        value: function (i) {
          var a = this,
            ...
            h = function (d, y, b) {
              ...
              return [].concat(ru(d), [$, w, A]).filter(zD);
            };
...
var Gp = function (t, r, n, i, a) {
  ...
  NN = ["points", "className", "baseLinePoints", "connectNulls"];
function wr() {
  return (
    (wr = Object.assign
      ? Object.assign.bind()
...
var KN = ["x", "y", "top", "left", "width", "height", "className"];
function pc() {
  return (
    (pc = Object.assign
      ? Object.assign.bind()
...
var QN = function (t, r, n, i, a, o) {
  ...
  eR = function (t) {
    var r = t.x,
      ...
      v = t.className,
      d = ZN(t, KN),
      y = GN({ x: n, y: a, top: u, left: s, width: l, height: h }, d);
  ...
  nR = ht;
function iR(e, t) {
  return e && e.length ? tR(e, nR(t), rR) : void 0;
}
var aR = iR;
const oR = oe(aR);
var uR = ho,
  ...
  sR = Kv;
function lR(e, t) {
  return e && e.length ? uR(e, cR(t), sR) : void 0;
}
var fR = lR;
const pR = oe(fR);
var hR = ["cx", "cy", "angle", "ticks", "axisLine"],
  dR = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function Wr(e) {
  "@babel/helpers - typeof";
  return (
    (Wr =
...
function PR(e, t, r) {
  return (
    ...
    _R(
      e,
      Ny() ? Reflect.construct(t, r || [], wa(e).constructor) : t.apply(e, r),
    )
  );
}
function _R(e, t) {
...
var jR = Math.PI / 180,
  ...
  Ao = (function (e) {
    function t() {
      return (AR(this, t), PR(this, t, arguments));
    }
    return (
      TR(t, e),
      SR(
          ...
          },
          {
            ...
            value: function () {
              ...
              if (c === "circle")
                return S.createElement(
                  bo,
                  Yt({ className: "recharts-polar-angle-axis-line" }, s, {
                    cx: i,
                    cy: a,
                    r: o,
                  }),
...
var MR = Wd,
  CR = MR(Object.getPrototypeOf, Object),
  IR = CR,
  kR = _t,
  DR = IR,
  NR = $t,
  ...
  BR = Object.prototype,
  Ly = LR.toString,
  FR = BR.hasOwnProperty,
  WR = Ly.call(Object);
function zR(e) {
  if (!NR(e) || kR(e) != RR) return !1;
  var t = DR(e);
  if (t === null) return !0;
  var r = FR.call(t, "constructor") && t.constructor;
  return typeof r == "function" && r instanceof r && Ly.call(r) == WR;
}
var UR = zR;
const qR = oe(UR);
var HR = _t,
...
function ch(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return S.createElement(oL, r);
    case "sector":
      return S.createElement(Ay, r);
    case "symbols":
      if (dL(t)) return S.createElement(Zc, r);
      break;
    default:
      return null;
  }
...
function By(e) {
  var t = e.option,
    ...
    c = cL(e, uL),
    s;
  if (L.isValidElement(t)) s = L.cloneElement(t, Aa(Aa({}, c), vL(t)));
  else if (V(t)) s = t(c);
  else if (qR(t) && !YR(t)) {
    var f = i(t, c);
...
function bL(e, t) {
  var r;
  return (So(e, t) ? (r = yL) : Po(e, t) ? (r = mL) : si(e, t) && (r = gL), r);
}
function xL(e, t) {
  var r;
  return (
        ...
        },
        {
          ...
          value: function () {
            ...
            return S.createElement(
              ...
              (!h || v) && Ot.renderCallByParent(this.props, o, !1),
            );
          },
        },
      ],
...
Xe(Ft, "parseDeltaAngle", function (e, t) {
  var r = Ie(t - e),
    n = Math.min(Math.abs(t - e), 360);
  return r * n;
});
Xe(Ft, "getRealPieData", function (e) {
  var t = e.data,
    r = e.children,
    n = H(e, !1),
    i = Ze(r, us);
...
Xe(Ft, "parseCoordinateOfPie", function (e, t) {
  var r = t.top,
    n = t.left,
    i = t.width,
    a = t.height,
...
Xe(Ft, "getComposedData", function (e) {
  var t = e.item,
    r = e.offset,
    n =
  ...
  if (m > 0) {
    ...
    g = i.map(function (P, _) {
      ...
      var I = M + Ie(d) * ((E !== 0 ? h : 0) + T * O),
        ...
        D = [{ name: $, value: E, payload: P, dataKey: b, type: p }],
        B = le(v.cx, v.cy, k, C);
      return (
        (A = ce(
          ce(
...
var jL = Math.ceil,
  ML = Math.max;
function CL(e, t, r, n) {
  for (var i = -1, a = ML(jL((t - e) / (r || 1)), 0), o = Array(a); a--; )
    ((o[n ? a : ++i] = e), (e += r));
  return o;
}
var IL = CL,
...
function BL(e) {
  return function (t, r, n) {
    return (
      n && typeof n != "number" && LL(t, r, n) && (r = n = void 0),
      (t = nu(t)),
...
var KL = ["Webkit", "Moz", "O", "ms"],
  GL = function (t, r) {
    var n = t.replace(/(\w)/, function (a) {
        return a.toUpperCase();
      }),
      i = KL.reduce(function (a, o) {
...
function lB(e, t, r) {
  var n = cB(e) ? aB : uB;
  return (r && sB(e, t, r) && (t = void 0), n(e, oB(t)));
}
var fB = lB;
const pB = oe(fB);
var st = function (t, r) {
...
function MB(e, t, r) {
  var n = EB(e) ? _B : $B;
  return (r && jB(e, t, r) && (t = void 0), n(e, TB(t)));
}
var CB = MB;
const Ky = oe(CB);
var IB = ["x", "y"];
...
var yn = (function (e) {
  function t() {
    ...
    for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++)
      i[a] = arguments[a];
    return (
      (r = KB(this, t, [].concat(i))),
      kt(r, "state", { isAnimationFinished: !1 }),
      kt(r, "id", sn("recharts-bar-")),
        ...
        },
        {
          ...
          value: function () {
            ...
            return S.createElement(
              ...
              (!h || y) && Ot.renderCallByParent(this.props, a),
            );
          },
        },
      ],
...
kt(yn, "getComposedData", function (e) {
  var t = e.props,
    r = e.item,
    n = e.barPosition,
    i = e.bandSize,
  ...
  var v = t.layout,
    ...
    P = l.map(function (_, E) {
      ...
      var D = FB(x, Gy.defaultProps.minPointSize)($[1], E);
      if (v === "horizontal") {
        var B,
        ...
        if (
          ...
          var X = Ie(C || D) * (Math.abs(D) - Math.abs(C));
          ((M -= X), (C += X));
        }
      } else {
        ...
        if (
          ...
          var Wt = Ie(I || D) * (Math.abs(D) - Math.abs(I));
          I += Wt;
        }
      }
      return ge(
...
function vF(e, t, r) {
  ...
  if (!n) return -1;
  var i = r == null ? 0 : hF(r);
  return (i < 0 && (i = dF(n + i, 0)), fF(e, pF(t), i));
}
var yF = vF,
  mF = uF,
  gF = yF,
...
var WF = function (t, r) {
  ...
  zF = function (t, r, n, i, a, o, u, c, s) {
    ...
    if (r) {
      ...
      if (st(s, "discard") && !t.x.isInRange(w)) return null;
      var x = [
        { x: w, y: l + h },
        { x: w, y: l },
      ];
...
function UF(e) {
  ...
  var h = ks({ x: f.scale, y: l.scale }),
    ...
    d = Pe(r),
    y = n && n.length === 2,
    b = zF(h, v, d, y, p, e.position, f.orientation, l.orientation, e);
  if (!b) return null;
  var w = NF(b, 2),
    x = w[0],
    O = x.x,
    ...
    A = g.x,
    P = g.y,
    _ = st(e, "hidden") ? "url(#".concat(s, ")") : void 0,
    E = _h(_h({ clipPath: _ }, H(e, !0)), {}, { x1: O, y1: m, x2: A, y2: P });
  return S.createElement(
    ee,
    { className: J("recharts-reference-line", u) },
    WF(o, E),
    Te.renderCallByParent(e, eF({ x1: O, y1: m, x2: A, y2: P })),
  );
}
var Fs = (function (e) {
  function t() {
    return (TF(this, t), MF(this, t, arguments));
  }
  return (
    kF(t, e),
    jF(t, [
      {
        key: "render",
        value: function () {
          return S.createElement(UF, this.props);
        },
      },
    ])
  );
...
var JF = function (t) {
  ...
  To = (function (e) {
    function t() {
      return (qF(this, t), GF(this, t, arguments));
    }
    return (
      YF(t, e),
      KF(t, [
...
var u3 = function (t, r, n, i, a) {
    ...
    return st(a, "discard") && (!p.isInRange(h) || !p.isInRange(v))
      ? null
      : Jy(h, v);
  },
  jo = (function (e) {
    function t() {
      return (QF(this, t), r3(this, t, arguments));
    }
    return (
      a3(t, e),
      t3(t, [
...
function Ws(e, t, r) {
  ...
  if (R(c) || fr.isSsr) return l3(i, typeof c == "number" && R(c) ? c : 0);
  var p = [],
    ...
    d = function (x, O) {
      ...
      return h === "width"
        ? c3(En(m, { fontSize: t, letterSpacing: r }), v, l)
  ...
  return c === "equidistantPreserveStart"
    ...
    : (c === "preserveStart" || c === "preserveStartEnd"
        ? (p = y3(y, b, d, i, o, c === "preserveStartEnd"))
        : (p = v3(y, b, d, i, o)),
      p.filter(function (w) {
        return w.isShow;
      }));
...
function ym(e, t) {
  ...
  if (S.isValidElement(e)) r = S.cloneElement(e, t);
    ...
    r = S.createElement(
      "line",
      er({}, f, { x1: n, y1: i, x2: a, y2: o, fill: "none", key: u }),
    );
  }
  return r;
}
    ...
    return py(
      Ws(
        Ce(
          ...
          {},
          { ticks: bt(n, !0), viewBox: { x: 0, y: 0, width: i, height: a } },
        ),
      ),
      o.left,
      o.left + o.width,
...
function W3(e) {
  ...
  if (
    ...
    return null;
  var O = f.verticalCoordinatesGenerator || B3,
    m = f.horizontalCoordinatesGenerator || F3,
  ...
  return S.createElement(
    ...
    S.createElement(
      D3,
      er({}, f, { offset: s, horizontalPoints: g, xAxis: w, yAxis: x }),
    ),
    S.createElement(
      N3,
      er({}, f, { offset: s, verticalPoints: A, xAxis: w, yAxis: x }),
    ),
    S.createElement(R3, er({}, f, { horizontalPoints: g })),
    S.createElement(L3, er({}, f, { verticalPoints: A })),
  );
}
W3.displayName = "CartesianGrid";
var z3 = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"],
  U3 = ["key"],
  mm;
function Zr(e) {
  "@babel/helpers - typeof";
...
function G3(e, t, r) {
  return (
    ...
    V3(
      e,
      bm() ? Reflect.construct(t, r || [], Da(e).constructor) : t.apply(e, r),
    )
  );
}
function V3(e, t) {
          ...
          value: function (n, i, a) {
            ...
            var c = this.props,
              ...
              v = f.map(function (y, b) {
                var w = jt(
                  jt(jt({ key: "dot-".concat(b), r: 3 }, p), h),
                  {},
                  {
                    index: b,
                    cx: y.x,
            ...
            return S.createElement(
              ee,
              tr({ className: "recharts-area-dots" }, d),
              v,
            );
          },
        },
        ...
        },
        {
          ...
          value: function () {
            ...
            return S.createElement(
              ...
              (!d || b) && Ot.renderCallByParent(this.props, u),
            );
          },
        },
      ],
...
ut(vr, "getComposedData", function (e) {
  ...
  return (
    ...
    jt({ points: w, baseLine: x, layout: h, isRange: b }, p)
  );
});
ut(vr, "renderDotItem", function (e, t) {
  ...
  if (S.isValidElement(e)) r = S.cloneElement(e, t);
    ...
    var n = J("recharts-area-dot", typeof e != "boolean" ? e.className : ""),
      i = t.key,
      a = gm(t, U3);
    r = S.createElement(bo, tr({}, a, { key: i, className: n }));
  }
  return r;
});
function Jr(e) {
...
function tW(e, t, r) {
  return (
    ...
    rW(
      e,
      wm() ? Reflect.construct(t, r || [], Na(e).constructor) : t.apply(e, r),
    )
  );
}
function rW(e, t) {
...
var Mo = (function (e) {
  function t() {
    return (J3(this, t), tW(this, t, arguments));
  }
  return (
    iW(t, e),
    eW(t, [
      {
        key: "render",
        value: function () {
          return L.createElement(oW, this.props);
        },
      },
    ])
  );
...
var vW = function (t) {
  ...
  Co = (function (e) {
    function t() {
      return (uW(this, t), lW(this, t, arguments));
    }
    return (
      hW(t, e),
      sW(t, [
        {
          key: "render",
          value: function () {
            return L.createElement(vW, this.props);
          },
        },
      ])
    );
...
function IW(e) {
  ...
  var v,
    d = Er;
  if (p === "ScatterChart") ((v = o), (d = eR));
  else if (p === "BarChart") ((v = TW(l, o, c, f)), (d = Is));
  else if (l === "radial") {
    var y = Em(o),
      b = y.cx,
      w = y.cy,
    ...
    ((v = {
      ...
      (d = Ay));
  } else ((v = { points: EW(l, o, c) }), (d = Er));
  var g = Ni(
    Ni(Ni(Ni({ stroke: "#ccc", pointerEvents: "none" }, c), v), H(h, !1)),
    {},
    {
      payload: u,
      payloadIndex: s,
...
var ZW = { xAxis: ["bottom", "top"], yAxis: ["left", "right"] },
  JW = { width: "100%", height: "100%" },
  Im = { x: 0, y: 0 };
function Ri(e) {
  return e;
}
...
var Dc = function (t, r, n, i) {
  ...
  tz = function (t, r) {
    ...
    return n.reduce(function (v, d) {
      ...
      if (!T || T.length === 0) {
        var k,
          D = (k = b.domain) !== null && k !== void 0 ? k : C;
        if (x) {
          if (((T = Mn(E, x, w)), w === "category" && h)) {
            ...
            m && B
              ? ((M = T), (T = Pa(0, $)))
              : m ||
                (T = hp(D, T, d).reduce(function (z, X) {
        ...
        if (w === "number") ((T = Cc(l, T, _, a, A)), D && (T = Yu(D, T, O)));
          ...
          j(
            ...
            K(
              ...
              j(
                ...
                {
                  hide: !0,
                  orientation: He(ZW, "".concat(a, ".").concat(d % 2), null),
                  domain: m,
                  originalDomain: O,
                  isCategorical: v,
                  layout: f,
    ...
    var r = t.chartName,
        ...
        return (
          x.forEach(function (F, q) {
            var G = Io(b.data, {
              ...
              We = z["".concat(k, "Id")],
              Wt = {},
              Ne = c.reduce(function (zt, Ut) {
                var ko = w["".concat(Ut.axisType, "Map")],
                  qs = z["".concat(Ut.axisType, "Id")];
                (ko && ko[qs]) || Ut.axisType === "zAxis" || cr();
                var Hs = ko[qs];
                return j(
                  j({}, zt),
                  {},
              ...
              W = Ne[k],
              Z = Ne["".concat(k, "Ticks")],
              Q = O && O[me] && O[me].hasStack && Lk(F, O[me].stackGroups),
              N = xt(F.type).indexOf("Bar") >= 0,
              ve = ha(W, Z),
              te = [],
              xe =
                D && Pk({ barSize: _, stackGroups: O, totalSize: uz(Ne, k) });
            if (N) {
              var we,
                Re,
                Et = Y(fe) ? M : fe,
                yr =
                  (we =
                    (Re = ha(W, Z, !0)) !== null && Re !== void 0 ? Re : Et) !==
                    null && we !== void 0
                    ? we
                    : 0;
              ((te = _k({
                    ...
                    return j(
                      ...
                      {},
                      {
                        position: j(
                          j({}, zt.position),
                          {},
                          { offset: zt.position.offset - yr / 2 },
                        ),
                      },
                    );
                  })));
            ...
            Oi &&
              B.push({
                props: j(
                  ...
                  K(
                    K(
                      K({ key: F.key || "item-".concat(q) }, C, Ne[C]),
                      k,
                      Ne[k],
                    ),
                    "animationId",
      ...
      h = function (b, w) {
        ...
        var A = x.children,
          ...
          I = T.cateAxisName,
          C = Ze(A, n),
          k = Nk(E, C, "".concat(M, "Id"), "".concat(I, "Id"), _, $),
          ...
          B = oz(
            j(j({}, D), {}, { props: x, graphicalItems: C }),
            w == null ? void 0 : w.legendBBox,
          );
        Object.keys(D).forEach(function (z) {
          D[z] = f(x, D[z], B, z.replace("Map", ""), r);
        });
      ...
      v = (function (y) {
        function b(w) {
          ...
          return (
            ...
            K(m, "accessibilityManager", new _W()),
            ...
            K(m, "renderPolarGrid", function (g) {
              ...
              return L.cloneElement(g, {
                polarAngles: Array.isArray(_)
                  ? _
                  : bt(C, !0).map(function (q) {
                      return q.coordinate;
                    }),
                polarRadius: Array.isArray(E)
                  ? E
                  : bt(I, !0).map(function (q) {
                      return q.coordinate;
                    }),
                cx: k,
                cy: D,
            ...
            K(m, "renderGraphicChild", function (g, A, P) {
              ...
              var W = L.cloneElement(g, j(j({}, _.props), Ne));
              function Z(Ut) {
                return typeof M.dataKey == "function"
                  ? M.dataKey(Ut.payload)
                  : null;
              }
              if (Wt)
                if (I >= 0) {
                  ...
                  if (M.dataKey && !M.allowDuplicatedCategory) {
                    ...
                    ((Q = Bi(F, ve, C)), (N = q && G && Bi(G, ve, C)));
                  } else
                    ((Q = F == null ? void 0 : F[I]), (N = q && G && G[I]));
                  if (We || me) {
                    var te =
                    ...
                    return [
                      L.cloneElement(
                        g,
                        j(j(j({}, _.props), Ne), {}, { activeIndex: te }),
                      ),
                      null,
                      null,
                    ];
                  ...
                  var xe,
                    ...
                    yr = Et === void 0 ? g : Et,
                    Oi = Re.childIndex,
                    zt = j(j(j({}, _.props), Ne), {}, { activeIndex: Oi });
                  return [L.cloneElement(yr, zt), null, null];
                }
        ...
        return (
          ...
          zW(b, [
            ...
            },
            {
              key: "componentDidUpdate",
              value: function (x) {
                fu([Ue(x.children, vt)], [Ue(this.props.children, vt)]) ||
                  this.displayDefaultTooltip();
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                var x = Ue(this.props.children, vt);
            ...
            },
            {
              ...
              value: function (x) {
                ...
                if (M !== "axis" && $ && T) {
                  var C = Ct($).scale,
                    k = Ct(T).scale,
                    D = C && C.invert ? C.invert(A.chartX) : null,
                    B = k && k.invert ? k.invert(A.chartY) : null;
                  return j(j({}, A), {}, { xValue: D, yValue: B }, I);
                }
              ...
              value: function (x, O, m) {
                for (
                  ...
                  if (
                    _.item === x ||
                    _.props.key === x.key ||
                    (O === xt(_.item.type) && m === _.childIndex)
                  )
                    return _;
                }
                return null;
