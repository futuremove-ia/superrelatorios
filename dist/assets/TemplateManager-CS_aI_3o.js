...
import { C as T, a as k } from "./card-CTs8HHrG.js";
import { u as X, B as l } from "./index-CaCe4Bjh.js";
import { B as c } from "./badge-Dl11-P0M.js";
import { I as y } from "./input-D9BHdvW6.js";
import { L as n } from "./label-DVbglEJw.js";
import { T as Y } from "./textarea-BtgKkYBH.js";
import { S as x, a as m, b as h, c as p, d as t } from "./select-NitbrCX6.js";
import { D as Z, f as _, a as $, b as ee, c as se } from "./dialog-EL2Wz64d.js";
import {
  U as ae,
  q as D,
  v as te,
...
const be = () => {
  ...
  const v = B.filter((s) => {
      const i =
          ...
          s.tags.some((W) => W.toLowerCase().includes(o.toLowerCase())),
        Q = u === "all" || s.category === u,
        K = g === "all" || s.type === g;
      return i && Q && K;
    }),
    b = (s) => {
