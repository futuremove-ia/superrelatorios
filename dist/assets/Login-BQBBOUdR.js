import { u as S, j as e, B as m, s as h } from "./index-BNBvVWlM.js";
import { r as o, c as I, i as L } from "./router-C2uYhr1z.js";
import { I as j } from "./input-Cqi0Zq_u.js";
import { L as w } from "./label-8Qqntpp1.js";
import { C as B, b as E, c as k, a as F, e as M } from "./card-ChPN7OiP.js";
import { S as U } from "./separator-DzfmiBe7.js";
import { u as n } from "./index-CDFfWQZo.js";
import { L as z } from "./LogoIcon-C8anqLWR.js";
import { B as A } from "./BrandName-CtyiOgdf.js";
import "./utils-CrQ_Kxni.js";
const H = () =>
    e.jsxs("svg", {
      className: "w-5 h-5",
      viewBox: "0 0 24 24",
      ...
      _ = async (t) => {
        ...
        try {
          if (r) {
            ...
            if (a) throw a;
            (n.success(s("auth.toast.signup_success")),
              setTimeout(() => {
            ...
            if (a) throw a;
            (n.success(s("auth.toast.login_success")), f(d()));
          }
        } catch (a) {
          const u =
