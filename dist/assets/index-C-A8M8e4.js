...
var A = j ? { passive: !1 } : !1,
  ...
  et = function (e, t, n, r, u) {
    ...
    return (
      ((p && (Math.abs(f) < 1 || !u)) || (!p && (Math.abs(v) < 1 || !u))) &&
        (b = !0),
      b
    );
  },
    ...
    return (
      ...
      function () {
        (s.forEach(function (f) {
          ...
          (M.set(f, v),
            i.set(f, h),
            v || (I.has(f) || f.removeAttribute(r), I.delete(f)),
