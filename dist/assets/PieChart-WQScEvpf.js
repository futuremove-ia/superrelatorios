import { l as Q } from "./index-BNBvVWlM.js";
import { h as vi, g as oe, r as R, R as P } from "./router-C2uYhr1z.js";
var xm = Array.isArray,
  Be = xm,
  wm = typeof vi == "object" && vi && vi.Object === Object && vi,
  Nh = wm,
  Om = Nh,
  Am = typeof self == "object" && self && self.Object === Object && self,
  Sm = Om || Am || Function("return this")(),
  st = Sm,
  Pm = st,
  _m = Pm.Symbol,
  oi = _m,
...
var St = Fm,
  ...
  Um = "[object Symbol]";
function qm(e) {
  return typeof e == "symbol" || (zm(e) && Wm(e) == Um);
}
var Kr = qm,
  Hm = Be,
  Gm = Kr,
...
function Vm(e, t) {
  ...
  return r == "number" || r == "symbol" || r == "boolean" || e == null || Gm(e)
    ? !0
    : Xm.test(e) || !Km.test(e) || (t != null && e in Object(t));
}
var _c = Vm;
function Ym(e) {
  var t = typeof e;
...
var Wg = Fg,
  zg = ja,
  Ug = Object.prototype,
  qg = Ug.hasOwnProperty;
function Hg(e) {
  var t = this.__data__;
  return zg ? t[e] !== void 0 : qg.call(t, e);
}
var Gg = Hg,
  Kg = ja,
...
Vr.prototype.clear = Zg;
Vr.prototype.delete = Jg;
Vr.prototype.get = Qg;
Vr.prototype.has = eb;
Vr.prototype.set = tb;
var rb = Vr;
...
var Tc = ab,
  ob = Tc;
function ub(e, t) {
  for (var r = e.length; r--; ) if (ob(e[r][0], t)) return r;
  return -1;
}
var Ma = ub,
  cb = Ma,
...
Yr.prototype.clear = Ob;
Yr.prototype.delete = Ab;
Yr.prototype.get = Sb;
Yr.prototype.has = Pb;
Yr.prototype.set = _b;
var Ca = Yr,
...
Zr.prototype.clear = Yb;
Zr.prototype.delete = Zb;
Zr.prototype.get = Jb;
Zr.prototype.has = Qb;
Zr.prototype.set = e0;
var jc = Zr,
...
function Mc(e, t) {
  ...
  return ((r.cache = new (Mc.Cache || Bh)()), r);
}
Mc.Cache = Bh;
var Fh = Mc;
const r0 = oe(Fh);
...
var Cc = p0,
  ...
  d0 = Be,
  v0 = Kr,
  Hs = qs ? qs.prototype : void 0,
  Gs = Hs ? Hs.toString : void 0;
function Wh(e) {
  if (typeof e == "string") return e;
  if (d0(e)) return h0(e, Wh) + "";
  if (v0(e)) return Gs ? Gs.call(e) : "";
  var t = e + "";
...
ie.ContextConsumer = Ba;
ie.ContextProvider = La;
ie.Element = kc;
ie.ForwardRef = Fa;
ie.Fragment = Da;
ie.Lazy = qa;
...
var W0 = Hh.exports,
  ...
  q0 = "[object Number]";
function H0(e) {
  return typeof e == "number" || (U0(e) && z0(e) == q0);
}
var Kh = H0;
const G0 = oe(Kh);
var K0 = Kh;
...
var Ie = function (t) {
  ...
  Xt = function (t) {
    return er(t) && t.indexOf("%") === t.length - 1;
  },
  L = function (t) {
    return G0(t) && !ui(t);
  },
  ...
  ke = function (t, r) {
    ...
    if (!L(t) && !er(t)) return n;
    var a;
    if (Xt(t)) {
      var o = t.indexOf("%");
      a = (r * parseFloat(t.slice(0, o))) / 100;
    } else a = +t;
    return (ui(a) && (a = n), i && a > r && (a = r), a);
  },
  Et = function (t) {
    if (!t) return null;
    var r = Object.keys(t);
...
var ex = ["viewBox", "children"],
  ...
  Ks = ["points", "pathLength"],
  _o = { svg: ex, polygon: Ks, polyline: Ks },
  Nc = [
  ...
  Ci = function (t, r) {
    ...
    var n = t;
    if ((R.isValidElement(t) && (n = t.props), !Xr(n))) return null;
    var i = {};
    return (
  ...
  tr = function (t, r, n) {
    if (!Xr(t) || Qo(t) !== "object") return null;
    var i = null;
    return (
...
var Vs = {
  ...
  $o = null,
  Rc = function e(t) {
    if (t === Ys && Array.isArray($o)) return $o;
    var r = [];
    return (
      R.Children.forEach(t, function (n) {
        Z(n) ||
          (W0.isFragment(n) ? (r = r.concat(e(n.props.children))) : r.push(n));
      }),
      ($o = r),
      (Ys = t),
      r
...
var Zs = function (t) {
  ...
  ux = function (t) {
    return t && t.type && er(t.type) && ox.indexOf(t.type) >= 0;
  },
  BW = function (t) {
    return t && eu(t) === "object" && "clipDot" in t;
  },
  cx = function (t, r, n, i) {
    var a,
      o = (a = _o == null ? void 0 : _o[i]) !== null && a !== void 0 ? a : [];
    return (
      r.startsWith("data-") ||
      (!V(t) && ((i && o.includes(r)) || tx.includes(r))) ||
      (n && Nc.includes(r))
    );
  },
  X = function (t, r, n) {
    if (!t || typeof t == "function" || typeof t == "boolean") return null;
    var i = t;
    if ((R.isValidElement(t) && (i = t.props), !Xr(i))) return null;
    var a = {};
    return (
  ...
  tu = function e(t, r) {
    ...
    if (n === 0) return !0;
    if (n === 1)
      return Js(Array.isArray(t) ? t[0] : t, Array.isArray(r) ? r[0] : r);
    for (var i = 0; i < n; i++) {
      var a = t[i],
        o = r[i];
      if (Array.isArray(a) || Array.isArray(o)) {
        if (!e(a, o)) return !1;
      } else if (!Js(a, o)) return !1;
    }
    return !0;
  },
  Js = function (t, r) {
    ...
    if (!Z(t) && !Z(r)) {
      var n = t.props || {},
        ...
        u = o.children,
        c = Xs(o, ix);
      return i && u ? br(a, c) && tu(i, u) : !i && !u ? br(a, c) : !1;
    }
    return !1;
  },
  Qs = function (t, r) {
...
var ne = P.forwardRef(function (e, t) {
    ...
    return P.createElement("g", iu({ className: a }, X(i, !0), { ref: t }), r);
  }),
  nt = function (t, r) {
    for (
...
var Cx = Mx,
  ...
  Qh = Bx + "?",
  ed = "[" + Rx + "]?",
  Wx = "(?:" + Fx + "(?:" + [Yh, Zh, Jh].join("|") + ")" + ed + Qh + ")*",
  zx = ed + Qh + Wx,
  Ux = "(?:" + [Yh + au + "?", au, Zh, Jh, Lx].join("|") + ")",
  qx = RegExp(ou + "(?=" + ou + ")|" + Ux + zx, "g");
function Hx(e) {
  return e.match(qx) || [];
}
var Gx = Hx,
...
class sw {
    ...
    if (this._x1 === null) this._append`M${(this._x1 = t)},${(this._y1 = r)}`;
      ...
      if (!(Math.abs(l * c - s * f) > qt) || !a)
        ...
        let h = n - o,
          ...
          b = Math.sqrt(d),
          w = Math.sqrt(p),
          x = a * Math.tan((uu - Math.acos((d + p - y) / (2 * b * w))) / 2),
          A = x / w,
          m = x / b;
        (Math.abs(A - 1) > qt && this._append`L${t + A * f},${r + A * l}`,
          this
  ...
  arc(t, r, n, i, a, o) {
    ...
    (this._x1 === null
      ? this._append`M${s},${f}`
      : (Math.abs(this._x1 - s) > qt || Math.abs(this._y1 - f) > qt) &&
        this._append`L${s},${f}`,
      n &&
        (p < 0 && (p = (p % cu) + cu),
        p > uw
          ...
          : p > qt &&
            this
              ._append`A${n},${n},0,${+(p >= uu)},${l},${(this._x1 = t + n * Math.cos(a))},${(this._y1 = r + n * Math.sin(a))}`));
  }
  rect(t, r, n, i) {
    this
...
function od(e, t) {
  var r = se(!0),
    ...
    a = null,
    o = Lc(u);
  ((e = typeof e == "function" ? e : e === void 0 ? id : se(e)),
    (t = typeof t == "function" ? t : t === void 0 ? ad : se(t)));
  function u(c) {
    var s,
      f = (c = Bc(c)).length,
      l,
...
function yi(e, t, r) {
  ...
  ((e = typeof e == "function" ? e : e === void 0 ? id : se(+e)),
    ...
    (r = typeof r == "function" ? r : r === void 0 ? ad : se(+r)));
  function s(l) {
    var p,
      h,
      v,
    ...
    for (a == null && (u = o((w = c()))), p = 0; p <= d; ++p) {
      ...
      b &&
        ((x[p] = +e(y, p, l)),
        (A[p] = +t(y, p, l)),
        u.point(n ? +n(y, p, l) : x[p], r ? +r(y, p, l) : A[p]));
    }
    if (w) return ((u = null), w + "" || null);
  }
  function f() {
    return od().defined(i).curve(o).context(a);
  }
  return (
    (s.x = function (l) {
      return arguments.length
  ...
  Ow = {
    draw(e, t) {
      ...
      (e.moveTo(n, i),
        ...
        e.lineTo(He * u - Ge * c, Ge * u + He * c),
        e.lineTo(He * n + Ge * i, He * i - Ge * n),
        e.lineTo(He * a + Ge * o, He * o - Ge * a),
        e.lineTo(He * u + Ge * c, He * c - Ge * u),
        e.closePath());
    },
  };
function Aw(e, t) {
...
function tl(e, t, r) {
  var n = e._x1 - e._x0,
    ...
    u = (a * i + o * n) / (n + i);
  return (
    (el(a) + el(o)) * Math.min(Math.abs(a), Math.abs(o), 0.5 * Math.abs(u)) || 0
  );
}
function rl(e, t) {
  var r = e._x1 - e._x0;
  ...
  lineEnd: function () {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Eo(this, this._t0, rl(this, this._t0));
        break;
    }
    ((this._line || (this._line !== 0 && this._point === 1)) &&
      this._context.closePath(),
    ...
    if (((e = +e), (t = +t), !(e === this._x1 && t === this._y1))) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          ((this._point = 3), Eo(this, rl(this, (r = tl(this, e, t))), r));
          break;
        default:
          Eo(this, this._t0, (r = tl(this, e, t)));
          break;
      }
      ((this._x0 = this._x1),
        (this._x1 = e),
...
function dd(e) {
  this._context = new vd(e);
}
(dd.prototype = Object.create(Ri.prototype)).point = function (e, t) {
  ...
  lineEnd: function () {
    ...
    if (r)
      if (
        ...
        for (var n = nl(e), i = nl(t), a = 0, o = 1; o < r; ++a, ++o)
          this._context.bezierCurveTo(
            n[0][a],
            i[0][a],
            n[1][a],
...
function Nw() {
  var e = se([]),
    ...
    n = kw;
  function i(a) {
    var o = Array.from(e.apply(this, arguments), Dw),
      u,
      c = o.length,
      s = -1,
      f;
    ...
    for (u = 0, f = Bc(t(o)); u < c; ++u) o[f[u]].index = u;
    return (r(o, f), o);
  }
  return (
    (i.keys = function (a) {
    ...
    (i.order = function (a) {
      return arguments.length
        ? ((t =
            a == null ? lu : typeof a == "function" ? a : se(Array.from(a))),
          i)
        : t;
    }),
    (i.offset = function (a) {
...
var md = {
  ...
  Wc = function (t) {
    var r = t.type,
      ...
      u = o === void 0 ? "area" : o,
      c = qw(t, Fw),
      s = al(al({}, c), {}, { type: n, size: a, sizeType: u }),
      f = function () {
        var y = Kw(n),
          b = Aw()
            .type(y)
...
function Jw(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      ...
      Object.defineProperty(e, bd(n.key), n));
  }
}
function Qw(e, t, r) {
  return (
...
function eO(e, t, r) {
  return (
    ...
    tO(
      e,
      gd() ? Reflect.construct(t, r || [], Li(e).constructor) : t.apply(e, r),
    )
  );
}
function tO(e, t) {
...
var Ke = 32,
  zc = (function (e) {
    function t() {
      return (Zw(this, t), eO(this, t, arguments));
    }
    return (
      nO(t, e),
      Qw(t, [
...
Jr.prototype.clear = wO;
Jr.prototype.delete = OO;
Jr.prototype.get = AO;
Jr.prototype.has = SO;
Jr.prototype.set = PO;
var xd = Jr,
  _O = "__lodash_hash_undefined__";
function $O(e) {
...
function Bi(e) {
  var t = -1,
    r = e == null ? 0 : e.length;
  for (this.__data__ = new MO(); ++t < r; ) this.add(e[t]);
}
Bi.prototype.add = Bi.prototype.push = CO;
Bi.prototype.has = IO;
var wd = Bi;
function kO(e, t) {
...
function WO(e, t, r, n, i, a) {
  ...
  for (a.set(e, t), a.set(t, e); ++l < u; ) {
    ...
    if (h) {
      if (
        !RO(t, function (b, w) {
          if (!LO(h, w) && (v === b || i(v, b, r, n, a))) return h.push(w);
        })
      ) {
        p = !1;
        break;
...
var Uc = KO,
  ...
  l1 = "[object DataView]",
  sl = ul ? ul.prototype : void 0,
  jo = sl ? sl.valueOf : void 0;
function f1(e, t, r, n, i, a, o) {
  switch (r) {
    case l1:
    ...
    case s1:
      return !(e.byteLength != t.byteLength || !a(new cl(e), new cl(t)));
    case e1:
    case t1:
    case i1:
      return XO(+e, +t);
    ...
    case o1:
      var c = n & JO;
      if ((u || (u = ZO), e.size != t.size && !c)) return !1;
      var s = o.get(e);
      if (s) return s == t;
      ((n |= QO), o.set(e, t));
...
var k1 = I1,
  ...
  D1 = St,
  _d = Object.prototype,
  N1 = _d.hasOwnProperty,
  R1 = _d.propertyIsEnumerable,
  L1 = fl(
    (function () {
      return arguments;
    })(),
    ...
    ? fl
    : function (e) {
        return D1(e) && N1.call(e, "callee") && !R1.call(e, "callee");
      },
  qc = L1,
  Fi = { exports: {} };
function B1() {
...
var Hc = U1,
  q1 = 9007199254740991;
function H1(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= q1;
}
var Gc = H1,
  G1 = At,
  K1 = Gc,
...
pe[V1] =
  ...
  pe[uA] =
    !1;
function bA(e) {
  return X1(e) && K1(e.length) && !!pe[G1(e)];
}
var xA = bA;
function wA(e) {
  return function (t) {
...
function RA(e) {
  var t = e && e.constructor,
    r = (typeof t == "function" && t.prototype) || NA;
  return e === r;
}
var LA = RA;
function BA(e, t) {
...
var XA = KA,
  ...
  YA = Gc;
function ZA(e) {
  return e != null && YA(e.length) && !VA(e);
}
var si = ZA,
  JA = DA,
  QA = XA,
...
function lS(e, t, r, n, i, a) {
  ...
  for (var l = c; l--; ) {
    var p = u[l];
    if (!(o ? p in t : sS.call(t, p))) return !1;
  }
  var h = a.get(e),
    v = a.get(t);
...
var fS = lS,
  ...
  CS = Qr(gu),
  Ht = Cd;
((du && Ht(new du(new ArrayBuffer(1))) != bl) ||
  (vu && Ht(new vu()) != vl) ||
  (yu && Ht(yu.resolve()) != yl) ||
  (mu && Ht(new mu()) != ml) ||
  (gu && Ht(new gu()) != gl)) &&
...
var IS = Ht,
  ...
  mi = "[object Object]",
  BS = Object.prototype,
  Pl = BS.hasOwnProperty;
function FS(e, t, r, n, i, a) {
  var o = wl(e),
    u = wl(t),
    c = o ? Sl : xl(e),
    s = u ? Sl : xl(t);
  ((c = c == Al ? mi : c), (s = s == Al ? mi : s));
  var f = c == mi,
    l = s == mi,
    p = c == s;
  if (p && Ol(e)) {
  ...
  if (p && !f)
    return (
      a || (a = new Mo()),
      o || RS(e) ? kS(e, t, r, n, i, a) : DS(e, t, c, r, n, i, a)
    );
  if (!(r & LS)) {
    var h = f && Pl.call(e, "__wrapped__"),
      v = l && Pl.call(t, "__wrapped__");
    if (h || v) {
      var d = h ? e.value() : e,
        y = v ? t.value() : t;
      return (a || (a = new Mo()), i(d, y, r, n, a));
    }
  }
  return p ? (a || (a = new Mo()), NS(e, t, r, n, i, a)) : !1;
}
var WS = FS,
  zS = WS,
  _l = St;
...
function KS(e, t, r, n) {
  ...
  for (; ++i < a; ) {
    ...
    if (o && u[2]) {
      ...
      if (!(p === void 0 ? qS(f, s, HS | GS, n, l) : p)) return !1;
    }
  }
  return !0;
}
...
function vP(e, t, r) {
  ...
  return a || ++n != i
    ? a
    : ((i = e == null ? 0 : e.length),
      !!i && hP(i) && pP(o, i) && (fP(e) || lP(e)));
}
var yP = vP,
  mP = cP,
  gP = yP;
function bP(e, t) {
  return e != null && gP(e, t, mP);
}
var xP = bP,
  wP = Kc,
  OP = qh,
...
function jP(e, t) {
  return SP(e) && PP(t)
    ...
    : function (r) {
        var n = OP(r, e);
        return n === void 0 && n === t ? AP(r, e) : wP(t, n, TP | EP);
      };
}
var MP = jP;
function CP(e) {
...
var __ = P_,
  ...
  T_ = __;
function E_(e, t) {
  return e && e.length ? T_(e, $_(t)) : [];
}
var j_ = E_;
const $l = oe(j_);
function Rd(e, t, r) {
  return t === !0 ? $l(e, r) : V(t) ? $l(e, t) : e;
}
function Pr(e) {
  "@babel/helpers - typeof";
  return (
...
function k_(e, t, r) {
  return (
    ...
    D_(
      e,
      Ld() ? Reflect.construct(t, r || [], zi(e).constructor) : t.apply(e, r),
    )
  );
}
function D_(e, t) {
  ...
  xr = (function (e) {
    function t() {
      ...
      return (
        ...
        Ya(r, "lastBoundingBox", { width: -1, height: -1 }),
        r
      );
    }
    return (
          ...
          },
          {
            ...
            value: function () {
              var n = this.props.onBBoxUpdate,
                i = this.getBBox();
              i
                ? (Math.abs(i.width - this.lastBoundingBox.width) > jl ||
                    Math.abs(i.height - this.lastBoundingBox.height) > jl) &&
          ...
          },
          {
            ...
            value: function () {
              ...
              return P.createElement(
                ...
                z_(a, ft(ft({}, this.props), {}, { payload: Rd(f, s, W_) })),
              );
            },
          },
        ],
...
function C$(e, t, r) {
  return (
    ...
    function () {
      for (
        var n = arguments, i = -1, a = kl(n.length - t, 0), o = Array(a);
        ++i < a;
      )
        o[i] = n[t + i];
      i = -1;
...
var wT = function (t) {
  var r = t.separator,
    ...
    g = !Z(d),
    O = g ? d : "",
    S = Q("recharts-default-tooltip", h),
    _ = Q("recharts-tooltip-label", v);
  g && y && f !== void 0 && f !== null && (O = y(d, f));
  var E = w ? { role: "status", "aria-live": "assertive" } : {};
  return P.createElement(
    "div",
    xu({ className: S, style: A }, E),
    P.createElement(
      "p",
      { className: _, style: m },
      P.isValidElement(O) ? O : "".concat(O),
    ),
    x(),
  );
};
...
function PT(e) {
  ...
  return Q(
    ...
    gi(
      gi(
        gi(
          gi({}, "".concat(sn, "-right"), L(r) && t && L(t.x) && r >= t.x),
          "".concat(sn, "-left"),
          L(r) && t && L(t.x) && r < t.x,
        ),
        "".concat(sn, "-bottom"),
  ...
  return (
    o.height > 0 && o.width > 0 && r
      ? ((f = Bl({
        ...
        (s = _T({ translateX: f, translateY: l, useTranslate3d: u })))
      : (s = ST),
    {
      cssProperties: s,
      cssClasses: PT({ translateX: f, translateY: l, coordinate: r }),
    }
  );
}
function _r(e) {
...
function ET(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      (n.configurable = !0),
      "value" in n && (n.writable = !0),
      Object.defineProperty(e, Gd(n.key), n));
  }
}
function jT(e, t, r) {
  return (
...
function MT(e, t, r) {
  return (
    ...
    CT(
      e,
      Hd() ? Reflect.construct(t, r || [], Ui(e).constructor) : t.apply(e, r),
    )
  );
}
function CT(e, t) {
      ...
      jT(t, [
        {
          ...
          value: function () {
            if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
              var n = this.wrapperNode.getBoundingClientRect();
              (Math.abs(n.width - this.state.lastBoundingBox.width) > zl ||
                Math.abs(n.height - this.state.lastBoundingBox.height) > zl) &&
                this.setState({
...
function BT(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      (n.configurable = !0),
      "value" in n && (n.writable = !0),
      Object.defineProperty(e, Xd(n.key), n));
  }
}
function FT(e, t, r) {
  return (
...
function WT(e, t, r) {
  return (
    ...
    zT(
      e,
      Kd() ? Reflect.construct(t, r || [], qi(e).constructor) : t.apply(e, r),
    )
  );
}
function zT(e, t) {
...
function KT(e, t) {
  return P.isValidElement(e)
    ...
    : typeof e == "function"
      ? P.createElement(e, t)
      : P.createElement(wT, t);
}
var pt = (function (e) {
  function t() {
    return (LT(this, t), WT(this, t, arguments));
  }
  return (
    qT(t, e),
    FT(t, [
      {
        ...
        value: function () {
          ...
          return P.createElement(
            ...
            KT(s, ql(ql({}, this.props), {}, { payload: m })),
          );
        },
      },
    ])
...
function lE(e) {
  ...
  e = iE(e);
  var r = uE.test(e);
  return r || cE.test(e) ? sE(e.slice(2), r ? 2 : 8) : oE.test(e) ? Gl : +e;
}
var Vd = lE,
  fE = It,
  Do = YT,
...
function vE(e, t, r) {
  ...
  ((t = Kl(t) || 0),
    fE(r) &&
      ((f = !!r.leading),
      (l = "maxWait" in r),
      (a = l ? hE(Kl(r.maxWait) || 0, t) : a),
      (p = "trailing" in r ? !!r.trailing : p)));
  function h(g) {
    var O = n,
      S = i;
    return ((n = i = void 0), (s = g), (o = e.apply(S, O)), o);
  }
  function v(g) {
...
var FW = R.forwardRef(function (e, t) {
    var r = e.aspect,
    ...
    var O = R.useState({ containerWidth: i.width, containerHeight: i.height }),
      S = PE(O, 2),
      _ = S[0],
      E = S[1],
      $ = R.useCallback(function (C, I) {
        E(function (M) {
          var k = Math.round(C),
            D = Math.round(I);
          return M.containerWidth === k && M.containerHeight === D
            ? M
      ...
      function () {
        var C = function (F) {
          var q,
            ...
            K = G.height;
          ($(z, K),
            (q = g.current) === null || q === void 0 || q.call(g, z, K));
        };
        d > 0 && (C = Yd(C, d, { trailing: !0, leading: !1 }));
    ...
    var T = R.useMemo(
      function () {
       ...
       maybe you don't need to use a ResponsiveContainer.`,
          ...
          nt(!r || r > 0, "The aspect(%s) must be greater than zero.", r));
        var M = Xt(o) ? C : o,
          k = Xt(c) ? I : c;
        (r &&
          r > 0 &&
          (M ? (k = M / r) : k && (M = k * r), p && k > p && (k = p)),
          nt(
            M > 0 || k > 0,
       ...
       height and width.`,
        ...
        var D = !Array.isArray(h) && mt(h.type).endsWith("Chart");
        return P.Children.map(h, function (B) {
          return P.isValidElement(B)
            ? R.cloneElement(
                B,
                bi(
                  { width: M, height: k },
    ...
    return P.createElement(
      "div",
      {
        ...
        className: Q("recharts-responsive-container", b),
        style: bi(
          bi({}, A),
          {},
...
var fr = { widthCache: {}, cacheCount: 0 },
  IE = 2e3,
  kE = {
    position: "absolute",
    top: "-20000px",
...
var bn = function (t) {
    ...
    if (t == null || tn.isSsr) return { width: 0, height: 0 };
    var n = DE(r),
      i = JSON.stringify({ text: t, copyStyle: n });
    if (fr.widthCache[i]) return fr.widthCache[i];
    try {
      var a = document.getElementById(Zl);
      a ||
        ((a = document.createElement("span")),
        a.setAttribute("id", Zl),
      ...
      return (
        (fr.widthCache[i] = c),
        ++fr.cacheCount > IE && ((fr.cacheCount = 0), (fr.widthCache = {})),
        c
      );
    } catch {
...
var ef = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,
  tf = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,
  HE = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/,
  GE = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/,
  Zd = {
    cm: 96 / 2.54,
    mm: 96 / 25.4,
...
var xi = (function () {
  function e(t, r) {
    (WE(this, e),
      ...
      r !== "" && !HE.test(r) && ((this.num = NaN), (this.unit = "")),
      KE.includes(r) && ((this.num = XE(t, r)), (this.unit = "px")));
  }
  return zE(
    e,
    [
...
function Jd(e) {
  if (e.includes(dr)) return dr;
  for (var t = e; t.includes("*") || t.includes("/"); ) {
    var r,
      n = (r = ef.exec(t)) !== null && r !== void 0 ? r : [],
      i = Hi(n, 4),
      a = i[1],
      o = i[2],
      u = i[3],
    ...
    if (f.isNaN()) return dr;
    t = t.replace(ef, f.toString());
  }
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var l,
      p = (l = tf.exec(t)) !== null && l !== void 0 ? l : [],
      h = Hi(p, 4),
      v = h[1],
      d = h[2],
      y = h[3],
    ...
    if (x.isNaN()) return dr;
    t = t.replace(tf, x.toString());
  }
  return t;
}
var rf = /\(([^()]*)\)/;
...
var JE = [
  ...
  QE = ["dx", "dy", "angle", "className", "breakAll"];
function Pu() {
  return (
    (Pu = Object.assign
      ? Object.assign.bind()
...
var Qd = /[ \f\n\r\t\v\u2028\u2029]+/,
  ev = function (t) {
    ...
    try {
      var a = [];
      Z(r) || (n ? (a = r.toString().split("")) : (a = r.toString().split(Qd)));
      var o = a.map(function (c) {
          return { word: c, width: bn(c, i).width };
        }),
        u = n ? 0 : bn(" ", i).width;
  ...
  oj = function (t) {
    ...
    if ((r || n) && !tn.isSsr) {
      var c,
        s,
        f = ev({ breakAll: o, children: i, style: a });
      if (f) {
  ...
  rr = function (t) {
    ...
    switch (d) {
      ...
      case "middle":
        ...
        break;
      default:
        T = No("calc(".concat(x.length - 1, " * -").concat(u, ")"));
        break;
    }
    var C = [];
    if (l) {
      var I = x[0].width,
        M = w.width;
      C.push("scale(".concat((L(M) ? M / I : 1) / I, ")"));
    }
    return (
      g && C.push("rotate(".concat(g, ", ").concat(E, ", ").concat($, ")")),
      ...
      P.createElement(
        ...
        Pu({}, X(_, !0), {
          x: E,
          y: $,
          className: Q("recharts-text", O),
          textAnchor: h,
          fill: b.includes("url") ? cf : b,
        }),
        x.map(function (k, D) {
...
function Jc(e) {
  let t, r, n;
  e.length !== 2
    ? ((t = Mt), (r = (u, c) => Mt(e(u), c)), (n = (u, c) => e(u) - c))
    : ((t = e === Mt || e === uj ? e : cj), (r = e), (n = e));
...
class sf extends Map {
  ...
  set(t, r) {
    return super.set(fj(this, t), r);
  }
  delete(t) {
    return super.delete(pj(this, t));
  }
}
...
function fj({ _intern: e, _key: t }, r) {
  const n = t(r);
  return e.has(n) ? e.get(n) : (e.set(n, r), r);
}
function pj({ _intern: e, _key: t }, r) {
  const n = t(r);
  ...
  return (
    i < 0
      ...
      : ((s = Math.pow(10, i) * o),
        ...
        u * s < e && ++u,
        c * s > t && --c),
    c < u && 0.5 <= r && r < 2 ? Gi(e, t, r * 2) : [u, c, s]
  );
}
function _u(e, t, r) {
...
function gj(e, t, r) {
  if (((e = Float64Array.from(sj(e))), !(!(n = e.length) || isNaN((t = +t))))) {
    if (t <= 0 || n < 2) return pf(e);
    if (t >= 1) return ff(e);
    var n,
      i = (n - 1) * t,
      a = Math.floor(i),
      o = ff(nv(e, a).subarray(0, a + 1)),
      u = pf(e.subarray(a + 1));
    return o + (u - o) * (i - a);
  }
}
function bj(e, t, r = tv) {
...
function Cn() {
  ...
  return (
    ...
    (e.copy = function () {
      return Cn(t(), [n, i]).round(u).paddingInner(c).paddingOuter(s).align(f);
    }),
    Qe.apply(l(), arguments)
  );
}
function iv(e) {
  var t = e.copy;
...
function xn() {
  return iv(Cn.apply(null, arguments).paddingInner(1));
}
function es(e, t, r) {
...
var In = 0.7,
  ...
  ot = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
  wj = /^#([0-9a-f]{3,8})$/,
  Oj = new RegExp(`^rgb\\(${wr},${wr},${wr}\\)$`),
  Aj = new RegExp(`^rgb\\(${ot},${ot},${ot}\\)$`),
  Sj = new RegExp(`^rgba\\(${wr},${wr},${wr},${kn}\\)$`),
  Pj = new RegExp(`^rgba\\(${ot},${ot},${ot},${kn}\\)$`),
  _j = new RegExp(`^hsl\\(${kn},${ot},${ot}\\)$`),
  $j = new RegExp(`^hsla\\(${kn},${ot},${ot},${kn}\\)$`),
  hf = {
    aliceblue: 15792383,
        ...
        : (t = Aj.exec(e))
          ...
          : (t = Sj.exec(e))
            ...
            : (t = Pj.exec(e))
              ...
              : (t = _j.exec(e))
                ? bf(t[1], t[2] / 100, t[3] / 100, 1)
                : (t = $j.exec(e))
                  ? bf(t[1], t[2] / 100, t[3] / 100, t[4])
                  : hf.hasOwnProperty(e)
                    ? yf(hf[e])
                    : e === "transparent"
                      ? new Le(NaN, NaN, NaN, 0)
                      : null
  );
}
function yf(e) {
...
function jj(e) {
  return (
    e instanceof fi || (e = Dn(e)),
    e ? ((e = e.rgb()), new Le(e.r, e.g, e.b, e.opacity)) : new Le()
  );
}
function ju(e, t, r, n) {
  return arguments.length === 1 ? jj(e) : new Le(e, t, r, n ?? 1);
}
function Le(e, t, r, n) {
...
es(
  ...
  av(fi, {
    ...
    clamp() {
      return new Le(Jt(this.r), Jt(this.g), Jt(this.b), Xi(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function ov(e) {
  ...
  if ((e instanceof fi || (e = Dn(e)), !e)) return new rt();
...
function Cj(e, t, r, n) {
  return arguments.length === 1 ? ov(e) : new rt(e, t, r, n ?? 1);
}
function rt(e, t, r, n) {
  ...
  av(fi, {
    ...
    rgb() {
      var e = (this.h % 360) + (this.h < 0) * 360,
        ...
        i = 2 * r - n;
      return new Le(
        Ro(e >= 240 ? e - 240 : e + 120, i, n),
        Ro(e, i, n),
        Ro(e < 120 ? e + 240 : e - 120, i, n),
        this.opacity,
      );
    },
    clamp() {
      return new rt(xf(this.h), Oi(this.s), Oi(this.l), Xi(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      const e = Xi(this.opacity);
      return `${e === 1 ? "hsl(" : "hsla("}${xf(this.h)}, ${Oi(this.s) * 100}%, ${Oi(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
    },
  }),
);
function xf(e) {
...
function Dj(e) {
  return (e = +e) == 1
    ? uv
    : function (t, r) {
        return r - t ? kj(t, r, e) : ts(isNaN(t) ? r : t);
      };
}
function uv(e, t) {
  var r = t - e;
  return r ? Ij(e, r) : ts(isNaN(e) ? t : e);
}
const wf = (function e(t) {
  var r = Dj(t);
  function n(i, a) {
    var o = r((i = ju(i)).r, (a = ju(a)).r),
      u = r(i.g, a.g),
      c = r(i.b, a.b),
      s = uv(i.opacity, a.opacity);
    return function (f) {
      return (
        (i.r = o(f)),
        (i.g = u(f)),
...
function Fj(e, t) {
  ...
  for (i in t) i in e ? (r[i] = rn(e[i], t[i])) : (n[i] = t[i]);
  return function (a) {
...
function Uj(e, t) {
  var r = (Mu.lastIndex = Lo.lastIndex = 0),
    n,
    i,
    a,
    o = -1,
    u = [],
    c = [];
  for (e = e + "", t = t + ""; (n = Mu.exec(e)) && (i = Lo.exec(t)); )
    ((a = i.index) > r &&
...
function Kj(e, t, r) {
  var n = e[0],
    ...
    o = t[1];
  return (
    i < n ? ((n = Cu(i, n)), (a = r(o, a))) : ((n = Cu(n, i)), (a = r(a, o))),
    function (u) {
      return a(n(u));
    }
  );
...
function Xj(e, t, r) {
  ...
  for (
    ...
    ((i[o] = Cu(e[o], e[o + 1])), (a[o] = r(t[o], t[o + 1])));
  return function (u) {
    var c = li(e, u, 1, n) - 1;
    return a[c](i[c](u));
  };
...
function Ja() {
  ...
  return (
    (l.invert = function (p) {
      return o(i((s || (s = u(t, e.map(n), Vi)))(p)));
    }),
    (l.domain = function (p) {
      return arguments.length ? ((e = Array.from(p, Yi)), f()) : e.slice();
    }),
    (l.range = function (p) {
      return arguments.length ? ((t = Array.from(p)), f()) : t.slice();
    }),
    (l.rangeRound = function (p) {
      return ((t = Array.from(p)), (r = rs), f());
    }),
    (l.clamp = function (p) {
...
var Jj =
  /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Nn(e) {
  if (!(t = Jj.exec(e))) throw new Error("invalid format: " + e);
  var t;
  return new is({
    fill: t[1],
    align: t[2],
...
function eM(e, t) {
  ...
  var n = r[0],
    i = r[1],
    a = i - (cv = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1,
    o = n.length;
  return a === o
    ? n
    : a > o
...
function tM(e) {
  var t =
      e.grouping === void 0 || e.thousands === void 0
        ? Pf
        : Yj(_f.call(e.grouping, Number), e.thousands + ""),
    r = e.currency === void 0 ? "" : e.currency[0] + "",
    n = e.currency === void 0 ? "" : e.currency[1] + "",
    i = e.decimal === void 0 ? "." : e.decimal + "",
    a = e.numerals === void 0 ? Pf : Zj(_f.call(e.numerals, String)),
    ...
    function E($) {
      ...
      if (m === "c") ((C = S($) + C), ($ = ""));
        ...
        if (
          ...
          for (I = -1, M = $.length; ++I < M; )
            if (((k = $.charCodeAt(I)), 48 > k || k > 57)) {
              ((C = (k === 46 ? i + $.slice(I + 1) : $.slice(I)) + C),
                ($ = $.slice(0, I)));
              break;
            }
        }
      ...
      w && !y && ($ = t($, 1 / 0));
      var B = T.length + $.length + C.length,
        F = B < b ? new Array(b - B + 1).join(p) : "";
      switch (
        (w && y && (($ = t(F + $, F.length ? b - C.length : 1 / 0)), (F = "")),
        h)
      ) {
        case "<":
          $ = T + $ + C + F;
        ...
        case "=":
          ...
          break;
        case "^":
          $ = F.slice(0, (B = F.length >> 1)) + T + $ + C + F.slice(B);
          break;
        default:
          $ = F + T + $ + C;
          break;
  ...
  function f(l, p) {
    var h = s(((l = Nn(l)), (l.type = "f"), l)),
      v = Math.max(-8, Math.min(8, Math.floor(Tr(p) / 3))) * 3,
      d = Math.pow(10, -v),
      y = $f[8 + v / 3];
    return function (b) {
      return h(d * b) + y;
...
var Ai, as, sv;
rM({ thousands: ",", grouping: [3], currency: ["$", ""] });
function rM(e) {
  return ((Ai = tM(e)), (as = Ai.format), (sv = Ai.formatPrefix), Ai);
}
function nM(e) {
  return Math.max(0, -Tr(Math.abs(e)));
}
function iM(e, t) {
  return Math.max(
    0,
    Math.max(-8, Math.min(8, Math.floor(Tr(t) / 3))) * 3 - Tr(Math.abs(e)),
  );
}
function aM(e, t) {
  return (
...
function kt(e) {
  ...
  return (
    (e.ticks = function (r) {
      var n = t();
      return _u(n[0], n[n.length - 1], r ?? 10);
    }),
    (e.tickFormat = function (r, n) {
      var i = t();
      return lv(i[0], i[i.length - 1], r ?? 10, n);
    }),
    (e.nice = function (r) {
      r == null && (r = 10);
      var n = t(),
      ...
      for (
        ...
        if (((s = $u(o, u, r)), s === c)) return ((n[i] = o), (n[a] = u), t(n));
...
function fv(e) {
  ...
  return (
    ...
    (r.domain = r.range =
      function (n) {
        return arguments.length ? ((e = Array.from(n, Yi)), r) : e.slice();
      }),
...
function sM(e) {
  return e === 10 ? cM : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function lM(e) {
  return e === Math.E
    ? Math.log
...
function os(e) {
  ...
  function o() {
    return (
      (i = lM(n)),
      (a = sM(n)),
      r()[0] < 0 ? ((i = jf(i)), (a = jf(a)), e(oM, uM)) : e(Tf, Ef),
      t
    );
  }
  return (
    ...
    (t.ticks = (u) => {
      ...
      if (!(n % 1) && h - p < y) {
        ...
        b.length * 2 < y && (b = _u(s, f, y));
      } else b = _u(p, h, Math.min(h - p, y)).map(a);
    ...
    (t.tickFormat = (u, c) => {
      if (
        ...
        c == null && (c = n === 10 ? "s" : ","),
        typeof c != "function" &&
          (!(n % 1) && (c = Nn(c)).precision == null && (c.trim = !0),
          (c = as(c))),
        u === 1 / 0)
      )
        return c;
...
function hv() {
  const e = os(Ja()).domain([1, 10]);
  return (
    (e.copy = () => pi(e, hv()).base(e.base())),
    Qe.apply(e, arguments),
    e
  );
}
...
function us(e) {
  ...
  return (
    (r.constant = function (n) {
      return arguments.length ? e(Mf((t = +n)), Cf(t)) : t;
    }),
    kt(r)
  );
}
function dv() {
  ...
  return (
    (e.copy = function () {
      return pi(e, dv()).constant(e.constant());
    }),
    Qe.apply(e, arguments)
  );
}
...
function cs(e) {
  var t = e(De, De),
    r = 1;
  function n() {
    return r === 1 ? e(De, De) : r === 0.5 ? e(fM, pM) : e(If(r), If(1 / r));
  }
  return (
...
function ss() {
  ...
  return (
    (e.copy = function () {
      return pi(e, ss()).exponent(e.exponent());
    }),
    Qe.apply(e, arguments),
    e
  );
...
function vv() {
  ...
  return (
    ...
    (i.range = function (a) {
      return arguments.length
        ? (e.range((t = Array.from(a, Yi)).map(kf)), i)
        : t.slice();
    }),
    ...
    (i.copy = function () {
      return vv(e.domain(), t).round(r).clamp(e.clamp()).unknown(n);
    }),
    Qe.apply(i, arguments),
    kt(i)
  );
...
function yv() {
  ...
  function i() {
    ...
    for (r = new Array(u - 1); ++o < u; ) r[o - 1] = bj(e, o / u);
    return a;
  }
  function a(o) {
    return o == null || isNaN((o = +o)) ? n : t[li(r, o)];
  }
  return (
...
function mv() {
  var e = 0,
    ...
    a;
  function o(c) {
    return c != null && c <= c ? i[li(n, c, 0, r)] : a;
  }
  function u() {
    var c = -1;
...
function gv() {
  var e = [0.5],
    ...
    n = 1;
  function i(a) {
    return a != null && a <= a ? t[li(e, a, 0, n)] : r;
  }
  return (
    (i.domain = function (a) {
      return arguments.length
    ...
    (i.copy = function () {
      return gv().domain(e).range(t).unknown(r);
    }),
    Qe.apply(i, arguments)
  );
}
...
const hs = Pe(
  (e) => {
    e.setTime(
      e - e.getMilliseconds() - e.getSeconds() * dt - e.getMinutes() * Ve,
    );
  },
  (e, t) => {
    e.setTime(+e + t * vt);
...
const hi = Pe(
  ...
  (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * Ve) / bt,
  (e) => e.getDate() - 1,
);
hi.range;
const Qa = Pe(
...
function ur(e) {
  return Pe(
    ...
    (t, r) =>
      (r - t - (r.getTimezoneOffset() - t.getTimezoneOffset()) * Ve) / ls,
  );
}
const eo = ur(0),
  ea = ur(1),
...
function xv(e, t, r, n, i, a) {
  ...
  function c(s, f, l) {
    const p = Math.abs(f - s) / l,
      h = Jc(([, , y]) => y).right(o, p);
    if (h === o.length) return e.every(Tu(s / Wo, f / Wo, l));
    if (h === 0) return Qi.every(Math.max(Tu(s, f, l), 1));
    const [v, d] = o[p / o[h - 1][2] < o[h][2] / p ? h - 1 : h];
    return v.every(d);
  }
  return [u, c];
}
const [AM, SM] = xv(wt, ys, to, bv, ds, ps),
  [PM, _M] = xv(xt, vs, eo, hi, hs, fs);
function zo(e) {
  if (0 <= e.y && e.y < 100) {
  ...
  function g(W, Y) {
    return function (J) {
      var N = [],
        ...
        Re,
        _t;
      for (J instanceof Date || (J = new Date(+J)); ++ve < xe; )
        W.charCodeAt(ve) === 37 &&
          (N.push(W.slice(ee, ve)),
          (Re = Nf[(we = W.charAt(++ve))]) != null
            ? (we = W.charAt(++ve))
            : (Re = we === "e" ? " " : "0"),
          (_t = Y[we]) && (we = _t(J, Re)),
          N.push(we),
          (ee = ve + 1));
      return (N.push(W.slice(ee, ve)), N.join(""));
    };
  }
  function O(W, Y) {
    return function (J) {
      var N = fn(1900, void 0, 1),
        ve = S(N, W, (J += ""), 0),
        ee,
        xe;
      if (ve != J.length) return null;
      ...
      if (
        ...
        ("w" in N || (N.w = 1),
          "Z" in N
            ? ((ee = Uo(fn(N.y, 0, 1))),
              (xe = ee.getUTCDay()),
              (ee = xe > 4 || xe === 0 ? ta.ceil(ee) : ta(ee)),
              (ee = Qa.offset(ee, (N.V - 1) * 7)),
              (N.y = ee.getUTCFullYear()),
              (N.m = ee.getUTCMonth()),
              (N.d = ee.getUTCDate() + ((N.w + 6) % 7)))
            : ((ee = zo(fn(N.y, 0, 1))),
              (xe = ee.getDay()),
              (ee = xe > 4 || xe === 0 ? ea.ceil(ee) : ea(ee)),
              (ee = hi.offset(ee, (N.V - 1) * 7)),
              (N.y = ee.getFullYear()),
              (N.m = ee.getMonth()),
        ...
        ("W" in N || "U" in N) &&
          ...
          (xe =
            "Z" in N
              ? Uo(fn(N.y, 0, 1)).getUTCDay()
              : zo(fn(N.y, 0, 1)).getDay()),
          (N.m = 0),
          (N.d =
            "W" in N
              ...
              : N.w + N.U * 7 - ((xe + 6) % 7)));
      return "Z" in N
        ? ((N.H += (N.Z / 100) | 0), (N.M += N.Z % 100), Uo(N))
        : zo(N);
    };
  }
  function S(W, Y, J, N) {
    for (var ve = 0, ee = Y.length, xe = J.length, we, Re; ve < ee; ) {
      if (N >= xe) return -1;
      if (((we = Y.charCodeAt(ve++)), we === 37)) {
        if (
          ((we = Y.charAt(ve++)),
          (Re = m[we in Nf ? Y.charAt(ve++) : we]),
          !Re || (N = Re(W, J, N)) < 0)
        )
          return -1;
      } else if (we != J.charCodeAt(N++)) return -1;
    }
    return N;
  }
  function _(W, Y, J) {
    var N = s.exec(Y.slice(J));
    return N ? ((W.p = f.get(N[0].toLowerCase())), J + N[0].length) : -1;
  }
  function E(W, Y, J) {
    var N = h.exec(Y.slice(J));
    return N ? ((W.w = v.get(N[0].toLowerCase())), J + N[0].length) : -1;
  }
  function $(W, Y, J) {
    var N = l.exec(Y.slice(J));
    return N ? ((W.w = p.get(N[0].toLowerCase())), J + N[0].length) : -1;
  }
  function T(W, Y, J) {
    var N = b.exec(Y.slice(J));
    return N ? ((W.m = w.get(N[0].toLowerCase())), J + N[0].length) : -1;
  }
  function C(W, Y, J) {
    var N = d.exec(Y.slice(J));
    return N ? ((W.m = y.get(N[0].toLowerCase())), J + N[0].length) : -1;
  }
  function I(W, Y, J) {
    return S(W, t, Y, J);
  }
...
function pn(e) {
  return new RegExp("^(?:" + e.map(jM).join("|") + ")", "i");
}
function hn(e) {
...
function VM(e, t) {
  return te(1 + hi.count(xt(e), e), t, 3);
}
function wv(e, t) {
...
function tC(e, t) {
  return te(eo.count(xt(e) - 1, e), t, 2);
}
function Ov(e) {
  var t = e.getDay();
  return t >= 4 || t === 0 ? Er(e) : Er.ceil(e);
}
function rC(e, t) {
  return ((e = Ov(e)), te(Er.count(xt(e), e) + (xt(e).getDay() === 4), t, 2));
}
function nC(e) {
  return e.getDay();
}
function iC(e, t) {
  return te(ea.count(xt(e) - 1, e), t, 2);
}
function aC(e, t) {
  return te(e.getFullYear() % 100, t, 2);
}
function oC(e, t) {
  return ((e = Ov(e)), te(e.getFullYear() % 100, t, 2));
}
function uC(e, t) {
...
function pC(e, t) {
  return te(1 + Qa.count(wt(e), e), t, 3);
}
function Av(e, t) {
...
function gC(e, t) {
  return te(to.count(wt(e) - 1, e), t, 2);
}
function Sv(e) {
  var t = e.getUTCDay();
...
function bC(e, t) {
  return (
    (e = Sv(e)),
    te(jr.count(wt(e), e) + (wt(e).getUTCDay() === 4), t, 2)
  );
}
function xC(e) {
  return e.getUTCDay();
...
function wC(e, t) {
  return te(ta.count(wt(e) - 1, e), t, 2);
}
function OC(e, t) {
  return te(e.getUTCFullYear() % 100, t, 2);
}
function AC(e, t) {
  return ((e = Sv(e)), te(e.getUTCFullYear() % 100, t, 2));
}
function SC(e, t) {
...
function ms(e, t, r, n, i, a, o, u, c, s) {
  var f = ns(),
    l = f.invert,
    p = f.domain,
    h = s(".%L"),
  ...
  return (
    ...
    (f.domain = function (g) {
      return arguments.length ? p(Array.from(g, EC)) : p().map(TC);
    }),
    (f.ticks = function (g) {
      var O = p();
    ...
    (f.copy = function () {
      return pi(f, ms(e, t, r, n, i, a, o, u, c, s));
    }),
    f
  );
}
function jC() {
  return Qe.apply(
    ms(PM, _M, xt, vs, eo, hi, hs, fs, Yt, Pv).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
...
function MC() {
  return Qe.apply(
    ms(AM, SM, wt, ys, to, Qa, ds, ps, Yt, _v).domain([
      Date.UTC(2e3, 0, 1),
      Date.UTC(2e3, 0, 2),
    ]),
    arguments,
...
function Tv() {
  var e = os(ro()).domain([1, 10]);
  return (
    (e.copy = function () {
      return Dt(e, Tv()).base(e.base());
    }),
    Pt.apply(e, arguments)
  );
}
function Ev() {
  ...
  return (
    (e.copy = function () {
      return Dt(e, Ev()).constant(e.constant());
    }),
    Pt.apply(e, arguments)
  );
}
function gs() {
  ...
  return (
    (e.copy = function () {
      return Dt(e, gs()).exponent(e.exponent());
    }),
    Pt.apply(e, arguments)
  );
}
...
function jv() {
  ...
  function r(n) {
    if (n != null && !isNaN((n = +n)))
      return t((li(e, n, 1) - 1) / (e.length - 1));
  }
  return (
    (r.domain = function (n) {
      if (!arguments.length) return e.slice();
    ...
    (r.quantiles = function (n) {
      return Array.from({ length: n + 1 }, (i, a) => gj(e, a / n));
    }),
    (r.copy = function () {
      return jv(t).domain(e);
    }),
    Pt.apply(r, arguments)
  );
}
function no() {
  var e = 0,
...
function Cv() {
  var e = os(no()).domain([0.1, 1, 10]);
  return (
    (e.copy = function () {
      return Dt(e, Cv()).base(e.base());
    }),
    Pt.apply(e, arguments)
  );
}
function Iv() {
  ...
  return (
    (e.copy = function () {
      return Dt(e, Iv()).constant(e.constant());
    }),
    Pt.apply(e, arguments)
  );
}
function bs() {
  ...
  return (
    (e.copy = function () {
      return Dt(e, bs()).exponent(e.exponent());
    }),
    Pt.apply(e, arguments)
  );
}
  ...
  Object.defineProperty(
    {
      ...
      scaleBand: Cn,
      scaleDiverging: Mv,
      scaleDivergingLog: Cv,
      scaleDivergingPow: bs,
      scaleDivergingSqrt: IC,
      ...
      scaleRadial: vv,
      scaleSequential: $v,
      scaleSequentialLog: Tv,
      scaleSequentialPow: gs,
      scaleSequentialQuantile: jv,
      scaleSequentialSqrt: CC,
      scaleSequentialSymlog: Ev,
      scaleSqrt: hM,
      scaleSymlog: dv,
      scaleThreshold: gv,
      scaleTime: jC,
...
function DC(e, t, r) {
  for (var n = -1, i = e.length; ++n < i; ) {
    var a = e[n],
      o = t(a);
    if (o != null && (u === void 0 ? o === o && !kC(o) : r(o, u)))
      var u = o,
        c = a;
  }
  return c;
...
var kv = NC,
  ...
  BC = en;
function FC(e) {
  return e && e.length ? RC(e, BC, LC) : void 0;
}
var WC = FC;
const ao = oe(WC);
function zC(e, t) {
...
var Dv = zC,
  ...
  HC = en;
function GC(e) {
  return e && e.length ? UC(e, HC, qC) : void 0;
}
var KC = GC;
const oo = oe(KC);
var XC = Cc,
...
var nn = 1e9,
  ...
  de = !0,
  Ze = "[DecimalError] ",
  Qt = Ze + "Invalid argument: ",
  xs = Ze + "Exponent out of range: ",
  an = Math.floor,
  Gt = Math.pow,
  sI = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i,
  Ue,
...
U.dividedToIntegerBy = U.idiv = function (e) {
  var t = this,
    r = t.constructor;
  return ue(gt(t, new r(e), 0, 1), r.precision);
};
...
U.logarithm = U.log = function (e) {
  ...
  return r.eq(Ue)
    ? new n(0)
    : ((de = !1), (t = gt(Rn(r, a), Rn(e, a), a)), (de = !0), ue(t, i));
};
U.minus = U.sub = function (e) {
  var t = this;
  return (
    (e = new t.constructor(e)),
    t.s == e.s ? Bv(t, e) : Rv(t, ((e.s = -e.s), e))
  );
};
U.modulo = U.mod = function (e) {
  ...
  return r.s
    ? ((de = !1), (t = gt(r, e, 0, 1).times(e)), (de = !0), r.minus(t))
    : ue(new n(r), i);
};
...
U.precision = U.sd = function (e) {
  var t,
    ...
    n,
    i = this;
  if (e !== void 0 && e !== !!e && e !== 1 && e !== 0) throw Error(Qt + e);
  if (
...
U.toPower = U.pow = function (e) {
  ...
  if (((t = e.e), (r = e.d.length - 1), (o = t >= r), (a = u.s), o)) {
    if ((r = f < 0 ? -f : f) <= Nv) {
      for (
        i = new c(Ue), t = Math.ceil(n / he + 4), de = !1;
        r % 2 && ((i = i.times(u)), Xf(i.d, t)), (r = an(r / 2)), r !== 0;
      )
        ((u = u.times(u)), Xf(u.d, t));
      return ((de = !0), e.s < 0 ? new c(Ue).div(i) : ue(i, n));
    }
...
U.toPrecision = function (e, t) {
  ...
  return (
    e === void 0
      ? ((r = be(i)), (n = nr(i, r <= a.toExpNeg || r >= a.toExpPos)))
      : (ct(e, 1, nn),
        t === void 0 ? (t = a.rounding) : ct(t, 0, 8),
        (i = ue(new a(i), e, t)),
        (r = be(i)),
...
U.toSignificantDigits = U.tosd = function (e, t) {
  ...
  return (
    e === void 0
      ...
      : (ct(e, 1, nn), t === void 0 ? (t = n.rounding) : ct(t, 0, 8)),
    ue(new n(r), e, t)
  );
};
U.toString =
...
function ct(e, t, r) {
  if (e !== ~~e || e < t || e > r) throw Error(Qt + e);
}
function at(e) {
  var t,
    r,
  ...
  if (i > 0) {
    for (a += o, t = 1; t < i; t++)
      ((n = e[t] + ""), (r = he - n.length), r && (a += Tt(r)), (a += n));
    ((o = e[t]), (n = o + ""), (r = he - n.length), r && (a += Tt(r)));
...
var gt = (function () {
  ...
  return function (n, i, a, o) {
    ...
    if (
      ...
      return new _(0);
    if (((w = (w / he + 2) | 0), (s = 0), O == 1))
      for (f = 0, T = T[0], w++; (s < m || f) && w--; s++)
        ((x = f * _e + ($[s] || 0)), (v[s] = (x / T) | 0), (f = (x % T) | 0));
    else {
      for (
        f = (_e / (T[0] + 1)) | 0,
          f > 1 &&
            ((T = e(T, f)), ($ = e($, f)), (O = T.length), (m = $.length)),
          A = O,
          d = $.slice(0, O),
          y = d.length;
        y < O;
        ...
        d[y++] = 0;
      ((S = T.slice()), S.unshift(0), (g = T[0]), T[1] >= _e / 2 && ++g);
      do
        ((f = 0),
          (u = t(T, d, O, y)),
          u < 0
            ...
            : u === 0 && (f++, (d = [0])),
          (v[s++] = f),
          u && d[0] ? (d[y++] = $[A] || 0) : ((d = [$[A]]), (y = 1)));
      while ((A++ < m || d[0] !== void 0) && w--);
    }
...
function qo(e, t, r) {
  if (t > e.LN10.sd())
    throw (
      (de = !0),
      r && (e.precision = r),
      Error(Ze + "LN10 precision limit exceeded")
    );
...
function Rn(e, t) {
  var r,
    ...
    d = h.constructor,
    y = d.precision;
  if (h.s < 1) throw Error(Ze + (h.s ? "NaN" : "-Infinity"));
  if (h.eq(Ue)) return new d(0);
  if ((t == null ? ((de = !1), (s = y)) : (s = t), h.eq(10)))
    return (t == null && (de = !0), qo(d, s));
  if (
    ((s += p),
    (d.precision = s),
    (r = at(v)),
    ...
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); )
      ((h = h.times(e)), (r = at(h.d)), (n = r.charAt(0)), l++);
    ((a = be(h)),
      n > 1 ? ((h = new d("0." + r)), a++) : (h = new d(n + "." + r.slice(1))));
  } else
    return (
      (c = qo(d, s + 2, y).times(a + "")),
      (h = Rn(new d(n + "." + r.slice(1)), s - p).plus(c)),
      (d.precision = y),
      t == null ? ((de = !0), ue(h, y)) : h
    );
  for (
    u = o = h = gt(h.minus(Ue), h.plus(Ue), s), f = ue(h.times(h), s), i = 3;
    ;
  ) {
    if (
      ((o = ue(o.times(f), s)),
      (c = u.plus(gt(o, new d(i), s))),
      at(c.d).slice(0, s) === at(u.d).slice(0, s))
    )
      return (
        (u = u.times(2)),
        a !== 0 && (u = u.plus(qo(d, s + 2, y).times(a + ""))),
        (u = gt(u, new d(l), s)),
        (d.precision = y),
...
function Kf(e, t) {
  ...
  if (((t = t.slice(n, i)), t)) {
    ...
    for (; n--; ) t += "0";
    if ((e.d.push(+t), de && (e.e > ra || e.e < -ra))) throw Error(xs + r);
...
function ue(e, t, r) {
          ...
          : u > 5 ||
            (u == 5 &&
              (r == 4 ||
                c ||
                (r == 6 &&
                  ((n > 0 ? (i > 0 ? s / Gt(10, o - i) : 0) : l[f - 1]) % 10) &
                    1) ||
                r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !l[0])
  )
  ...
  if (
    (n == 0
      ...
      : ((l.length = f + 1),
        (a = Gt(10, he - n)),
        (l[f] = i > 0 ? (((s / Gt(10, o - i)) % Gt(10, i)) | 0) * a : 0)),
    c)
  )
    for (;;)
      if (f == 0) {
  ...
  if (de && (e.e > ra || e.e < -ra)) throw Error(xs + be(e));
  return e;
}
function Bv(e, t) {
  var r,
...
function nr(e, t, r) {
  ...
  return (
    t
      ? (r && (n = r - o) > 0
          ? (a = a.charAt(0) + "." + a.slice(1) + Tt(n))
          : o > 1 && (a = a.charAt(0) + "." + a.slice(1)),
        (a = a + (i < 0 ? "e" : "e+") + i))
      : i < 0
        ? ((a = "0." + Tt(-i - 1) + a), r && (n = r - o) > 0 && (a += Tt(n)))
        : i >= o
          ? ((a += Tt(i + 1 - o)),
            r && (n = r - i - 1) > 0 && (a = a + "." + Tt(n)))
          : ((n = i + 1) < o && (a = a.slice(0, n) + "." + a.slice(n)),
            r && (n = r - o) > 0 && (i + 1 === o && (a += "."), (a += Tt(n)))),
    e.s < 0 ? "-" + a : a
  );
}
function Xf(e, t) {
  ...
  Vf = function (t) {
    return function r() {
      return arguments.length === 0 ||
        (arguments.length === 1 &&
          zv(arguments.length <= 0 ? void 0 : arguments[0]))
        ? r
            ...
            : e(
                ...
                Vf(function () {
                  ...
                  var f = i.map(function (l) {
                    return zv(l) ? c.shift() : l;
                  });
                  return r.apply(void 0, fI(f).concat(c));
                }),
              );
        });
  },
  co = function (t) {
    return mI(t.length, t);
  },
  ku = function (t, r) {
...
var OI = co(function (e, t, r) {
    var n = +e,
      i = +t;
    return n + r * (i - n);
  }),
  AI = co(function (e, t, r) {
    var n = t - +e;
    return ((n = n || 1 / 0), (r - e) / n);
  }),
  SI = co(function (e, t, r) {
    var n = t - +e;
...
const so = {
  rangeStep: wI,
  getDigitCount: xI,
  interpolateNumber: OI,
  uninterpolateNumber: AI,
  uninterpolateTruncation: SI,
};
function Nu(e) {
  return $I(e) || _I(e) || qv(e) || PI();
}
function PI() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function MI(e, t, r) {
  ...
  if (!i.isint() && r) {
    var a = Math.abs(e);
    a < 1
      ? ((n = new ae(10).pow(so.getDigitCount(e) - 1)),
...
function Kv(e, t, r, n) {
  ...
  var a = Gv(new ae(t).sub(e).div(r - 1), n, i),
    o;
  e <= 0 && t >= 0
    ? (o = new ae(0))
...
function CI(e) {
  ...
  if (s === f) return MI(s, i, a);
  var p = Kv(s, f, o, a),
    h = p.step,
    v = p.tickMin,
    d = p.tickMax,
    y = so.rangeStep(v, d.add(new ae(0.1).mul(h)), h);
  return r > n ? Du(y) : y;
}
function II(e, t) {
  var r = Ln(e, 2),
  ...
  if (c === s) return [c];
  var f = Math.max(t, 2),
    l = Gv(new ae(s).sub(c).div(f - 1), a, 0),
    p = [].concat(
      Nu(so.rangeStep(new ae(c), new ae(s).sub(new ae(0.99).mul(l)), l)),
      [s],
    );
  return n > i ? Du(p) : p;
}
...
function XI(e, t, r) {
  return (
    ...
    VI(
      e,
      Xv() ? Reflect.construct(t, r || [], ia(e).constructor) : t.apply(e, r),
    )
  );
}
function VI(e, t) {
...
var lo = (function (e) {
  function t() {
    return (HI(this, t), XI(this, t, arguments));
  }
  return (
    ZI(t, e),
    KI(t, [
          ...
          var v = c.map(function (d) {
            ...
            if (a === "vertical") {
              ...
              (m.push({ x1: I, y1: $, x2: I, y2: T }),
                m.push({ x1: C, y1: E, x2: I, y2: E }),
                m.push({ x1: C, y1: $, x2: C, y2: T }));
...
var Zv = function (t) {
  var r = t.children,
    ...
    o = ze(r, xr);
  if (!o) return null;
  var u = xr.defaultProps,
    c = u !== void 0 ? Wt(Wt({}, u), o.props) : {},
    s;
  return (
    ...
    Wt(Wt(Wt({}, c), xr.getWithHeight(o, i)), {}, { payload: s, item: o })
  );
};
function Fn(e) {
  "@babel/helpers - typeof";
...
function je(e, t, r) {
  return Z(e) || Z(t) ? r : Se(t) ? qe(e, t, r) : V(t) ? t(e) : r;
}
function wn(e, t, r, n) {
  var i = iI(e, function (u) {
    return je(u, t);
  });
  if (r === "number") {
    ...
    return a.length ? [oo(a), ao(a)] : [1 / 0, -1 / 0];
  }
  var o = n
    ? i.filter(function (u) {
        return !Z(u);
...
var ck = function (t) {
    ...
    if (
      ...
      for (var A = 0; A < u; A++)
        if (
          (A === 0 && t <= (n[A].coordinate + n[A + 1].coordinate) / 2) ||
          (A > 0 &&
            A < u - 1 &&
            t > (n[A].coordinate + n[A - 1].coordinate) / 2 &&
            t <= (n[A].coordinate + n[A + 1].coordinate) / 2) ||
          (A === u - 1 && t > (n[A].coordinate + n[A - 1].coordinate) / 2)
        ) {
          o = n[A].index;
          break;
        }
    ...
    for (var o = {}, u = Object.keys(a), c = 0, s = u.length; c < s; c++)
      for (
        ...
        var v = f[l[p]],
          d = v.items,
          y = v.cateAxisId,
          b = d.filter(function (O) {
            return mt(O.type).indexOf("Bar") >= 0;
          });
        if (b && b.length) {
  ...
  lk = function (t) {
    ...
    if (o[0].barSize === +o[0].barSize) {
      var p = !1,
        h = i / c,
        v = o.reduce(function (A, m) {
          return A + m.barSize || 0;
        }, 0);
      ((v += (c - 1) * s),
        v >= i && ((v -= (c - 1) * s), (s = 0)),
  ...
  fk = function (t, r, n, i) {
    ...
    if (s) {
      ...
      if (
        ...
        return ye(ye({}, t), {}, Or({}, h, t[h] + (l || 0)));
      if (
        (d === "horizontal" || (d === "vertical" && h === "center")) &&
        v !== "middle" &&
        L(t[v])
      )
        return ye(ye({}, t), {}, Or({}, v, t[v] + (p || 0)));
    }
    return t;
  },
  pk = function (t, r, n) {
  ...
  Jv = function (t, r, n, i, a) {
    var o = r.props.children,
      u = Ye(o, lo).filter(function (s) {
        return pk(i, a, s.props.direction);
      });
    if (u && u.length) {
      ...
      return t.reduce(
        function (s, f) {
          var l = je(f, n);
          if (Z(l)) return s;
          var p = Array.isArray(l) ? [oo(l), ao(l)] : [l, l],
            h = c.reduce(
              function (v, d) {
                var y = je(f, d, 0),
  ...
  Qv = function (t, r, n, i, a) {
    var o = r.map(function (c) {
      ...
      return (n === "number" && s && Jv(t, c, s, i)) || wn(t, s, n, a);
    });
    if (n === "number")
      return o.reduce(
        function (c, s) {
  ...
  ry = function (t, r, n) {
    ...
    if (er(i)) {
      ...
      return { scale: (Gf[c] || xn)(), realScaleType: Gf[c] ? c : "point" };
    }
    return V(i) ? { scale: i } : { scale: xn(), realScaleType: "point" };
  },
  ep = 1e-4,
  ny = function (t) {
    var r = t.domain();
    if (!(!r || r.length <= 2)) {
      var n = r.length,
        i = t.range(),
        a = Math.min(i[0], i[1]) - ep,
        o = Math.max(i[0], i[1]) + ep,
        u = t(r[0]),
        c = t(r[n - 1]);
    ...
    if (!(r <= 0))
      for (var n = 0, i = t[0].length; n < i; ++n)
        for (var a = 0, o = 0, u = 0; u < r; ++u) {
          var c = ui(t[u][n][1]) ? t[u][n][0] : t[u][n][1];
          c >= 0
    ...
    if (!(r <= 0))
      for (var n = 0, i = t[0].length; n < i; ++n)
        for (var a = 0, o = 0; o < r; ++o) {
          var u = ui(t[o][n][1]) ? t[o][n][0] : t[o][n][1];
          u >= 0
    ...
    var u = o ? r.reverse() : r,
      ...
      s = u.reduce(function (l, p) {
        ...
        if (Se(d)) {
          ...
          w.stackGroups[ci("_stackId_")] = {
            numericAxisId: n,
            cateAxisId: i,
            items: [p],
          };
        return ye(ye({}, l), {}, Or({}, b, w));
      }, c),
      f = {};
        ...
        h.stackGroups = Object.keys(h.stackGroups).reduce(function (d, y) {
          ...
          return ye(
            ...
            Or({}, y, {
              ...
              cateAxisId: i,
              items: b.items,
              stackedData: bk(t, b.items, a),
            }),
          );
        }, v);
      }
      return ye(ye({}, l), {}, Or({}, p, h));
    }, f);
  },
  iy = function (t, r) {
    ...
    if (a && i === "number" && o && (o[0] === "auto" || o[1] === "auto")) {
      ...
      var f = kI(s, a, u);
      return (t.domain([oo(f), ao(f)]), { niceTicks: f });
    }
    if (a && i === "number") {
      var l = t.domain(),
        p = DI(l, a, u);
...
function WW(e) {
  ...
  if (t.type === "category") {
    if (!t.allowDuplicatedCategory && t.dataKey && !Z(i[t.dataKey])) {
      var u = Mi(r, "value", i[t.dataKey]);
      if (u) return u.coordinate + n / 2;
    }
    return r[a] ? r[a].coordinate + n / 2 : null;
  }
  var c = je(i, Z(o) ? t.dataKey : o);
...
var tp = function (t) {
    ...
    var c = je(o, r.dataKey, r.domain[u]);
  ...
  Ak = function (t) {
    return t.reduce(
      function (r, n) {
        return [oo(n.concat([r[0]]).filter(L)), ao(n.concat([r[1]]).filter(L))];
      },
      [1 / 0, -1 / 0],
    );
  },
  ...
  rp = /^dataMin[\s]*-[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/,
  np = /^dataMax[\s]*\+[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/,
  Fu = function (t, r, n) {
    if (V(t)) return t(r, n);
  ...
  ip = function (t, r, n) {
    return !t || !t.length || uo(t, qe(n, "type.defaultProps.domain")) ? r : t;
  },
  oy = function (t, r) {
...
var oa = Math.PI / 180,
  ...
  Ck = function (t, r, n, i, a) {
    ...
    return d.reduce(function (y, b) {
      ...
      var S = ry(w, a),
        _ = S.realScaleType,
        E = S.scale;
      (E.domain(x).range(m), ny(E));
      var $ = iy(E, ht(ht({}, w), {}, { realScaleType: _ })),
        T = ht(
          ht(ht({}, w), $),
          {},
          {
  ...
  kk = function (t, r) {
    var n = t.x,
      ...
      a = r.cx,
      o = r.cy,
      u = Ik({ x: n, y: i }, { x: a, y: o });
    if (u <= 0) return { radius: u };
    var c = (n - a) / u,
      s = Math.acos(c);
    return (
      i > o && (s = 2 * Math.PI - s),
      { radius: u, angle: Mk(s), angleInRadian: s }
    );
  },
  Dk = function (t) {
    var r = t.startAngle,
  ...
  up = function (t, r) {
    ...
    return v ? ht(ht({}, r), {}, { radius: o, angle: Nk(h, r) }) : null;
  },
  sy = function (t) {
    return !R.isValidElement(t) && !V(t) && typeof t != "boolean"
      ? t.className
      : "";
  };
function zn(e) {
...
var Xk = function (t) {
  ...
  Yk = function (t, r, n) {
    ...
    `,
        ...
        .concat(g.x, ",")
        .concat(g.y),
      S = Z(t.id) ? ci("recharts-radial-line-") : t.id;
    return P.createElement(
      "text",
      Un({}, n, {
      ...
      P.createElement("defs", null, P.createElement("path", { id: S, d: O })),
      ...
      : a === "insideRight"
        ...
        : a === "insideTop"
          ...
          : a === "insideBottom"
            ...
            : a === "insideTopLeft"
              ? Ae({ x: u + y, y: c + p, textAnchor: w, verticalAnchor: v }, O)
              : a === "insideTopRight"
                ? Ae(
                    {
                      x: u + s - y,
                ...
                : a === "insideBottomLeft"
                  ...
                  : a === "insideBottomRight"
                    ...
                    : Xr(a) && (L(a.x) || Xt(a.x)) && (L(a.y) || Xt(a.y))
                      ? Ae(
                          {
                            x: u + ke(a.x, s),
                            y: c + ke(a.y, f),
...
function $e(e) {
  var t = e.offset,
    ...
    l = f === void 0 ? "" : f,
    p = i.textBreakAll;
  if (!a || (Z(u) && Z(c) && !R.isValidElement(s) && !V(s))) return null;
  ...
  return P.createElement(
    rr,
    Un({ className: Q("recharts-label", l) }, d, y, { breakAll: p }),
    h,
  );
}
$e.displayName = "Label";
var ly = function (t) {
    ...
    if (w) return w;
    if (L(d) && L(y)) {
      if (L(l) && L(p)) return { x: l, y: p, width: d, height: y };
      if (L(h) && L(v)) return { x: h, y: v, width: d, height: y };
    }
    return L(l) && L(p)
  ...
  e2 = function (t, r) {
    return t
      ? t === !0
        ? P.createElement($e, { key: "label-implicit", viewBox: r })
        : Se(t)
          ? P.createElement($e, { key: "label-implicit", viewBox: r, value: t })
          : R.isValidElement(t)
            ? t.type === $e
            ...
            : V(t)
              ...
              : Xr(t)
                ? P.createElement(
                    $e,
                    Un({ viewBox: r }, t, { key: "label-implicit" }),
                  )
                : null
      : null;
  },
  t2 = function (t, r) {
    ...
    var i = t.children,
      a = ly(t),
      o = Ye(i, $e).map(function (c, s) {
        return R.cloneElement(c, { viewBox: r || a, key: "label-".concat(s) });
      });
    if (!n) return o;
    var u = e2(t.label, r || a);
    return [u].concat(Lk(o));
  };
$e.parseViewBox = ly;
$e.renderCallByParent = t2;
function r2(e) {
...
var y2 = function (t) {
  return Array.isArray(t.value) ? i2(t.value) : t.value;
};
function Ct(e) {
  ...
  return !i || !i.length
    ...
    : P.createElement(
        ...
        i.map(function (f, l) {
          var p = Z(a) ? r(f, l) : je(f && f.payload, a),
            h = Z(u) ? {} : { id: "".concat(u, "-").concat(l) };
          return P.createElement(
            $e,
            ua({}, X(f, !0), s, h, {
              ...
              value: p,
              textBreakAll: c,
              viewBox: $e.parseViewBox(
                Z(o) ? f : lp(lp({}, f), {}, { clockWise: o }),
              ),
              key: "label-".concat(l),
              index: l,
            }),
...
function m2(e, t) {
  return e
    ? e === !0
      ? P.createElement(Ct, { key: "labelList-implicit", data: t })
...
function g2(e, t) {
  ...
  var n = e.children,
    i = Ye(n, Ct).map(function (o, u) {
      return R.cloneElement(o, { data: t, key: "labelList-".concat(u) });
    });
  if (!r) return i;
  var a = m2(e.label, t);
  return [a].concat(u2(i));
}
Ct.renderCallByParent = g2;
function Hn(e) {
  "@babel/helpers - typeof";
  return (
    (Hn =
...
var O2 = function (t, r) {
  ...
  A2 = function (t) {
    var r = t.cx,
      ...
      w = y.lineTangency,
      x = y.theta,
      A = c ? Math.abs(s - f) : Math.abs(s - f) - d - x;
    if (A < 0)
      return u
        ? "M "
            .concat(v.x, ",")
  ...
  `,
    ...
    if (i > 0) {
      var g = Pi({
        ...
        T = E.lineTangency,
        C = E.theta,
        I = c ? Math.abs(s - f) : Math.abs(s - f) - _ - C;
      if (I < 0 && o === 0)
  ...
  py = function (t) {
    ...
    return (
      ...
      P.createElement(
        "path",
        Uu({}, X(r, !0), { className: h, d: y, role: "img" }),
      )
    );
  };
function Gn(e) {
...
var yp = {
  ...
  T2 = function (t, r) {
    ...
    return (n === "curveMonotone" || n === "curveBump") && r
      ? yp["".concat(n).concat(r === "vertical" ? "Y" : "X")]
      : yp[n] || Ka;
  },
  E2 = function (t) {
    var r = t.type,
    ...
    if (Array.isArray(o)) {
      ...
      return (
        ...
        p.defined(_i).curve(f),
        p(v)
      );
    }
    return (
      u === "vertical" && L(o)
        ? (p = yi().y(vn).x1(dn).x0(o))
        : L(o)
          ? (p = yi().x(dn).y1(vn).y0(o))
          : (p = od().x(dn).y(vn)),
      p.defined(_i).curve(f),
      p(l)
    );
...
function K2(e, t, r) {
  var n = xp(e),
    i = n.length;
  if (xp(t).length !== i) return !1;
  for (; i-- > 0; ) if (!yy(e, t, r, n[i])) return !1;
  return !0;
}
function yn(e, t, r) {
  var n = gp(e),
    i = n.length;
  if (gp(t).length !== i) return !1;
  for (var a, o, u; i-- > 0; )
    if (
      ((a = n[i]),
      !yy(e, t, r, a) ||
...
function yy(e, t, r, n) {
  return (n === W2 || n === F2 || n === B2) && (e.$$typeof || t.$$typeof)
    ? !0
    : L2(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
var J2 = "[object Arguments]",
  Q2 = "[object Boolean]",
  eD = "[object Date]",
  tD = "[object Error]",
  rD = "[object Map]",
  ...
  Ap =
    typeof ArrayBuffer == "function" && ArrayBuffer.isView
      ...
      : null,
  Sp = Object.assign,
  lD = Object.prototype.toString.call.bind(Object.prototype.toString);
function fD(e) {
  ...
  return function (v, d, y) {
    ...
    if (sD(v)) return t(v, d, y);
    if (Ap != null && Ap(v)) return l(v, d, y);
...
function pD(e) {
  var t = e.circular,
    ...
    n = e.strict,
    i = {
      areArraysEqual: n ? yn : z2,
      areDatesEqual: U2,
      areErrorsEqual: q2,
      areFunctionsEqual: H2,
      areMapsEqual: n ? mp(wp, yn) : wp,
      areNumbersEqual: G2,
      areObjectsEqual: n ? yn : K2,
      arePrimitiveWrappersEqual: X2,
      areRegExpsEqual: V2,
      areSetsEqual: n ? mp(Op, yn) : Op,
      areTypedArraysEqual: n ? yn : Y2,
      areUrlsEqual: Z2,
    };
  if ((r && (i = Sp({}, i, r(i))), t)) {
    var a = $i(i.areArraysEqual),
      o = $i(i.areMapsEqual),
      u = $i(i.areObjectsEqual),
      c = $i(i.areSetsEqual);
    i = Sp({}, i, {
      areArraysEqual: a,
      areMapsEqual: o,
    ...
    n = function i(a) {
      if (!r) {
        if (Array.isArray(a)) {
          ...
          (i(c), Pp(i.bind(null, s)));
          return;
        }
        (Gu(a) === "object" && ((e = a), t(e)), typeof a == "function" && a());
      }
    };
  return {
    stop: function () {
...
var PD = function (t, r) {
  ...
  On = function (t, r) {
    return Object.keys(r).reduce(function (n, i) {
      return Tp(Tp({}, n), {}, my({}, i, t(i, r[i])));
    }, {});
  },
  Ep = function (t, r, n) {
    return t
      .map(function (i) {
        return "".concat($D(i), " ").concat(r, "ms ").concat(n);
      })
      .join(",");
  };
function TD(e, t) {
  return MD(e) || jD(e, t) || gy(e, t) || ED();
}
function ED() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var ca = 1e-4,
  ...
  Mp = function () {
    ...
    var l = jp(i, o),
      ...
      d = function (b) {
        for (var w = b > 1 ? 1 : b, x = w, A = 0; A < 8; ++A) {
          var m = l(x) - w,
            g = h(x);
          if (Math.abs(m - w) < ca || g < ca) return p(x);
          x = v(x - m / g);
        }
        return p(x);
      };
    ...
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      ...
      c = function (f, l, p) {
        var h = -(f - l) * n,
          ...
          d = p + ((h - v) * u) / 1e3,
          y = (p * u) / 1e3 + f;
        return Math.abs(y - l) < ca && Math.abs(d) < ca ? [l, 0] : [y, d];
      };
    ...
    if (typeof i == "string")
      switch (i) {
        ...
        case "spring":
          return RD();
        default:
          if (i.split("(")[0] === "cubic-bezier") return Mp(i);
      }
    ...
    var i = On(function (a, o) {
      if (Yu(o)) {
        var u = t(o.from, o.to, o.velocity),
          ...
          s = c[0],
          f = c[1];
        return Ee(Ee({}, o), {}, { from: s, velocity: f });
      }
      return o;
    }, r);
    return n < 1
      ? On(function (a, o) {
          return Yu(o)
            ? Ee(
                ...
                {},
                {
                  velocity: sa(o.velocity, i[a].velocity, n),
                  from: sa(o.from, i[a].from, n),
                },
              )
            : o;
        }, r)
...
const VD = function (e, t, r, n, i) {
  var a = PD(e, t),
    o = a.reduce(function (y, b) {
      return Ee(Ee({}, y), {}, Xu({}, b, [e[b], t[b]]));
    }, {}),
    u = a.reduce(function (y, b) {
      return Ee(
        Ee({}, y),
        {},
        Xu({}, b, { from: e[b], velocity: 0, to: t[b] }),
      );
    }, {}),
    c = -1,
    s,
    ...
    d = function (b) {
      ...
      var w = (b - f) / n,
        x = On(function (m, g) {
          return sa.apply(void 0, Cp(g).concat([r(w)]));
        }, o);
      if ((i(Ee(Ee(Ee({}, e), t), x)), w < 1)) c = requestAnimationFrame(l);
      else {
        var A = On(function (m, g) {
          return sa.apply(void 0, Cp(g).concat([r(1)]));
        }, o);
        i(Ee(Ee(Ee({}, e), t), A));
      }
    };
...
var Ot = (function (e) {
  ...
  function r(n, i) {
    ...
    var o = a.props,
      ...
      h = o.duration;
    if (
      ((a.handleStyleChange = a.handleStyleChange.bind(ec(a))),
      (a.changeStyle = a.changeStyle.bind(ec(a))),
      !u || h <= 0)
    )
      return (
        (a.state = { style: {} }),
    ...
    if (l && l.length) a.state = { style: l[0].style };
      ...
      if (typeof p == "function") return ((a.state = { style: s }), Qu(a));
      a.state = { style: c ? gn({}, c, s) : s };
    } else a.state = { style: {} };
    return a;
  }
  return (
    aN(r, [
        ...
        value: function (i) {
          ...
          if (u) {
            ...
            if (!(vD(i.to, f) && i.canBegin && i.isActive)) {
              ...
              var d = v || s ? l : i.to;
              if (this.state && p) {
                var y = { style: c ? gn({}, c, d) : d };
                ((c && p[c] !== d) || (!c && p !== d)) && this.setState(y);
              }
              this.runAnimation(
                et(et({}, this.props), {}, { from: d, begin: 0 }),
              );
            }
          }
        },
      ...
      },
      {
        ...
        value: function (i) {
          var a = this,
            ...
            h = VD(o, u, LD(s), c, this.changeStyle),
            v = function () {
              a.stopJSAnimation = h();
            };
        ...
        value: function (i) {
          var a = this,
            ...
            h = function (d, y, b) {
              ...
              var E = Ep(_, w, A),
                $ = et(et(et({}, S.style), m), {}, { transition: E });
              return [].concat(Go(d), [$, w, O]).filter(_D);
            };
          return this.manager.start(
            [c].concat(Go(o.reduce(h, [f, Math.max(p, u)])), [
              i.onAnimationEnd,
            ]),
          );
        },
      },
      {
        ...
        value: function (i) {
          ...
          var d = u ? gn({}, u, c) : c,
            y = Ep(Object.keys(d), o, s);
          v.start([f, a, et(et({}, d), {}, { transition: y }), o, l]);
        },
      },
      {
        key: "render",
        value: function () {
          ...
          var l = function (h) {
            var v = h.props,
              ...
              w = R.cloneElement(
                h,
                et(et({}, c), {}, { style: et(et({}, y), f), className: b }),
              );
            return w;
          };
          return s === 1
...
var Lp = function (t, r, n, i, a) {
  ...
  As = function (t) {
    ...
    return w
      ...
      : P.createElement(
          "path",
          fa({}, X(r, !0), { className: x, d: Lp(c, s, f, l, p) }),
        );
  },
  xN = ["points", "className", "baseLinePoints", "connectNulls"];
function vr() {
  return (
    (vr = Object.assign
      ? Object.assign.bind()
    ...
    if (i && i.length) {
      ...
      return P.createElement(
        ...
        c
          ? P.createElement(
              "path",
              vr({}, X(o, !0), { fill: "none", d: An(r, a) }),
            )
          : null,
        c
          ? P.createElement(
              "path",
              vr({}, X(o, !0), { fill: "none", d: An(i, a) }),
            )
          : null,
      );
    }
...
var Ss = function (t) {
  ...
  return r === +r && n === +n && i === +i
    ? R.createElement(
        "circle",
        rc({}, X(t, !1), Ci(t), { className: o, cx: r, cy: n, r: i }),
      )
    : null;
};
function Yn(e) {
...
var jN = ["x", "y", "top", "left", "width", "height", "className"];
function nc() {
  return (
    (nc = Object.assign
      ? Object.assign.bind()
...
var RN = function (t, r, n, i, a, o) {
  ...
  LN = function (t) {
    var r = t.x,
      ...
      v = t.className,
      d = DN(t, jN),
      y = MN({ x: n, y: a, top: u, left: s, width: l, height: h }, d);
    return !L(n) || !L(a) || !L(l) || !L(h) || !L(u) || !L(s)
      ? null
      : P.createElement(
          "path",
          nc({}, X(y, !0), {
            className: Q("recharts-cross", v),
            d: RN(n, a, l, h, u, s),
          }),
        );
  },
  ...
  WN = lt;
function zN(e, t) {
  return e && e.length ? BN(e, WN(t), FN) : void 0;
}
var UN = zN;
const qN = oe(UN);
var HN = io,
  ...
  KN = Dv;
function XN(e, t) {
  return e && e.length ? HN(e, GN(t), KN) : void 0;
}
var VN = XN;
const YN = oe(VN);
var ZN = ["cx", "cy", "angle", "ticks", "axisLine"],
  JN = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function Ir(e) {
  "@babel/helpers - typeof";
  return (
    (Ir =
...
var po = (function (e) {
  function t() {
    return (eR(this, t), rR(this, t, arguments));
  }
  return (
    aR(t, e),
    tR(
            ...
            var n = this,
              ...
              v = a.map(function (d, y) {
                ...
                return P.createElement(
                  ...
                  Sn(
                    {
                      className: Q("recharts-polar-radius-axis-tick", sy(o)),
          ...
          value: function () {
            ...
            return !i || !i.length
              ...
              : P.createElement(
                  ...
                  o && this.renderTicks(),
                  $e.renderCallByParent(this.props, this.getViewBox()),
                );
          },
        },
      ],
...
function Gp(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      (n.configurable = !0),
      "value" in n && (n.writable = !0),
      Object.defineProperty(e, _y(n.key), n));
  }
}
function cR(e, t, r) {
  return (
...
function sR(e, t, r) {
  return (
    ...
    lR(
      e,
      Py() ? Reflect.construct(t, r || [], ha(e).constructor) : t.apply(e, r),
    )
  );
}
function lR(e, t) {
...
var dR = Math.PI / 180,
  ...
  vo = (function (e) {
    function t() {
      return (uR(this, t), sR(this, t, arguments));
    }
    return (
      pR(t, e),
      cR(
          ...
          },
          {
            ...
            value: function () {
              ...
              if (c === "circle")
                return P.createElement(
                  Ss,
                  Kt({ className: "recharts-polar-angle-axis-line" }, s, {
                    cx: i,
                    cy: a,
                    r: o,
                  }),
              ...
              var n = this,
                ...
                h = a.map(function (v, d) {
                  ...
                  return P.createElement(
                    ...
                    Kt(
                      {
                        className: Q("recharts-polar-angle-axis-tick", sy(o)),
...
var vR = jd,
  yR = vR(Object.getPrototypeOf, Object),
  mR = yR,
  gR = At,
  bR = mR,
  xR = St,
  ...
  PR = $y.call(Object);
function _R(e) {
  if (!xR(e) || gR(e) != wR) return !1;
  var t = bR(e);
  if (t === null) return !0;
  var r = SR.call(t, "constructor") && t.constructor;
  return typeof r == "function" && r instanceof r && $y.call(r) == PR;
}
var $R = _R;
const TR = oe($R);
var ER = At,
  ...
  qR = function (t) {
    ...
    return b
      ...
      : P.createElement(
          ...
          P.createElement(
            "path",
            da({}, X(r, !0), { className: w, d: Zp(c, s, f, l, p) }),
          ),
        );
  },
  HR = [
...
function Qp(e) {
  ...
  switch (t) {
    case "rectangle":
      return P.createElement(As, r);
    case "trapezoid":
      return P.createElement(qR, r);
    case "sector":
      return P.createElement(py, r);
    case "symbols":
      if (JR(t)) return P.createElement(Wc, r);
      break;
    default:
      return null;
  }
...
function Ty(e) {
  var t = e.option,
    ...
    c = GR(e, HR),
    s;
  if (R.isValidElement(t)) s = R.cloneElement(t, va(va({}, c), QR(t)));
  else if (V(t)) s = t(c);
  else if (TR(t) && !kR(t)) {
    var f = i(t, c);
    s = P.createElement(Qp, { shapeType: r, elementProps: f });
  } else {
    var l = c;
    s = P.createElement(Qp, { shapeType: r, elementProps: l });
  }
  return u ? P.createElement(ne, { className: o }, s) : s;
}
function yo(e, t) {
...
function nL(e, t) {
  var r;
  return (yo(e, t) ? (r = eL) : mo(e, t) ? (r = tL) : Qn(e, t) && (r = rL), r);
}
function iL(e, t) {
  var r;
  return (
...
function sL(e, t, r) {
  return (
    ...
    lL(
      e,
      Ey() ? Reflect.construct(t, r || [], ya(e).constructor) : t.apply(e, r),
    )
  );
}
function lL(e, t) {
              ...
              v = n.map(function (d, y) {
                ...
                return (
                  ...
                  P.createElement(
                    ...
                    u && t.renderLabelLineItem(u, A, "line"),
                    t.renderLabelItem(o, x, je(d, m)),
                  )
                );
              });
          ...
          value: function (n) {
            ...
            return n.map(function (s, f) {
              ...
              return P.createElement(
                ...
                P.createElement(
                  Ty,
                  yr({ option: h, isActive: l, shapeType: "sector" }, v),
                ),
              );
            });
          },
            ...
            return P.createElement(
              ...
              function (v) {
                var d = v.t,
                  ...
                  w = b.startAngle;
                return (
                  a.forEach(function (x, A) {
                    var m = p && p[A],
                      g = A > 0 ? qe(x, "paddingAngle", 0) : 0;
                    if (m) {
                      var O = $t(
                        ...
                        S = ce(
                          ce({}, x),
                          {},
                          { startAngle: w + g, endAngle: w + O(d) + g },
                        );
        ...
        },
        {
          ...
          value: function () {
            ...
            return P.createElement(
              ...
              $e.renderCallByParent(this.props, null, !1),
              (!h || v) && Ct.renderCallByParent(this.props, o, !1),
            );
          },
        },
      ],
      [
        ...
        },
        {
          ...
          value: function (n, i, a) {
            ...
            return P.createElement(
              Hu,
              yr({}, i, { key: a, type: "linear", className: o }),
            );
          },
        },
        {
          ...
          value: function (n, i, a) {
            ...
            return P.createElement(
              rr,
              yr({}, i, { alignmentBaseline: "middle", className: u }),
              o,
            );
          },
        },
...
Xe(Rt, "parseDeltaAngle", function (e, t) {
  var r = Ie(t - e),
    n = Math.min(Math.abs(t - e), 360);
  return r * n;
});
Xe(Rt, "getRealPieData", function (e) {
  var t = e.data,
    r = e.children,
    n = X(e, !1),
    i = Ye(r, Zc);
...
Xe(Rt, "parseCoordinateOfPie", function (e, t) {
  var r = t.top,
    n = t.left,
    i = t.width,
    a = t.height,
...
Xe(Rt, "getComposedData", function (e) {
  var t = e.item,
    r = e.offset,
    n =
  ...
  var a = n.cornerRadius,
    ...
    v = ji.parseCoordinateOfPie(n, r),
    d = ji.parseDeltaAngle(o, u),
    y = Math.abs(d),
    b = s;
  Z(s) && Z(l)
    ? (nt(
  ...
  if (m > 0) {
    ...
    g = i.map(function (S, _) {
      var E = je(S, b, 0),
        ...
        T = (L(E) ? E : 0) / m,
        C;
      _ ? (C = O.endAngle + Ie(d) * c * (E !== 0 ? 1 : 0)) : (C = o);
      var I = C + Ie(d) * ((E !== 0 ? h : 0) + T * A),
        M = (C + I) / 2,
...
var dL = Math.ceil,
  vL = Math.max;
function yL(e, t, r, n) {
  for (var i = -1, a = vL(dL((t - e) / (r || 1)), 0), o = Array(a); a--; )
    ((o[n ? a : ++i] = e), (e += r));
  return o;
}
var mL = yL,
...
function AL(e) {
  return function (t, r, n) {
    return (
      n && typeof n != "number" && OL(t, r, n) && (r = n = void 0),
      (t = Ko(t)),
...
var jL = ["Webkit", "Moz", "O", "ms"],
  ML = function (t, r) {
    var n = t.replace(/(\w)/, function (a) {
        return a.toUpperCase();
      }),
      i = jL.reduce(function (a, o) {
        return ih(ih({}, a), {}, Cy({}, o + n, r));
      }, {});
    return ((i[t] = r), i);
  };
function Nr(e) {
...
function kL(e, t, r) {
  return (
    ...
    DL(
      e,
      Iy() ? Reflect.construct(t, r || [], ba(e).constructor) : t.apply(e, r),
    )
  );
}
function DL(e, t) {
    ...
    function t(r) {
      ...
      return (
        ...
        We(n, "handleSlideDragStart", function (i) {
          var a = uh(i) ? i.changedTouches[0] : i;
          (n.setState({
            isTravellerMoving: !1,
            isSlideMoving: !0,
            ...
            value: function (n) {
              ...
              var x = this.getIndex(b),
                ...
                g = function () {
                  var S = y.length - 1;
                  return (
                    (o === "startX" && (u > c ? A % d === 0 : m % d === 0)) ||
                    (u < c && m === S) ||
                    (o === "endX" && (u > c ? m % d === 0 : A % d === 0)) ||
                    (u > c && m === S)
                  );
                };
              this.setState(
                We(We({}, o, s + w), "brushMoveStartX", n.pageX),
                function () {
                  v && g() && v(x);
                },
              );
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                return null;
              var x = Q("recharts-brush", a),
                A = P.Children.count(o) === 1,
...
function XL(e, t, r) {
  var n = GL(e) ? UL : HL;
  return (r && KL(e, t, r) && (t = void 0), n(e, qL(t)));
}
var VL = XL;
const YL = oe(VL);
var ut = function (t, r) {
...
function ZL(e, t, r) {
  t == "__proto__" && ch
    ? ch(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 })
    : (e[t] = r);
}
var JL = ZL,
  QL = JL,
...
function vB(e, t, r) {
  var n = hB(e) ? lB : fB;
  return (r && dB(e, t, r) && (t = void 0), n(e, pB(t)));
}
var yB = vB;
const Dy = oe(yB);
var mB = ["x", "y"];
...
function jB(e, t, r) {
  return (
    ...
    MB(
      e,
      Ry() ? Reflect.construct(t, r || [], wa(e).constructor) : t.apply(e, r),
    )
  );
}
function MB(e, t) {
...
var on = (function (e) {
  function t() {
    ...
    return (
      ...
      jt(r, "state", { isAnimationFinished: !1 }),
      jt(r, "id", ci("recharts-bar-")),
                  ...
                  d = a.map(function (y, b) {
                    ...
                    if (w) {
                      var x = $t(w.x, y.x),
                        A = $t(w.y, y.y),
                        m = $t(w.width, y.width),
                        g = $t(w.height, y.height);
                      return ge(
                        ge({}, y),
                        {},
                        { x: x(v), y: A(v), width: m(v), height: g(v) },
                      );
                    }
                    if (o === "horizontal") {
                      var O = $t(0, y.height),
          ...
          value: function (n, i) {
            ...
            var p = s === "vertical" ? o[0].height / 2 : o[0].width / 2,
              h = function (y, b) {
                ...
                return { x: y.x, y: y.y, value: w, errorVal: je(y, b) };
              },
            ...
            return P.createElement(
              ...
              P.createElement(
                ne,
                {
                  ...
                  clipPath: A ? "url(#clipPath-".concat(m, ")") : null,
                },
                v ? this.renderBackground() : null,
                this.renderRectangles(),
              ),
              this.renderErrorBar(A, m),
              (!h || y) && Ct.renderCallByParent(this.props, a),
            );
          },
        },
      ],
...
jt(on, "getComposedData", function (e) {
  var t = e.props,
    r = e.item,
    n = e.barPosition,
    i = e.bandSize,
  ...
  var v = t.layout,
    ...
    x = y.minPointSize,
    A = v === "horizontal" ? o : a,
    m = s ? A.scale.domain() : null,
    g = wk({ numericAxis: A }),
    O = Ye(w, Zc),
    S = l.map(function (_, E) {
      var $, T, C, I, M, k;
      s
        ? ($ = vk(s[f + E], m))
        : (($ = je(_, b)), Array.isArray($) || ($ = [g, $]));
      var D = SB(x, Ny.defaultProps.minPointSize)($[1], E);
      if (v === "horizontal") {
        var B,
        ...
        ((T = tp({
          ...
          (C = (B = G ?? q) !== null && B !== void 0 ? B : void 0),
          (I = h.size));
        var z = q - G;
        if (
          ((M = Number.isNaN(z) ? 0 : z),
          (k = { x: T, y: o.y, width: I, height: o.height }),
          Math.abs(D) > 0 && Math.abs(M) < Math.abs(D))
        ) {
          var K = Ie(M || D) * (Math.abs(D) - Math.abs(M));
          ((C -= K), (M += K));
        }
      } else {
        ...
        if (
          ...
          (I = Fe - me),
          (M = h.size),
          (k = { x: a.x, y: C, width: a.width, height: M }),
          Math.abs(D) > 0 && Math.abs(I) < Math.abs(D))
        ) {
          var Lt = Ie(I || D) * (Math.abs(D) - Math.abs(I));
          I += Lt;
        }
      }
      return ge(
        ...
        {},
        {
          tooltipPayload: [oy(r, _)],
          tooltipPosition: { x: T + I / 2, y: C + M / 2 },
        },
      );
    });
  return ge({ data: S, layout: v }, p);
});
function ri(e) {
  "@babel/helpers - typeof";
  return (
...
var LB = function (t, r, n, i, a) {
    ...
    return f.reduce(function (h, v) {
      ...
      if (
        ...
        var T = b[1] - b[0],
          C = 1 / 0,
          I = d.categoricalDomain.sort(Q0);
        if (
          (I.forEach(function (fe, me) {
            me > 0 && (C = Math.min((fe || 0) - (I[me - 1] || 0), C));
          }),
          Number.isFinite(C))
        ) {
          var M = C / T,
          ...
          if (
            (d.padding === "gap" && (O = (M * k) / 2), d.padding === "no-gap")
          ) {
            var D = ke(t.barCategoryGap, M * k),
              B = (M * k) / 2;
            O = B - D - ((B - D) / k) * D;
          }
        }
      ...
      var F = ry(d, a, p),
        q = F.scale,
        G = F.realScaleType;
      (q.domain(b).range(S), ny(q));
      var z = iy(q, tt(tt({}, d), {}, { realScaleType: G }));
      i === "xAxis"
        ? (($ = (y === "top" && !A) || (y === "bottom" && A)),
          (_ = n.left),
          (E = l[g] - $ * d.height))
  ...
  BB = function (t) {
    var r = t.x1,
      ...
      i = t.x2,
      a = t.y2;
    return Fy({ x: r, y: n }, { x: i, y: a });
  },
  Wy = (function () {
    function e(t) {
      (DB(this, e), (this.scale = t));
    }
    return NB(
      e,
      [
...
var Ps = function (t) {
  var r = Object.keys(t).reduce(function (n, i) {
    return tt(tt({}, n), {}, go({}, i, Wy.create(t[i])));
  }, {});
  return tt(
    tt({}, r),
    {},
    {
      apply: function (i) {
        var a =
          ...
          o = a.bandAware,
          u = a.position;
        return iB(i, function (c, s) {
          return r[s].apply(c, { bandAware: o, position: u });
        });
      },
      isInRange: function (i) {
        return Dy(i, function (a, o) {
...
function eF(e, t, r) {
  ...
  if (!n) return -1;
  var i = r == null ? 0 : JB(r);
  return (i < 0 && (i = QB(n + i, 0)), YB(e, ZB(t), i));
}
var tF = eF,
  rF = GB,
  nF = tF,
...
var uF = r0(
  ...
  _s = R.createContext(void 0),
  $s = R.createContext(void 0),
  zy = R.createContext(void 0),
  Uy = R.createContext({}),
  qy = R.createContext(void 0),
  Hy = R.createContext(0),
  Gy = R.createContext(0),
  vh = function (t) {
    var r = t.state,
      n = r.xAxisMap,
      i = r.yAxisMap,
          ...
          P.createElement(
            ...
            P.createElement(
              ...
              P.createElement(
                Hy.Provider,
                { value: s },
                P.createElement(Gy.Provider, { value: c }, u),
              ),
            ),
          ),
        ),
  ...
  cF = function () {
    return R.useContext(qy);
  },
  Ky = function (t) {
    var r = R.useContext(_s);
    r == null && ir();
    var n = r[t];
    return (n == null && ir(), n);
  },
  sF = function () {
    var t = R.useContext(_s);
    return Et(t);
  },
  lF = function () {
    var t = R.useContext($s),
      r = oF(t, function (n) {
        return Dy(n.domain, Number.isFinite);
      });
    return r || Et(t);
  },
  Xy = function (t) {
    var r = R.useContext($s);
    r == null && ir();
    var n = r[t];
    return (n == null && ir(), n);
  },
  fF = function () {
    var t = R.useContext(zy);
    return t;
  },
  pF = function () {
...
function yF(e, t, r) {
  return (
    ...
    mF(
      e,
      Vy() ? Reflect.construct(t, r || [], Oa(e).constructor) : t.apply(e, r),
    )
  );
}
function mF(e, t) {
    ...
    return (
      P.isValidElement(t)
        ...
        : V(t)
          ...
          : (n = P.createElement(
              "line",
              fc({}, r, { className: "recharts-reference-line-line" }),
            )),
      n
    );
  },
  $F = function (t, r, n, i, a, o, u, c, s) {
    var f = a.x,
      l = a.y,
      p = a.width,
      h = a.height;
    if (n) {
      ...
      if (ut(s, "discard") && !t.y.isInRange(d)) return null;
      var y = [
        { x: f + p, y: d },
        { x: f, y: d },
      ];
    ...
    if (r) {
      ...
      if (ut(s, "discard") && !t.x.isInRange(w)) return null;
      var x = [
        { x: w, y: l + h },
        { x: w, y: l },
      ];
...
function TF(e) {
  ...
  var h = Ps({ x: f.scale, y: l.scale }),
    ...
    d = Se(r),
    y = n && n.length === 2,
    b = $F(h, v, d, y, p, e.position, f.orientation, l.orientation, e);
  if (!b) return null;
  var w = wF(b, 2),
    x = w[0],
    A = x.x,
    ...
    O = g.x,
    S = g.y,
    _ = ut(e, "hidden") ? "url(#".concat(s, ")") : void 0,
    E = mh(mh({ clipPath: _ }, X(e, !0)), {}, { x1: A, y1: m, x2: O, y2: S });
  return P.createElement(
    ne,
    { className: Q("recharts-reference-line", u) },
    _F(o, E),
    $e.renderCallByParent(e, BB({ x1: A, y1: m, x2: O, y2: S })),
  );
}
var Ms = (function (e) {
  function t() {
    return (hF(this, t), yF(this, t, arguments));
  }
  return (
    bF(t, e),
    vF(t, [
      {
        key: "render",
        value: function () {
          return P.createElement(TF, this.props);
        },
      },
    ])
  );
})(P.Component);
js(Ms, "displayName", "ReferenceLine");
js(Ms, "defaultProps", {
  isFront: !1,
  ifOverflow: "discard",
  xAxisId: 0,
...
function CF(e, t, r) {
  return (
    ...
    IF(
      e,
      Zy() ? Reflect.construct(t, r || [], Aa(e).constructor) : t.apply(e, r),
    )
  );
}
function IF(e, t) {
...
var RF = function (t) {
  ...
  xo = (function (e) {
    function t() {
      return (EF(this, t), CF(this, t, arguments));
    }
    return (
      DF(t, e),
      MF(t, [
        {
          ...
          value: function () {
            ...
            var p = l.x,
              ...
              d = v.shape,
              y = v.className,
              b = ut(this.props, "hidden") ? "url(#".concat(c, ")") : void 0,
              w = xh(
                xh({ clipPath: b }, X(this.props, !0)),
                {},
                { cx: p, cy: h },
              );
            return P.createElement(
              ne,
              { className: Q("recharts-reference-dot", y) },
              t.renderDot(d, w),
...
function BF(e, t) {
  for (var r = 0; r < t.length; r++) {
    ...
    ((n.enumerable = n.enumerable || !1),
      (n.configurable = !0),
      "value" in n && (n.writable = !0),
      Object.defineProperty(e, em(n.key), n));
  }
}
function FF(e, t, r) {
  return (
...
function WF(e, t, r) {
  return (
    ...
    zF(
      e,
      Qy() ? Reflect.construct(t, r || [], Sa(e).constructor) : t.apply(e, r),
    )
  );
}
function zF(e, t) {
...
var GF = function (t, r, n, i, a) {
    ...
    return ut(a, "discard") && (!p.isInRange(h) || !p.isInRange(v))
      ? null
      : Fy(h, v);
  },
  Oo = (function (e) {
    function t() {
      return (LF(this, t), WF(this, t, arguments));
    }
    return (
      qF(t, e),
      FF(t, [
        {
          ...
          value: function () {
            ...
            var y = GF(l, p, h, v, this.props);
            if (!y && !d) return null;
            var b = ut(this.props, "hidden") ? "url(#".concat(f, ")") : void 0;
            return P.createElement(
              ne,
              { className: Q("recharts-reference-area", c) },
              t.renderRect(d, Oh(Oh({ clipPath: b }, X(this.props, !0)), y)),
              $e.renderCallByParent(this.props, y),
            );
          },
        },
      ])
  ...
  return (
    P.isValidElement(e)
      ...
      : V(e)
        ...
        : (r = P.createElement(
            As,
            dc({}, t, { className: "recharts-reference-area-rect" }),
          )),
    r
  );
});
...
function Cs(e, t, r) {
  ...
  if (L(c) || tn.isSsr) return VF(i, typeof c == "number" && L(c) ? c : 0);
  var p = [],
    h = u === "top" || u === "bottom" ? "width" : "height",
    v =
      f && h === "width"
        ? bn(f, { fontSize: t, letterSpacing: r })
        : { width: 0, height: 0 },
    d = function (x, A) {
      var m = V(s) ? s(x.value, A) : x.value;
      return h === "width"
        ? KF(bn(m, { fontSize: t, letterSpacing: r }), v, l)
        : bn(m, { fontSize: t, letterSpacing: r })[h];
    },
  ...
  return c === "equidistantPreserveStart"
    ...
    : (c === "preserveStart" || c === "preserveStartEnd"
        ? (p = t3(y, b, d, i, o, c === "preserveStartEnd"))
        : (p = e3(y, b, d, i, o)),
      p.filter(function (w) {
        return w.isShow;
      }));
...
function c3(e, t, r) {
  return (
    ...
    s3(
      e,
      rm() ? Reflect.construct(t, r || [], _a(e).constructor) : t.apply(e, r),
    )
  );
}
function s3(e, t) {
      ...
      [
        {
          ...
          value: function (n, i) {
            var a = n.viewBox,
              ...
              c = u.viewBox,
              s = Vo(u, n3);
            return !br(a, c) || !br(o, s) || !br(i, this.state);
          },
        },
        {
          key: "componentDidMount",
        ...
        },
        {
          ...
          value: function (n, i, a) {
            var o = this,
              ...
              l = u.tickFormatter,
              p = u.unit,
              h = Cs(Oe(Oe({}, this.props), {}, { ticks: n }), i, a),
              v = this.getTickTextAnchor(),
              d = this.getTickVerticalAnchor(),
              y = X(this.props, !1),
              b = X(f, !1),
              w = Oe(Oe({}, y), {}, { fill: "none" }, X(c, !1)),
              x = h.map(function (A, m) {
                var g = o.getTickLineCoord(A),
                  O = g.line,
                  S = g.tick,
                  _ = Oe(
                    Oe(
                ...
                return P.createElement(
                  ...
                  f &&
                    t.renderTickItem(
                      f,
                      _,
                      "".concat(V(l) ? l(A.value, m) : A.value).concat(p || ""),
                    ),
                );
              });
            return P.createElement(
            ...
            return (
              ...
              o <= 0 || u <= 0 || !v || !v.length
                ...
                : P.createElement(
                    ne,
                    {
                      className: Q("recharts-cartesian-axis", s),
                      ref: function (y) {
                        n.layerReference = y;
                      },
                    },
      ...
      [
        {
          ...
          value: function (n, i, a) {
            var o,
              u = Q(i.className, "recharts-cartesian-axis-tick-value");
            return (
              P.isValidElement(n)
                ? (o = P.cloneElement(n, Oe(Oe({}, i), {}, { className: u })))
                : V(n)
...
Is(un, "displayName", "CartesianAxis");
Is(un, "defaultProps", {
  x: 0,
  y: 0,
  width: 0,
...
var S3 = function (t, r) {
    ...
    return ty(
      Cs(
        Ce(
          Ce(Ce({}, un.defaultProps), n),
          {},
          { ticks: yt(n, !0), viewBox: { x: 0, y: 0, width: i, height: a } },
        ),
      ),
      o.left,
      o.left + o.width,
...
function _3(e) {
  var t,
    ...
    f = Ce(
      ...
      {},
      {
        ...
        horizontal:
          (n = e.horizontal) !== null && n !== void 0 ? n : hr.horizontal,
        horizontalFill:
        ...
        verticalFill:
          (o = e.verticalFill) !== null && o !== void 0 ? o : hr.verticalFill,
        x: L(e.x) ? e.x : s.left,
        y: L(e.y) ? e.y : s.top,
  ...
  if (
    ...
    return null;
  var A = f.verticalCoordinatesGenerator || S3,
    m = f.horizontalCoordinatesGenerator || P3,
  ...
  if ((!g || !g.length) && V(m)) {
    var S = y && y.length,
      _ = m(
        {
          yAxis: x ? Ce(Ce({}, x), {}, { ticks: S ? y : x.ticks }) : void 0,
          width: u,
          height: c,
          offset: s,
        },
  ...
  return P.createElement(
    ...
    P.createElement(
      x3,
      Zt({}, f, { offset: s, horizontalPoints: g, xAxis: w, yAxis: x }),
    ),
    P.createElement(
      w3,
      Zt({}, f, { offset: s, verticalPoints: O, xAxis: w, yAxis: x }),
    ),
    P.createElement(O3, Zt({}, f, { horizontalPoints: g })),
    P.createElement(A3, Zt({}, f, { verticalPoints: O })),
  );
}
_3.displayName = "CartesianGrid";
function Ur(e) {
  "@babel/helpers - typeof";
  return (
    (Ur =
...
function j3(e, t, r) {
  return (
    ...
    M3(
      e,
      am() ? Reflect.construct(t, r || [], $a(e).constructor) : t.apply(e, r),
    )
  );
}
function M3(e, t) {
...
var ks = (function (e) {
  function t() {
    return ($3(this, t), j3(this, t, arguments));
  }
  return (
    I3(t, e),
    E3(t, [
      {
        key: "render",
        value: function () {
          return R.createElement(D3, this.props);
        },
      },
    ])
  );
})(R.Component);
om(ks, "displayName", "XAxis");
om(ks, "defaultProps", {
  allowDecimals: !0,
  hide: !1,
  orientation: "bottom",
...
function B3(e, t, r) {
  return (
    ...
    F3(
      e,
      cm() ? Reflect.construct(t, r || [], Ta(e).constructor) : t.apply(e, r),
    )
  );
}
function F3(e, t) {
...
var q3 = function (t) {
  ...
  Ds = (function (e) {
    function t() {
      return (N3(this, t), B3(this, t, arguments));
    }
    return (
      z3(t, e),
      L3(t, [
        {
          key: "render",
          value: function () {
            return R.createElement(q3, this.props);
          },
        },
      ])
    );
  })(R.Component);
sm(Ds, "displayName", "YAxis");
sm(Ds, "defaultProps", {
  allowDuplicatedCategory: !0,
  allowDecimals: !0,
  hide: !1,
...
var tW = (function () {
  function e() {
    (Z3(this, e),
      Jo(this, "activeIndex", 0),
      Jo(this, "coordinateList", []),
      Jo(this, "layout", "horizontal"));
  }
  return Q3(e, [
    {
      key: "setDetails",
...
function cW(e) {
  ...
  var v,
    d = Hu;
  if (p === "ScatterChart") ((v = o), (d = LN));
  else if (p === "BarChart") ((v = nW(l, o, c, f)), (d = As));
  else if (l === "radial") {
    var y = hm(o),
      b = y.cx,
      w = y.cy,
    ...
    ((v = {
      ...
      (d = py));
  } else ((v = { points: iW(l, o, c) }), (d = Hu));
  var g = Ti(
    Ti(Ti(Ti({ stroke: "#ccc", pointerEvents: "none" }, c), v), X(h, !1)),
    {},
    {
      payload: u,
      payloadIndex: s,
      className: Q("recharts-tooltip-cursor", h.className),
    },
  );
  return R.isValidElement(h) ? R.cloneElement(h, g) : R.createElement(d, g);
}
var sW = ["item"],
  lW = [
    "children",
...
function gW(e, t, r) {
  return (
    ...
    bW(
      e,
      dm() ? Reflect.construct(t, r || [], Ea(e).constructor) : t.apply(e, r),
    )
  );
}
function bW(e, t) {
...
var _W = { xAxis: ["bottom", "top"], yAxis: ["left", "right"] },
  ...
  Ao = function (t, r) {
    var n = r.graphicalItems,
      ...
      o = (n ?? []).reduce(function (u, c) {
        var s = c.props.data;
        return s && s.length ? [].concat(Gr(u), Gr(s)) : u;
      }, []);
    return o.length > 0
      ? o
      : t && t.length && L(i) && L(a)
...
var Pc = function (t, r, n, i) {
  ...
  jW = function (t, r) {
    ...
    return n.reduce(function (v, d) {
      ...
      var E = Ao(t.data, {
          graphicalItems: i.filter(function (z) {
            var K,
              fe =
                o in z.props
                  ? z.props[o]
                  : (K = z.type.defaultProps) === null || K === void 0
                    ? void 0
                    : K[o];
            return fe === _;
          }),
        ...
        I;
      rW(b.domain, A, w) &&
        ((T = Fu(b.domain, null, A)),
        h && (w === "number" || g !== "auto") && (I = wn(E, x, "category")));
      var M = gm(w);
      if (!T || T.length === 0) {
        var k,
          D = (k = b.domain) !== null && k !== void 0 ? k : M;
        if (x) {
          if (((T = wn(E, x, w)), w === "category" && h)) {
            var B = J0(T);
            m && B
              ? ((C = T), (T = ma(0, $)))
              : m ||
                (T = ip(D, T, d).reduce(function (z, K) {
                  return z.indexOf(K) >= 0 ? z : [].concat(Gr(z), [K]);
                }, []));
          } else if (w === "category")
            m
          ...
          h
            ...
            : u && u[_] && u[_].hasStack && w === "number"
              ? (T = p === "expand" ? [0, 1] : ay(u[_].stackGroups, c, s))
              : (T = Qv(
                  E,
                  i.filter(function (z) {
                    var K = o in z.props ? z.props[o] : z.type.defaultProps[o],
                      fe =
                        "hide" in z.props
                          ? z.props.hide
        ...
        if (w === "number") ((T = Oc(l, T, _, a, O)), D && (T = Fu(D, T, A)));
        ...
        H(
          ...
          j(
            ...
            {},
            {
              ...
              categoricalDomain: I,
              duplicateDomain: C,
              originalDomain: (y = b.domain) !== null && y !== void 0 ? y : M,
              isCategorical: h,
              layout: f,
            },
          ),
      ...
      if (!y[x]) {
        ...
        return (
          v
            ? (m = ma(0, h))
            : u && u[x] && u[x].hasStack
              ? ((m = ay(u[x].stackGroups, c, s)), (m = Oc(l, m, x, a)))
              : ((m = Fu(
                  A,
                  Qv(
                    p,
          ...
          j(
            ...
            H(
              ...
              j(
                ...
                {
                  hide: !0,
                  orientation: qe(_W, "".concat(a, ".").concat(d % 2), null),
                  domain: m,
                  originalDomain: A,
                  isCategorical: v,
                  layout: f,
  ...
  DW = function (t, r) {
      ...
      y = Object.keys(o).reduce(
        function (m, g) {
          var O = o[g],
            S = O.orientation;
          return !O.mirror && !O.hide
            ? j(j({}, m), {}, H({}, S, qe(m, "".concat(S)) + O.height))
            : m;
        },
    ...
    return j(
      j({ brushBottom: w }, b),
      {},
      { width: Math.max(x, 0), height: Math.max(A, 0) },
    );
  },
  NW = function (t, r) {
  ...
  bm = function (t) {
    var r = t.chartName,
        ...
        return (
          x.forEach(function (F, q) {
            var G = Ao(b.data, {
              ...
              Fe = z["".concat(k, "Id")],
              Lt = {},
              Ne = c.reduce(function (Bt, Ft) {
                var So = w["".concat(Ft.axisType, "Map")],
                  Ns = z["".concat(Ft.axisType, "Id")];
                (So && So[Ns]) || Ft.axisType === "zAxis" || ir();
                var Rs = So[Ns];
                return j(
                  j({}, Bt),
                  {},
              ...
              W = Ne[k],
              Y = Ne["".concat(k, "Ticks")],
              J = A && A[me] && A[me].hasStack && Ok(F, A[me].stackGroups),
              N = mt(F.type).indexOf("Bar") >= 0,
              ve = aa(W, Y),
              ee = [],
              xe =
                D && sk({ barSize: _, stackGroups: A, totalSize: NW(Ne, k) });
            if (N) {
              var we,
                Re,
                _t = Z(fe) ? C : fe,
                lr =
                  (we =
                    (Re = aa(W, Y, !0)) !== null && Re !== void 0 ? Re : _t) !==
                    null && we !== void 0
                    ? we
                    : 0;
              ((ee = lk({
                barGap: $,
                barCategoryGap: T,
                bandSize: lr !== ve ? lr : ve,
                sizeList: xe[Fe],
                maxBarSize: _t,
              })),
                lr !== ve &&
                  (ee = ee.map(function (Bt) {
                    return j(
                      j({}, Bt),
                      {},
                      {
                        position: j(
                          j({}, Bt.position),
                          {},
                          { offset: Bt.position.offset - lr / 2 },
                        ),
                      },
                    );
                  })));
            ...
            di &&
              B.push({
                props: j(
                  ...
                  H(
                    H(
                      H({ key: F.key || "item-".concat(q) }, M, Ne[M]),
                      k,
                      Ne[k],
                    ),
                    "animationId",
      ...
      h = function (b, w) {
        ...
        var O = x.children,
          ...
          I = T.cateAxisName,
          M = Ye(O, n),
          k = xk(E, M, "".concat(C, "Id"), "".concat(I, "Id"), _, $),
          D = c.reduce(function (z, K) {
            var fe = "".concat(K.axisType, "Map");
            return j(
              j({}, z),
              {},
              H(
          ...
          B = DW(
            j(j({}, D), {}, { props: x, graphicalItems: M }),
      ...
      v = (function (y) {
        function b(w) {
          ...
          return (
            vW(this, b),
            (m = gW(this, b, [w])),
            H(m, "eventEmitterSymbol", Symbol("rechartsEventEmitter")),
            H(m, "accessibilityManager", new tW()),
            H(m, "handleLegendBBoxUpdate", function (g) {
              if (g) {
                var O = m.state,
                  S = O.dataStartIndex,
                  _ = O.dataEndIndex,
            ...
            H(m, "handleReceiveSyncEvent", function (g, O, S) {
              if (m.props.syncId === g) {
                if (
            ...
            H(m, "triggerSyncEvent", function (g) {
              m.props.syncId !== void 0 &&
                Yo.emit(Zo, m.props.syncId, g, m.eventEmitterSymbol);
            }),
            H(m, "applySyncEvent", function (g) {
              ...
              if (g.dataStartIndex !== void 0 || g.dataEndIndex !== void 0)
                ...
                var q = j(j({}, D), {}, { x: D.left, y: D.top }),
                  ...
                  K = B[M] && B[M].value,
                  fe = Pc(m.state, m.props.data, M),
                  me = B[M]
                    ? {
                        x: S === "horizontal" ? B[M].coordinate : G,
                        y: S === "horizontal" ? z : B[M].coordinate,
                      }
                    : mm;
                m.setState(
                  j(
            ...
            H(m, "renderCursor", function (g) {
              var O,
                ...
                $ = S.activePayload,
                T = S.offset,
                C = S.activeTooltipIndex,
                I = S.tooltipAxisBandSize,
                M = m.getTooltipEventType(),
                k = (O = g.props.active) !== null && O !== void 0 ? O : _,
                D = m.props.layout,
            ...
            H(m, "renderPolarAxis", function (g, O, S) {
              var _ = qe(g, "type.axisType"),
                E = qe(m.state, "".concat(_, "Map")),
                $ = g.type.defaultProps,
            ...
            H(m, "renderPolarGrid", function (g) {
              ...
              return R.cloneElement(g, {
                polarAngles: Array.isArray(_)
                  ? _
                  : yt(M, !0).map(function (q) {
                      return q.coordinate;
                    }),
                polarRadius: Array.isArray(E)
                  ? E
                  : yt(I, !0).map(function (q) {
                      return q.coordinate;
                    }),
                cx: k,
                cy: D,
            ...
            H(m, "renderBrush", function (g) {
              ...
              return R.cloneElement(g, {
                ...
                onChange: Si(m.handleBrushChange, g.props.onChange),
                data: _,
                x: L(g.props.x) ? g.props.x : $.left,
                y: L(g.props.y)
                  ? g.props.y
                  : $.top + $.height + $.brushBottom - (S.bottom || 0),
                width: L(g.props.width) ? g.props.width : $.width,
                startIndex: T,
                endIndex: C,
                updateId: "brush-".concat(I),
              });
            }),
            H(m, "renderReferenceElement", function (g, O, S) {
              if (!g) return null;
              var _ = m,
                E = _.clipPathId,
                $ = m.state,
                ...
                C = $.yAxisMap,
                I = $.offset,
                M = g.type.defaultProps || {},
                k = g.props,
                D = k.xAxisId,
                B = D === void 0 ? M.xAxisId : D,
                F = k.yAxisId,
                q = F === void 0 ? M.yAxisId : F;
              return R.cloneElement(g, {
                key: g.key || "".concat(O, "-").concat(S),
                xAxis: T[B],
                yAxis: C[q],
              ...
              var O = g.item,
                ...
                I =
                  O.item.type.defaultProps !== void 0
                    ? j(j({}, O.item.type.defaultProps), O.item.props)
                    : O.item.props,
                M = I.activeDot,
                k = I.dataKey,
                D = j(
            ...
            H(m, "renderGraphicChild", function (g, O, S) {
              var _ = m.filterFormatItem(g, O, S);
              if (!_) return null;
              ...
              E !== "axis" && D && D.props.trigger === "click"
                ? (Ne = {
                    onClick: Si(m.handleItemMouseEnter, g.props.onClick),
                  })
                : E !== "axis" &&
                  (Ne = {
                    onMouseLeave: Si(
              ...
              var W = R.cloneElement(g, j(j({}, _.props), Ne));
              function Y(Ft) {
                return typeof C.dataKey == "function"
                  ? C.dataKey(Ft.payload)
                  : null;
              }
              if (Lt)
                if (I >= 0) {
                  ...
                  if (C.dataKey && !C.allowDuplicatedCategory) {
                    var ve =
                      typeof C.dataKey == "function"
                        ? Y
                        : "payload.".concat(C.dataKey.toString());
                    ((J = Mi(F, ve, M)), (N = q && G && Mi(G, ve, M)));
                  } else
                    ((J = F == null ? void 0 : F[I]), (N = q && G && G[I]));
                  if (Fe || me) {
                    var ee =
                  ...
                  var xe,
                    ...
                    lr = _t === void 0 ? g : _t,
                    di = Re.childIndex,
                    Bt = j(j(j({}, _.props), Ne), {}, { activeIndex: di });
                  return [R.cloneElement(lr, Bt), null, null];
                }
              return q ? [W, null, null] : [W, null];
            }),
            H(m, "renderCustomized", function (g, O, S) {
              return R.cloneElement(
                g,
                j(
            ...
            H(m, "renderMap", {
              CartesianGrid: { handler: Ei, once: !0 },
              ReferenceArea: { handler: m.renderReferenceElement },
              ReferenceLine: { handler: Ei },
            ...
            (m.clipPathId = "".concat(
              (x = w.id) !== null && x !== void 0 ? x : ci("recharts"),
              "-clip",
            )),
            (m.throttleTriggeredAfterMouseMove = Yd(
          ...
          mW(b, [
                    ...
                    offset: {
                      left:
                        (x = this.props.margin.left) !== null && x !== void 0
                          ...
                          : 0,
                      top:
                        (A = this.props.margin.top) !== null && A !== void 0
                          ? A
                          : 0,
                    },
              ...
              value: function () {
                ...
                if (S) {
                  ...
                  if (
                    ...
                    k &&
                      ((M = j(j({}, M), k.props.points[_].tooltipPosition)),
            ...
            },
            {
              ...
              value: function (x, A) {
                ...
                if (
                  (this.state.tooltipTicks !== A.tooltipTicks &&
                    this.accessibilityManager.setDetails({
                      coordinateList: this.state.tooltipTicks,
                    }),
            ...
            },
            {
              key: "componentDidUpdate",
              value: function (x) {
                tu([ze(x.children, pt)], [ze(this.props.children, pt)]) ||
                  this.displayDefaultTooltip();
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                var x = ze(this.props.children, pt);
                if (x && typeof x.props.shared == "boolean") {
                  var A = x.props.shared ? "axis" : "item";
                  return u.indexOf(A) >= 0 ? A : a;
                }
                return a;
              },
            },
            {
              ...
              value: function (x) {
                ...
                var A = this.container,
                  ...
                  S = m.width / A.offsetWidth || 1,
                  _ = this.inRange(O.chartX, O.chartY, S);
                if (!_) return null;
                var E = this.state,
                  $ = E.xAxisMap,
                  T = E.yAxisMap,
                  C = this.getTooltipEventType(),
                  I = Ih(this.state, this.props.data, this.props.layout, _);
                if (C !== "axis" && $ && T) {
                  var M = Et($).scale,
                    k = Et(T).scale,
                    D = M && M.invert ? M.invert(O.chartX) : null,
                    B = k && k.invert ? k.invert(O.chartY) : null;
                  return j(j({}, O), {}, { xValue: D, yValue: B }, I);
                }
                return I ? j(j({}, O), I) : null;
              },
            },
            {
              key: "inRange",
            ...
            },
            {
              ...
              value: function () {
                ...
                var O = Ci(this.props, this.handleOuterEvent);
                return j(j({}, O), g);
              },
            },
            {
              key: "addListener",
              value: function () {
                Yo.on(Zo, this.handleReceiveSyncEvent);
              },
            },
            {
              key: "removeListener",
              value: function () {
                Yo.removeListener(Zo, this.handleReceiveSyncEvent);
              },
            },
            {
              key: "filterFormatItem",
              value: function (x, A, m) {
                for (
                  ...
                  if (
                    _.item === x ||
                    _.props.key === x.key ||
                    (A === mt(_.item.type) && m === _.childIndex)
                  )
                    return _;
                }
                return null;
            ...
            },
            {
              ...
              value: function () {
                ...
                return x
                  ? Object.entries(x).reduce(function (A, m) {
                      var g = jh(m, 2),
                        O = g[0],
                        S = g[1];
                      return j(j({}, A), {}, H({}, O, S.scale));
                    }, {})
                  : null;
              },
            },
            ...
            },
            {
              ...
              value: function (x) {
                var A;
                return (A = this.state.xAxisMap) === null ||
                  A === void 0 ||
                  (A = A[x]) === null ||
                  A === void 0
                  ? void 0
            ...
            },
            {
              ...
              value: function (x) {
                var A;
                return (A = this.state.yAxisMap) === null ||
                  A === void 0 ||
                  (A = A[x]) === null ||
                  A === void 0
                  ? void 0
                ...
                if (m && m.length)
                  for (var O = 0, S = m.length; O < S; O++) {
                    ...
                    if (C === "Bar") {
                      ...
                      var M = (E.data || []).find(function (B) {
                        return up(x, B);
                      });
                      if (M) return { graphicalItem: _, payload: M };
                    } else if (yo(_, g) || mo(_, g) || Qn(_, g)) {
                      var k = oL({
                          graphicalItem: _,
                          activeTooltipItem: g,
                          itemData: T.data,
                      ...
                      return {
                        ...
                        payload: Qn(_, g) ? T.data[k] : _.props.data[k],
                      };
                    }
                  }
                return null;
              ...
              value: function () {
                ...
                if (E)
                  return P.createElement(
                    ...
                    P.createElement(
                      nu,
                      gr({}, I, { width: O, height: S, title: $, desc: T }),
                      this.renderClipPath(),
                      Qs(m, this.renderMap),
                    ),
                  );
                ...
                return P.createElement(
                  ...
                  P.createElement(
                    ...
                    gr(
                      {
                        className: Q("recharts-wrapper", g),
                        style: j(
                          {
                            position: "relative",
                            cursor: "default",
    ...
    (H(v, "displayName", r),
      ...
      H(v, "getDerivedStateFromProps", function (y, b) {
        var w = y.dataKey,
          x = y.data,
          A = y.children,
          m = y.width,
        ...
        if (
          ...
          var C = kh(y),
            ...
            M = j(j({}, Ih(b, x, O)), {}, { updateId: b.updateId + 1 }),
            k = j(j(j({}, C), I), M);
          return j(
            ...
            j(
              ...
              h(
                j(
                  j({ props: y }, b),
                  {},
                  { updateId: Fe, dataStartIndex: z, dataEndIndex: K },
                ),
                b,
              ),
            ),
            {},
            { prevChildren: A, dataStartIndex: z, dataEndIndex: K },
          );
        }
        return null;
      }),
      H(v, "renderActiveDot", function (y, b, w) {
        var x;
        return (
          R.isValidElement(y)
            ? (x = R.cloneElement(y, b))
            : V(y)
              ? (x = y(b))
              : (x = P.createElement(Ss, b)),
          P.createElement(ne, { className: "recharts-active-dot", key: w }, x)
        );
      }));
    var d = R.forwardRef(function (b, w) {
      return P.createElement(v, gr({}, b, { ref: w }));
    });
  ...
  zW = bm({
    ...
    axisComponents: [
      { axisType: "xAxis", AxisComp: ks },
      { axisType: "yAxis", AxisComp: Ds },
    ],
    formatAxisMap: LB,
  }),
  UW = bm({
