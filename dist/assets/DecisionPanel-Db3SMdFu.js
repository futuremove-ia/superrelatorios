import { u as q, j as e, B as l } from "./index-CZZTgEon.js";
import { r as b } from "./vendor-BgR6OOld.js";
import { C as n, b as d, c as o, a as c } from "./card-CeRYWmFS.js";
import { B as r } from "./badge-Dywuca96.js";
import { K as h } from "./kpi-card-DiK3deXa.js";
import { T as D, a as V, b as m, c as x } from "./tabs-aA6rM8TF.js";
import { A as K, a as O } from "./alert-NildW34i.js";
import { S as L, a as U, b as F, c as H, d as p } from "./select-BzszXf0X.js";
import { P as u } from "./progress-DiZtfjCp.js";
import { S as j } from "./separator-CdVtjmJc.js";
import {
  I as Z,
  r as _,
  D as g,
...
const ge = ({ className: S }) => {
  const { t: s } = q(),
    [R, P] = b.useState("overview"),
    [z, I] = b.useState("current"),
    t = {
      id: "1",
    ...
    f = (a) => {
      switch (a) {
        case "up":
          return e.jsx(y, { className: "w-4 h-4 text-green-500" });
        case "down":
          return e.jsx(ee, { className: "w-4 h-4 text-red-500" });
        default:
          return e.jsx("div", {
  ...
  return e.jsxs("div", {
    className: `container-fluid space-y-8 py-6 ${S}`,
    children: [
      e.jsxs("div", {
        className:
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsx("div", {
                ...
                children: e.jsx(Z, { className: "w-6 h-6 text-blue-600" }),
              }),
              e.jsxs("div", {
                children: [
                  e.jsx("h1", {
                    className: "text-3xl font-bold text-foreground",
                    children: s("decision_panel.title"),
                  }),
                  e.jsx("p", {
                    className: "text-muted-foreground",
                    children: s("decision_panel.subtitle"),
                  }),
                ],
              }),
            ],
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsxs(L, {
                ...
                onValueChange: I,
                children: [
                  e.jsx(U, { className: "w-32", children: e.jsx(F, {}) }),
                  e.jsxs(H, {
                    children: [
                      e.jsx(p, {
                        value: "current",
                        children: s("decision_panel.period.current"),
                      }),
                      e.jsx(p, {
                        value: "last_month",
                        children: s("decision_panel.period.last_month"),
                      }),
                      e.jsx(p, {
                        value: "quarter",
                        children: s("decision_panel.period.quarter"),
                      }),
                    ],
                  }),
                ],
              ...
              e.jsxs(l, {
                ...
                children: [
                  ...
                  s("decision_panel.actions.filters"),
                ],
              }),
              e.jsxs(l, {
                variant: "outline",
                ...
                children: [
                  ...
                  s("decision_panel.actions.export"),
                ],
              }),
              e.jsxs(l, {
                variant: "outline",
                ...
                children: [
                  ...
                  s("decision_panel.actions.refresh"),
                ],
              }),
            ],
          }),
      ...
      e.jsxs(K, {
        ...
        children: [
          e.jsx(w, { className: "h-4 w-4 text-red-600" }),
          e.jsxs(O, {
            className: "text-red-800",
            children: [
              e.jsx("strong", {
                children: s("decision_panel.alert.critical_detected"),
              }),
              " ",
              t.title,
              e.jsx(l, {
                ...
                children: s("decision_panel.alert.analyze_now"),
              }),
            ],
          }),
        ],
        ...
        children: [
          e.jsxs(V, {
            ...
            children: [
              e.jsx(m, {
                value: "overview",
                children: s("decision_panel.tabs.overview"),
              }),
              e.jsx(m, {
                value: "situation",
                children: s("decision_panel.tabs.situation"),
              }),
              e.jsx(m, {
                value: "recommendations",
                children: s("decision_panel.tabs.recommendations"),
              }),
              e.jsx(m, {
                value: "actions",
                children: s("decision_panel.tabs.actions"),
              }),
            ],
          }),
          e.jsx(x, {
            ...
            children: e.jsxs("div", {
              ...
              children: [
                  ...
                  children: [
                    e.jsx(d, {
                      children: e.jsxs(o, {
                        ...
                        children: [
                          e.jsx(w, { className: "w-5 h-5 text-red-600" }),
                          s("decision_panel.situation.priority_title"),
                        ],
                      }),
                    }),
                    e.jsxs(c, {
                              ...
                              children: [
                                ...
                                e.jsxs("div", {
                                  children: [
                                    ...
                                    e.jsx("p", {
                                      className: "font-medium",
                                      children: t.actionableTranslation,
                                    }),
                                  ],
                                }),
                              ],
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx(h, {
                      title: s("decision_panel.kpi.recommendations"),
                      value: "3",
                      icon: G,
                      variant: "info",
                      subtitle: s(
                    ...
                    e.jsx(h, {
                      title: s("decision_panel.kpi.average_confidence"),
                      value: "77%",
                      icon: J,
                      variant: "success",
                      subtitle: s(
                    ...
                    e.jsx(h, {
                      title: s("decision_panel.kpi.expected_impact"),
                      value: "R$125K",
                      icon: y,
                      variant: "success",
                      subtitle: s(
                ...
                e.jsx(d, {
                  children: e.jsxs(o, {
                    ...
                    children: [
                      ...
                      s("decision_panel.situation.detailed_analysis"),
                    ],
                  }),
                }),
                e.jsxs(c, {
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("h2", {
                    className: "text-2xl font-bold",
                    children: s("decision_panel.recommendations.title"),
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsxs(l, {
                        ...
                        children: [
                          e.jsx(_, { className: "w-4 h-4 mr-2" }),
                          s("decision_panel.recommendations.filter"),
                        ],
                      }),
                      e.jsxs(l, {
                        variant: "outline",
                        ...
                        children: [
                          e.jsx(g, { className: "w-4 h-4 mr-2" }),
                          s("decision_panel.recommendations.export"),
                        ],
                      }),
                    ],
                  }),
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("h2", {
                    className: "text-2xl font-bold",
                    children: s("decision_panel.action_plan.title"),
                  }),
                  e.jsxs(l, {
                    children: [
                      e.jsx(g, { className: "w-4 h-4 mr-2" }),
                      s("decision_panel.action_plan.export_plan"),
                    ],
                  }),
                ],
              }),
              e.jsxs(n, {
                children: [
                  e.jsx(d, {
                    children: e.jsx(o, {
                      children: s("decision_panel.action_plan.summary_title"),
                    }),
                  }),
                  e.jsxs(c, {
                    className: "space-y-6",
                            ...
                            children: [
                              ...
                              e.jsxs(
                                "div",
                                {
                                  ...
                                  children: [
                                    e.jsx("div", {
                                      className: `w-3 h-3 rounded-full ${a.status === "ready" ? "bg-green-500" : "bg-gray-300"}`,
                                    }),
                                    e.jsxs("div", {
                                      className: "flex-1",
                                      children: [
                                        ...
                                        e.jsxs("div", {
                                          ...
                                          children: [
                                            e.jsxs("span", {
                                              className: "text-sm",
                                              children: [a.actions, " ações"],
                                            }),
                                            e.jsx(u, {
                                              value:
                                                a.status === "ready" ? 100 : 0,
                                              className: "flex-1 h-2",
                                            }),
                                          ],
                                        }),
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsxs(l, {
                            ...
                            children: [
                              e.jsx(k, { className: "w-4 h-4 mr-2" }),
                              s("decision_panel.action_plan.view_details"),
                            ],
                          }),
                        ],
                      }),
