import { u as D, j as e, B as a } from "./index-D2W-YaK1.js";
import { r as N } from "./vendor-BgR6OOld.js";
import { C as l, b as v, c as b, a as r } from "./card-38iTbfya.js";
import { B as i } from "./badge-BXC9IUk2.js";
import { K as O } from "./kpi-card-D_QME9US.js";
import { T as F, a as $, b as n, c as d } from "./tabs-DRi0Xwho.js";
import { P as x } from "./progress-CevgmHj5.js";
import { S as G, a as K, b as Q, c as H, d as w } from "./select-Al8v4OJE.js";
import { S as c } from "./skeleton-nXEMt3o5.js";
import { A as U, a as Y } from "./alert-CcKAu5nV.js";
import { S as J } from "./separator-CbQuHTTz.js";
import { a as W, u as X } from "./useCrossDomainAnalytics-DKPT4l7q.js";
...
const Ae = () => {
  D();
  const [z, M] = N.useState("quarter"),
    [S, T] = N.useState("overview");
  N.useState(["finance", "commercial", "operations", "strategy"]);
  const { analytics: ie, isLoading: R } = W("default-org"),
    { values: le, isLoading: E } = X("default-org"),
    q = R || E,
    I = [
      {
    ...
    ? e.jsxs("div", {
        ...
        children: [
          e.jsxs("div", {
            ...
            children: [
              e.jsx(c, { className: "h-10 w-64" }),
              e.jsxs("div", {
                className: "flex gap-3",
                children: [
                  e.jsx(c, { className: "h-10 w-32" }),
                  e.jsx(c, { className: "h-10 w-32" }),
                ],
              }),
            ],
          ...
          e.jsx("div", {
            ...
            children: [1, 2, 3, 4].map((s) =>
              e.jsx(c, { className: "h-32 rounded-xl" }, s),
            ),
          }),
          e.jsxs("div", {
            className: "space-y-6",
            children: [
              e.jsx(c, { className: "h-6 w-48" }),
              e.jsx("div", {
                className: "grid grid-cols-1 lg:grid-cols-2 gap-6",
                children: [1, 2].map((s) =>
                  e.jsx(c, { className: "h-64 rounded-xl" }, s),
                ),
              }),
            ],
          }),
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("div", {
                    ...
                    children: e.jsx(u, { className: "w-6 h-6 text-white" }),
                  }),
                  e.jsxs("div", {
                    children: [
                      e.jsx("h1", {
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs(G, {
                    ...
                    onValueChange: M,
                    children: [
                      e.jsx(K, { className: "w-32", children: e.jsx(Q, {}) }),
                      e.jsxs(H, {
                        children: [
                          e.jsx(w, { value: "month", children: "Mês" }),
                          e.jsx(w, { value: "quarter", children: "Trimestre" }),
                          e.jsx(w, { value: "year", children: "Ano" }),
                        ],
                      }),
                    ],
                  }),
          ...
          e.jsxs(F, {
            ...
            children: [
              e.jsxs($, {
                ...
                children: [
                  e.jsx(n, { value: "overview", children: "Visão Geral" }),
                  e.jsx(n, { value: "correlations", children: "Correlações" }),
                  e.jsx(n, { value: "predictions", children: "Previsões" }),
                  e.jsx(n, { value: "insights", children: "Insights" }),
                  e.jsx(n, { value: "anomalies", children: "Anomalias" }),
                ],
              }),
              e.jsx(d, {
                value: "overview",
                                    ...
                                    e.jsxs("div", {
                                      children: [
                                        ...
                                        e.jsxs("div", {
                                          ...
                                          children: [
                                            e.jsxs("span", {
                                              className: `text-lg font-bold ${L(s.correlation)}`,
                                              children: [
                                                s.correlation > 0 ? "+" : "",
                                                s.correlation,
                                              ],
                              ...
                              e.jsxs("div", {
                                ...
                                children: [
                                  ...
                                  e.jsx("div", {
                                    ...
                                    children: s.factors.map((f, g) =>
                                      e.jsx(
                                        i,
                                        { variant: "outline", children: f },
                                        g,
                                      ),
                                    ),
                                  }),
                        ...
                        l,
                        {
                          children: e.jsx(r, {
                            ...
                            children: e.jsxs("div", {
                              ...
                              children: [
                                e.jsx("div", {
                                  className: `p-2 rounded-lg ${s.type === "opportunity" ? "bg-green-100" : s.type === "risk" ? "bg-red-100" : "bg-blue-100"}`,
                                  children: e.jsx(s.icon, {
                                    className: `w-6 h-6 ${s.type === "opportunity" ? "text-green-600" : s.type === "risk" ? "text-red-600" : "text-blue-600"}`,
                                  }),
                                }),
                                e.jsxs("div", {
                                  className: "flex-1",
              ...
              e.jsxs(d, {
                ...
                children: [
                  ...
                  e.jsxs(U, {
                    ...
                    children: [
                      e.jsx(y, { className: "h-4 w-4 text-yellow-600" }),
                      e.jsxs(Y, {
                                ...
                                children: [
                                  ...
                                  e.jsxs("div", {
                                    children: [
                                      ...
                                      e.jsx("p", {
                                        className: `text-lg font-bold ${s.actualValue > s.expectedValue ? "text-red-600" : "text-green-600"}`,
                                        children: s.actualValue,
                                      }),
                                    ],
                                  }),
                                  e.jsxs("div", {
