import { u as T, j as e, B as c, c as d } from "./index-DSuxXiPq.js";
import { r as p, L as u } from "./router-C2uYhr1z.js";
import { C as r, a as i, b as n, c as m, d as x } from "./card-kC7SKLKo.js";
import { B as f } from "./badge-ByuXo0CA.js";
import { S as k, a as D, b as R, c as P, d as j } from "./select-DeKeYH2O.js";
import { a as z } from "./DomainTag-BbTYsAWq.js";
import {
  f as v,
  k as b,
  a1 as E,
...
const o = [
  ...
  J = ({ diagnosis: s, onSelect: a, isSelected: t }) =>
    e.jsx(r, {
      className: d(
        ...
        children: e.jsxs("div", {
          ...
          children: [
            e.jsx("div", {
              ...
              children:
                s.severity === "high"
                  ? e.jsx(B, { className: "h-5 w-5 text-red-600" })
                  : s.severity === "medium"
                    ? e.jsx(y, { className: "h-5 w-5 text-amber-600" })
                    : e.jsx(q, { className: "h-5 w-5 text-blue-600" }),
            }),
            e.jsxs("div", {
                ...
                e.jsxs(n, {
                  children: [
                    e.jsxs(m, {
                      ...
                      children: [
                        e.jsx(O, { className: "w-5 h-5 text-primary" }),
                        "Causa Raiz",
                      ],
                    }),
                ...
                e.jsxs(n, {
                  children: [
                    e.jsxs(m, {
                      className: "flex items-center gap-2 text-lg",
                      children: [
                        e.jsx(V, { className: "w-5 h-5 text-red-500" }),
                        "Impacto no Negócio",
                      ],
                    }),
          ...
          children: [
            e.jsx(n, {
              children: e.jsxs(m, {
                className: "flex items-center gap-2 text-lg",
                children: [
                  e.jsx(N, { className: "w-5 h-5 text-blue-600" }),
                  "Análise da IA",
                ],
              }),
            }),
  ...
  ae = () => {
    const { t: s } = T(),
      [a, t] = p.useState(["finance", "commercial", "operations", "strategy"]),
      [g, C] = p.useState(o[0].id),
      [w, A] = p.useState("quarter"),
      h = o.filter((l) => a.includes(l.domain)),
      S = o.find((l) => l.id === g) || o[0];
    return e.jsxs("div", {
      className:
              ...
              children: [
                e.jsxs(k, {
                  ...
                  children: [
                    ...
                    e.jsxs(P, {
                      children: [
                        e.jsx(j, { value: "month", children: "Este Mês" }),
                        e.jsx(j, {
                          value: "quarter",
                          children: "Este Trimestre",
                        }),
                        e.jsx(j, { value: "year", children: "Este Ano" }),
                      ],
                    }),
                  ],
                }),
              ...
              children: [
                ...
                e.jsx("div", {
                  ...
                  children: h.map((l) =>
                    e.jsx(
                      J,
                      { diagnosis: l, onSelect: C, isSelected: g === l.id },
                      l.id,
                    ),
                  ),
                }),
