...
var qe = (r, e, t) =>
  e in r
    ...
    : (r[e] = t);
var Q = (r, e, t) => qe(r, typeof e != "symbol" ? e + "" : e, t);
import { j as c, c as oe, a1 as ye, u as He } from "./index-DJVek99o.js";
import { C as q, a as H, b as de, c as ce, d as ke } from "./card-Ekw6AZkO.js";
import { B as Ke } from "./badge-BRPjZ132.js";
import {
  d as We,
  a3 as Ge,
  ap as Ye,
...
import { u as we } from "./useQuery-lOGkLDRM.js";
import { u as et } from "./useCurrentOrganization-QE33f3lM.js";
import { S as le } from "./skeleton-CLezCALq.js";
...
function at({
  ...
  const o = tt[s];
  return c.jsx(q, {
    className: oe("card-hover", o.border, i),
    children: c.jsx(H, {
      className: "p-4",
      children: c.jsxs("div", {
        className: "space-y-2",
        children: [
          ...
          n &&
            c.jsxs("div", {
              ...
              children: [
                n.value > 0
                  ? c.jsx(We, { className: "h-3 w-3 text-green-600" })
                  : n.value < 0
                    ? c.jsx(Ge, { className: "h-3 w-3 text-red-600" })
                    : c.jsx(Ye, { className: "h-3 w-3 text-muted-foreground" }),
                c.jsxs("span", {
                  className: oe(
                    "text-xs",
...
(function (r) {
  ...
  ((r.assertNever = t),
    (r.arrayToEnum = (s) => {
      const n = {};
      for (const i of s) n[i] = i;
      return n;
    }),
    (r.getValidEnumValues = (s) => {
      const n = r.objectKeys(s).filter((o) => typeof s[s[o]] != "number"),
        i = {};
      for (const o of n) i[o] = s[o];
    ...
    (r.find = (s, n) => {
      for (const i of s) if (n(i)) return i;
    }),
    (r.isInteger =
...
const nt = (r) => {
  const { data: e, path: t, errorMaps: a, issueData: s } = r,
    n = [...t, ...(s.path || [])],
    i = { ...s, path: n };
  ...
  const l = a
    ...
    .slice()
    .reverse();
  for (const p of l) o = p(i, { data: e, defaultError: o }).message;
...
const g = Object.freeze({ status: "aborted" }),
  ...
  Te = (r) => r.status === "aborted",
  Re = (r) => r.status === "dirty",
  z = (r) => r.status === "valid",
  X = (r) => typeof Promise < "u" && r instanceof Promise;
var f;
(function (r) {
...
const Ce = (r, e) => {
  if (z(e)) return { success: !0, data: e.value };
    ...
    : {
        errorMap: (i, o) => {
          ...
          return i.code === "invalid_enum_value"
            ...
            : typeof o.data > "u"
              ? { message: l ?? a ?? o.defaultError }
              : i.code !== "invalid_type"
                ? { message: o.defaultError }
                : { message: l ?? t ?? o.defaultError };
        },
        description: s,
      };
}
class x {
  ...
  "~validate"(e) {
    ...
    if (!this["~standard"].async)
      try {
        ...
        ((s =
          (a = n == null ? void 0 : n.message) == null
            ? void 0
            : a.toLowerCase()) != null &&
    ...
    return this._parseAsync({ data: e, path: [], parent: t }).then((n) =>
      z(n) ? { value: n.value } : { issues: t.common.issues },
    );
  }
  ...
  async safeParseAsync(e, t) {
    const a = {
      ...
      n = await (X(s) ? s : Promise.resolve(s));
    return Ce(a, n);
  }
  refine(e, t) {
    const a = (s) =>
  ...
  refinement(e, t) {
    return this._refinement((a, s) =>
      e(a) ? !0 : (s.addIssue(typeof t == "function" ? t(a, s) : t), !1),
    );
  }
  _refinement(e) {
    return new $({
  ...
  brand() {
    return new Ct({ typeName: _.ZodBranded, type: this, ...y(this._def) });
  }
  catch(e) {
    const t = typeof e == "function" ? e : () => e;
    return new _e({
...
const it = /^c[^\s-]{8,}$/i,
  ot = /^[0-9a-z]+$/,
  dt = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
  ct =
    /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
  lt = /^[a-z0-9_-]{21}$/i,
  ut = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
  mt =
    /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
  ht =
    /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
  ft = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let ue;
const pt =
  ...
  yt = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
  xt = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
  $e =
...
class ee extends x {
  _parse(e) {
    ...
    if (Number.isNaN(e.data.getTime())) {
      const n = this._getOrReturnCtx(e);
      return (u(n, { code: d.invalid_date }), g);
    }
    const a = new E();
    let s;
    for (const n of this._def.checks)
...
Ae.create = (r) => new Ae({ typeName: _.ZodSymbol, ...y(r) });
class Ne extends x {
  _parse(e) {
...
Ne.create = (r) => new Ne({ typeName: _.ZodUndefined, ...y(r) });
class Se extends x {
  _parse(e) {
...
Se.create = (r) => new Se({ typeName: _.ZodNull, ...y(r) });
class Oe extends x {
  constructor() {
...
Oe.create = (r) => new Oe({ typeName: _.ZodAny, ...y(r) });
class Pe extends x {
  constructor() {
...
Pe.create = (r) => new Pe({ typeName: _.ZodUnknown, ...y(r) });
class L extends x {
  _parse(e) {
    const t = this._getOrReturnCtx(e);
    return (
      u(t, { code: d.invalid_type, expected: h.never, received: t.parsedType }),
      g
    );
  }
}
L.create = (r) => new L({ typeName: _.ZodNever, ...y(r) });
class je extends x {
  _parse(e) {
    if (this._getType(e) !== h.undefined) {
      const a = this._getOrReturnCtx(e);
...
je.create = (r) => new je({ typeName: _.ZodVoid, ...y(r) });
class C extends x {
  _parse(e) {
    ...
    if (
      ...
      return Promise.all(
        [...t.data].map((i, o) => s.type._parseAsync(new M(t, i, t.path, o))),
      ).then((i) => E.mergeArray(a, i));
    const n = [...t.data].map((i, o) =>
      s.type._parseSync(new M(t, i, t.path, o)),
    );
    return E.mergeArray(a, n);
  }
  get element() {
...
function Z(r) {
  if (r instanceof b) {
    ...
    return r instanceof C
      ? new C({ ...r._def, type: Z(r.element) })
      : r instanceof j
        ? j.create(Z(r.unwrap()))
        : r instanceof D
          ? D.create(Z(r.unwrap()))
          : r instanceof V
            ? V.create(r.items.map((e) => Z(e)))
            : r;
}
class b extends x {
  constructor() {
  ...
  _parse(e) {
    ...
    if (!(this._def.catchall instanceof L && this._def.unknownKeys === "strip"))
      for (const p in s.data) i.includes(p) || o.push(p);
    const l = [];
    for (const p of i) {
      const m = n[p],
        k = s.data[p];
      l.push({
        ...
        value: m._parse(new M(s, k, s.path, p)),
    ...
    if (this._def.catchall instanceof L) {
      ...
      for (const m of o) {
        ...
        l.push({
          key: { status: "valid", value: m },
          value: p._parse(new M(s, k, s.path, m)),
      ...
      ? Promise.resolve()
          .then(async () => {
            ...
            for (const m of l) {
              const k = await m.key,
                w = await m.value;
              p.push({ key: k, value: w, alwaysSet: m.alwaysSet });
            }
            return p;
          })
          .then((p) => E.mergeObjectSync(a, p))
      : E.mergeObjectSync(a, l);
  }
  get shape() {
              ...
              errorMap: (t, a) => {
                ...
                const s =
                  ((i = (n = this._def).errorMap) == null
                    ? void 0
                    : i.call(n, t, a).message) ?? a.defaultError;
  ...
  omit(e) {
    const t = {};
    for (const a of I.objectKeys(this.shape)) e[a] || (t[a] = this.shape[a]);
    return new b({ ...this._def, shape: () => t });
  }
  deepPartial() {
    return Z(this);
  ...
  required(e) {
    ...
    for (const a of I.objectKeys(this.shape))
      if (e && !e[a]) t[a] = this.shape[a];
        ...
        let n = this.shape[a];
        for (; n instanceof j; ) n = n._def.innerType;
        t[a] = n;
      }
    return new b({ ...this._def, shape: () => t });
  }
  keyof() {
    return Be(I.objectKeys(this.shape));
  }
}
b.create = (r, e) =>
  new b({
...
class te extends x {
  _parse(e) {
    ...
    function s(n) {
      ...
      return (u(t, { code: d.invalid_union, unionErrors: i }), g);
    }
    if (t.common.async)
      return Promise.all(
        a.map(async (n) => {
      ...
      ).then(s);
    {
      ...
      for (const l of a) {
        const p = { ...t, common: { ...t.common, issues: [] }, parent: null },
          m = l._parseSync({ data: t.data, path: t.path, parent: p });
        if (m.status === "valid") return m;
        (m.status === "dirty" && !n && (n = { result: m, ctx: p }),
      ...
      return (u(t, { code: d.invalid_union, unionErrors: o }), g);
    }
  }
  get options() {
...
te.create = (r, e) => new te({ options: r, typeName: _.ZodUnion, ...y(e) });
function pe(r, e) {
  const t = O(r),
    a = O(e);
  if (r === e) return { valid: !0, data: r };
  if (t === h.object && a === h.object) {
    const s = I.objectKeys(e),
      n = I.objectKeys(r).filter((o) => s.indexOf(o) !== -1),
      i = { ...r, ...e };
    for (const o of n) {
      const l = pe(r[o], e[o]);
...
class ae extends x {
  _parse(e) {
    const { status: t, ctx: a } = this._processInputParams(e),
      s = (n, i) => {
        if (Te(n) || Te(i)) return g;
        const o = pe(n.value, i.value);
        return o.valid
          ? ((Re(n) || Re(i)) && t.dirty(), { status: t.value, value: o.data })
          : (u(a, { code: d.invalid_intersection_types }), g);
      };
...
ae.create = (r, e, t) =>
  new ae({ left: r, right: e, typeName: _.ZodIntersection, ...y(t) });
class V extends x {
  _parse(e) {
    const { status: t, ctx: a } = this._processInputParams(e);
    ...
    const n = [...a.data]
      .map((i, o) => {
        ...
        return l ? l._parse(new M(a, i, a.path, o)) : null;
      })
      .filter((i) => !!i);
    return a.common.async
      ? Promise.all(n).then((i) => E.mergeArray(t, i))
      : E.mergeArray(t, n);
  }
  get items() {
  ...
  rest(e) {
    return new V({ ...this._def, rest: e });
  }
}
V.create = (r, e) => {
  if (!Array.isArray(r))
    throw new Error("You must pass an array of schemas to z.tuple([ ... ])");
  return new V({ items: r, typeName: _.ZodTuple, rest: null, ...y(e) });
};
class Me extends x {
  get keySchema() {
  ...
  _parse(e) {
    ...
    if (a.parsedType !== h.map)
      return (
        u(a, { code: d.invalid_type, expected: h.map, received: a.parsedType }),
        g
      );
    const s = this._def.keyType,
      n = this._def.valueType,
      i = [...a.data.entries()].map(([o, l], p) => ({
        key: s._parse(new M(a, o, a.path, [p, "key"])),
        value: n._parse(new M(a, l, a.path, [p, "value"])),
      }));
    if (a.common.async) {
      const o = new Map();
      return Promise.resolve().then(async () => {
        for (const l of i) {
          const p = await l.key,
            m = await l.value;
          if (p.status === "aborted" || m.status === "aborted") return g;
          ((p.status === "dirty" || m.status === "dirty") && t.dirty(),
            o.set(p.value, m.value));
        }
...
Me.create = (r, e, t) =>
  new Me({ valueType: e, keyType: r, typeName: _.ZodMap, ...y(t) });
class Y extends x {
  _parse(e) {
    const { status: t, ctx: a } = this._processInputParams(e);
    if (a.parsedType !== h.set)
      return (
        u(a, { code: d.invalid_type, expected: h.set, received: a.parsedType }),
        g
      );
    const s = this._def;
    (s.minSize !== null &&
    ...
    function i(l) {
      const p = new Set();
      for (const m of l) {
        if (m.status === "aborted") return g;
        (m.status === "dirty" && t.dirty(), p.add(m.value));
      }
      return { status: t.value, value: p };
    }
    const o = [...a.data.values()].map((l, p) =>
      n._parse(new M(a, l, a.path, p)),
    );
    return a.common.async ? Promise.all(o).then((l) => i(l)) : i(o);
  }
  min(e, t) {
    return new Y({
      ...this._def,
...
Le.create = (r, e) => new Le({ getter: r, typeName: _.ZodLazy, ...y(e) });
class Ve extends x {
  _parse(e) {
...
Ve.create = (r, e) => new Ve({ value: r, typeName: _.ZodLiteral, ...y(e) });
function Be(r, e) {
  return new K({ values: r, typeName: _.ZodEnum, ...y(e) });
}
class K extends x {
  _parse(e) {
    ...
    if (
      ...
      const t = this._getOrReturnCtx(e),
        a = this._def.values;
      return (
        u(t, { received: t.data, code: d.invalid_enum_value, options: a }),
        g
      );
    }
    return T(e.data);
...
class Ze extends x {
  _parse(e) {
    ...
    if (
      ...
      const s = I.objectValues(t);
      return (
        u(a, { received: a.data, code: d.invalid_enum_value, options: s }),
        g
      );
    }
    return T(e.data);
...
Ze.create = (r, e) => new Ze({ values: r, typeName: _.ZodNativeEnum, ...y(e) });
class re extends x {
  unwrap() {
    return this._def.type;
  }
...
re.create = (r, e) => new re({ type: r, typeName: _.ZodPromise, ...y(e) });
class $ extends x {
  innerType() {
...
$.create = (r, e, t) =>
  new $({ schema: r, typeName: _.ZodEffects, effect: e, ...y(t) });
...
j.create = (r, e) => new j({ innerType: r, typeName: _.ZodOptional, ...y(e) });
class D extends x {
  _parse(e) {
...
D.create = (r, e) => new D({ innerType: r, typeName: _.ZodNullable, ...y(e) });
class ge extends x {
  _parse(e) {
    const { ctx: t } = this._processInputParams(e);
    let a = t.data;
    return (
      t.parsedType === h.undefined && (a = this._def.defaultValue()),
...
class ze extends x {
  _parse(e) {
    if (this._getType(e) !== h.nan) {
      const a = this._getOrReturnCtx(e);
      return (
        u(a, { code: d.invalid_type, expected: h.nan, received: a.parsedType }),
        g
      );
    }
    return { status: "valid", value: e.data };
...
ze.create = (r) => new ze({ typeName: _.ZodNaN, ...y(r) });
class Ct extends x {
  _parse(e) {
    const { ctx: t } = this._processInputParams(e),
      a = t.data;
...
class xe extends x {
  ...
  static create(e, t) {
    return new xe({ in: e, out: t, typeName: _.ZodPipeline });
  }
}
class ve extends x {
  _parse(e) {
...
ve.create = (r, e) =>
  new ve({ innerType: r, typeName: _.ZodReadonly, ...y(e) });
b.lazycreate;
var _;
(function (r) {
...
const N = ne({
  ...
  unit: v(),
  domain: F(["finance", "sales", "marketing", "operations", "hr", "strategy"]),
  sector: v().optional(),
  business_model: v().optional(),
  niche: v().optional(),
  trend_direction: F(["higher_is_better", "lower_is_better", "no_trend"]),
  input_type: F(["cumulative", "non_cumulative"]),
  group_data_period: F(["daily", "weekly", "monthly", "quarterly", "yearly"]),
  total_is: F([
    "sum_of_values",
    "average_of_values",
    "last_value",
...
`,
  ...
  async getKPIs() {
    ...
    return N.array().parse(e || []);
  }
  async getKPIById(e) {
    const { data: t, error: a } = await this.supabase
      .from("library_kpis")
      .select("*")
      .eq("id", e)
      .maybeSingle();
    if (a)
      throw (
        console.error("Error fetching KPI:", a),
        new Error(`Failed to fetch KPI: ${a.message}`)
      );
    return N.safeParse(t).success ? t : null;
  }
  async getKPIByCode(e) {
    ...
    if (a)
      throw (
        console.error("Error fetching KPI by code:", a),
        new Error(`Failed to fetch KPI by code: ${a.message}`)
      );
    return N.safeParse(t).success ? t : null;
  }
  async getKPIsByDomain(e) {
    ...
    if (a)
      throw (
        console.error("Error fetching KPIs by domain:", a),
        new Error(`Failed to fetch KPIs by domain: ${a.message}`)
      );
  ...
  async createKPI(e) {
    ...
    const t = { ...e, code: (i = e.code) == null ? void 0 : i.toUpperCase() },
      { data: a, error: s } = await this.supabase
        .from("library_kpis")
        .insert(t)
        .select()
        .single();
    ...
    const n = N.safeParse(a);
    if (!n.success)
      throw new Error(`Invalid KPI data returned: ${n.error.message}`);
    return n.data;
  }
  async updateKPI(e, t) {
    const a = { ...t, ...(t.code && { code: t.code.toUpperCase() }) },
      { data: s, error: n } = await this.supabase
        .from("library_kpis")
        .update(a)
        .eq("id", e)
        .select()
  ...
  async getKPIDomains() {
    ...
    return [...new Set((e || []).map((s) => s.domain))];
  }
  async searchKPIs(e) {
    const { data: t, error: a } = await this.supabase
      .from("library_kpis")
    ...
    if (a)
      throw (
        console.error("Error searching KPIs:", a),
        new Error(`Failed to search KPIs: ${a.message}`)
      );
    return N.array().parse(t || []);
  }
}
...
`,
  ...
  async getOrganizationKPIs(e) {
    ...
    if (a)
      throw (
        console.error("Error fetching organization KPIs:", a),
        new Error(`Failed to fetch organization KPIs: ${a.message}`)
      );
    return A.array().parse(t || []);
  }
  async getOrganizationKPIsByPeriod(e, t) {
    const { data: a, error: s } = await this.supabase
      .from("user_metrics")
      .select(
        `
        *,
  ...
  async getLatestOrganizationKPIs(e) {
    ...
    if (a)
      throw (
        console.error("Error fetching latest periods:", a),
        new Error(`Failed to fetch latest periods: ${a.message}`)
      );
    const s = new Map();
    t == null ||
      t.forEach((l) => {
        s.has(l.kpi_id) || s.set(l.kpi_id, l.period_key);
      });
  ...
  async getOrganizationKPIById(e, t) {
    ...
    return A.safeParse(a).success ? a : null;
  }
  async createOrganizationKPI(e) {
    ...
    if (a)
      throw (
        console.error("Error creating organization KPI:", a),
        new Error(`Failed to create organization KPI: ${a.message}`)
      );
    const s = A.safeParse(t);
    if (!s.success)
      throw new Error(
  ...
  async getKPIHistory(e, t, a = 12) {
    const { data: s, error: n } = await this.supabase
      .from("user_metrics")
      .select(
        `
        *,
    ...
    return A.array().parse(s || []);
  }
  async getKPITrend(e, t, a = 6) {
    const s = await this.getKPIHistory(e, t, a);
    if (s.length === 0)
      return {
        current: null,
        previous: null,
    ...
    const o = ((n.value - i.value) / i.value) * 100,
      l = o > 0 ? "up" : o < 0 ? "down" : "stable";
    return { current: n, previous: i, trend: l, percentageChange: o };
  }
  async bulkCreateOrganizationKPIs(e) {
    ...
    if (a)
      throw (
        console.error("Error bulk creating organization KPIs:", a),
        new Error(`Failed to bulk create organization KPIs: ${a.message}`)
      );
    const s = A.array().safeParse(t || []);
    if (!s.success)
      throw new Error(
        `Invalid organization KPI data returned: ${s.error.message}`,
      );
  ...
  async getKPIsByDateRange(e, t, a) {
    const { data: s, error: n } = await this.supabase
      .from("user_metrics")
      .select(
        `
...
const Ot = new St(),
  ...
  jt = (r) => Pt.find((e) => e.code === r),
  Mt = (r, e) => {
    const t = jt(r);
    return t == null ? void 0 : t.kpisWithDescriptions[e];
  },
  Lt = {
...
`,
  ...
  async calculateRelevance(e, t, a, s) {
    const n = await Nt.getKPIs(),
      i = await this.getDataPresence(e),
      o = this.getReadinessLevel(i.totalDataPoints),
      l = [],
      p = t ? Zt[t] || [] : [],
      m = a ? zt[a] || [] : [],
      k = s ? Vt[s] || [] : [];
    for (const w of n) {
      let R = 999,
        B = "KPI disponível";
      const ie = Lt[w.code];
      (ie && ((R = ie.priority), (B = ie.reason)),
        k.includes(w.code) &&
          ((R = Math.max(R - 2, 1)), (B = `Relevante para modelo ${s}`)),
        p.includes(w.code) &&
          ((R = Math.max(R - 1, 1)), (B = `Relevante para setor ${t}`)),
        m.includes(w.code) &&
          ((R = Math.max(R - 1, 1)), (B = `Relevante para porte ${a}`)));
      const be = i.byKPI[w.code] || 0;
      if (this.shouldIncludeKPI(o, be, R)) {
        const J = s ? Mt(s, w.code) : void 0;
        l.push({
          code: w.code,
          title: w.title,
          domain: w.domain,
          ...
          readiness_level: o,
          dataPoints: be,
          next_action: this.suggestNextAction(w.code),
          kpiDescription: J
            ? {
                whatIsIt: J.whatIsIt,
                whyItMatters: J.whyItMatters,
                howToImprove: J.howToImprove,
              }
            : void 0,
        });
      }
    }
    return l.sort((w, R) => w.priority - R.priority);
  }
  shouldIncludeKPI(e, t, a) {
    switch (e) {
      case 0:
        return a <= 1;
      case 1:
  ...
  async getDataPresence(e) {
    const t = await Ot.getOrganizationKPIs(e),
      a = {},
      s = {};
    for (const i of t)
      if (i.kpi_library) {
        const o = i.kpi_library.domain || "unknown",
          l = i.kpi_library.code || "unknown";
        ((a[o] = (a[o] || 0) + 1), (s[l] = (s[l] || 0) + 1));
      }
...
const me = new Ut(),
  Ue = {
    ...
    dataPresence: (r) => ["dataPresence", r],
    maturity: (r) => ["maturity", r],
  };
function Kt(r, e, t, a) {
  const s = we({
      queryKey: Ue.relevance(r),
      queryFn: () => me.calculateRelevance(r, e, t, a),
      enabled: !!r,
      staleTime: 3e5,
    }),
    n = we({
      queryKey: Ue.dataPresence(r),
      queryFn: () => me.getDataPresence(r),
      enabled: !!r,
      staleTime: 5 * 60 * 1e3,
    }),
    i = n.data ? me.getMaturityInfo(n.data.totalDataPoints) : void 0;
  return {
    kpis: s.data,
    isLoading: s.isLoading || n.isLoading,
...
function Qt() {
  const { t: r } = He(),
    { organization: e, isLoading: t } = et(),
    a = (e == null ? void 0 : e.id) || "",
    { kpis: s, isLoading: n, maturity: i } = Kt(a);
  if (t || n)
    return c.jsx("div", {
      ...
      children: c.jsxs("div", {
        className: "space-y-4",
        children: [
          c.jsx(le, { className: "h-8 w-64" }),
          c.jsx(le, { className: "h-4 w-96" }),
          c.jsx("div", {
            className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4",
            children: [...Array(4)].map((m, k) =>
              c.jsx(le, { className: "h-32" }, k),
            ),
          }),
        ],
      }),
  ...
  const o = (m) =>
      typeof m == "number" ? m.toLocaleString("pt-BR") : String(m ?? "-"),
    l = (m) => {
      var w;
      const k = (w = m.relevanceScore) == null ? void 0 : w.status;
      return k === "high" ? "positive" : k === "low" ? "negative" : "neutral";
    },
    p = (m) => {
      if (!m.relevanceScore) return;
      const k = m.relevanceScore.score || 0;
        ...
        children: c.jsxs("div", {
          children: [
            c.jsx("h1", {
              ...
              children: r("metrics.title", { defaultValue: "Métricas e KPIs" }),
            }),
            c.jsx("p", {
              className: "text-muted-foreground mt-2",
              children: r("metrics.description", {
                defaultValue:
          ...
          c.jsxs(q, {
            children: [
              c.jsxs(de, {
                children: [
                  c.jsx(ce, {
                    children: r("metrics.kpis_relevantes", {
                      defaultValue: "KPIs Relevantes",
                    }),
                  }),
                  c.jsx(ke, {
                    children: r("metrics.kpis_relevantes_desc", {
                      defaultValue:
                  ...
                  s && s.length > 0
                    ...
                    : c.jsxs("div", {
                        ...
                        children: [
                          ...
                          c.jsx("p", {
                            className: "text-sm text-muted-foreground",
                            children: r("metrics.upload_data", {
          ...
          c.jsxs(q, {
            children: [
              c.jsxs(de, {
                children: [
                  c.jsx(ce, {
                    children: r("metrics.resumo", { defaultValue: "Resumo" }),
                  }),
                  c.jsx(ke, {
                    children: r("metrics.resumo_desc", {
                  ...
                  children: [
                    ...
                    c.jsxs("div", {
                      ...
                      children: [
                        c.jsx("span", {
                          className: "text-sm font-medium",
                          children: r("metrics.kpis_positivos", {
                        ...
                        c.jsx("span", {
                          ...
                          children:
                            (s == null
                              ? void 0
                              : s.filter((m) => l(m) === "positive").length) ||
                            0,
                        }),
                      ],
                    }),
                    c.jsxs("div", {
                      ...
                      children: [
                        c.jsx("span", {
                          className: "text-sm font-medium",
                          children: r("metrics.kpisAtenção", {
                        ...
                        c.jsx("span", {
                          ...
                          children:
                            (s == null
                              ? void 0
                              : s.filter((m) => l(m) === "negative").length) ||
                            0,
                        }),
                      ],
                    }),
                    c.jsxs("div", {
                      ...
                      children: [
                        c.jsx("span", {
                          className: "text-sm font-medium",
                          children: r("metrics.kpis_neutros", {
