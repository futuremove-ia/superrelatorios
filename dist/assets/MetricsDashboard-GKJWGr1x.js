import { u as O, j as e } from "./vendor-data-DuuuwLk5.js";
import { r as v, L as b, b as re } from "./vendor-react-DfYPWlel.js";
import { s as H, B as i, u as le } from "./index-CaCe4Bjh.js";
import { C as j, b as g, c as f, a as p } from "./card-CTs8HHrG.js";
import { B as y } from "./badge-Dl11-P0M.js";
import { K as ne } from "./kpi-card-Dnmm5F9h.js";
import { P as ie } from "./progress-D0h63-PB.js";
import { S as M, a as A, b as R, c as k, d as x } from "./select-NitbrCX6.js";
import { I as ce } from "./input-D9BHdvW6.js";
import { S as m } from "./skeleton-DM3l7qP2.js";
import { A as de, a as oe } from "./alert-DSCI8Aob.js";
import { u as he } from "./useMetricsLibrary-DVOPAetK.js";
import {
  E as P,
  a7 as xe,
  T as L,
...
import {
  ...
  b as I,
  c as U,
} from "./vendor-charts-BOYeCxEi.js";
import "./vendor-radix-CfL9Rjb9.js";
const De = (t) =>
    O({
      queryKey: ["metric-values", t],
      queryFn: async () => {
        const { data: n, error: r } = await H.from("latest_metric_values")
          .select("*")
  ...
  Te = ({ metric: t, onClick: n, compact: r = !1 }) => {
    const o = () => {
        switch (t.healthStatus) {
          case "good":
            return e.jsx(me, { className: "w-4 h-4 text-green-500" });
          case "warning":
            return e.jsx(L, { className: "w-4 h-4 text-yellow-500" });
          case "critical":
            return e.jsx(L, { className: "w-4 h-4 text-red-500" });
          default:
            return e.jsx(xe, { className: "w-4 h-4 text-gray-500" });
        }
      },
      h = () => {
        switch (t.healthStatus) {
      ...
      d = r ? "p-4" : "p-6";
    return e.jsxs(j, {
      className: `cursor-pointer transition-all hover:shadow-md ${h()} ${d}`,
      onClick: n,
      children: [
        e.jsx(g, {
  ...
  _ = ({ trend: t, value: n, compact: r = !1 }) => {
    const o = () => {
        switch (t) {
          case "up":
            return e.jsx(je, { className: "w-4 h-4 text-green-500" });
          case "down":
            return e.jsx(ue, { className: "w-4 h-4 text-red-500" });
          case "stable":
            return e.jsx(z, { className: "w-4 h-4 text-gray-500" });
          default:
            return e.jsx(z, { className: "w-4 h-4 text-gray-500" });
        }
      },
    ...
    return r
      ? e.jsxs("div", {
          ...
          children: [
            o(),
            e.jsx("span", {
              className: `text-xs font-medium ${h()}`,
              children: c(n),
            }),
          ],
        })
  ...
  Pe = ({ metrics: t, domain: n, period: r }) => {
    if (!t.length)
      return e.jsx("div", {
            ...
            e.jsx($, {
              ...
              children: e.jsxs(be, {
                ...
                children: [
                  ...
                  e.jsx(Ce, { tick: { fontSize: 12 } }),
                  e.jsx(T, {
                    formatter: (a, l) => [`${a}`, "Valor"],
                    labelFormatter: (a) => `Métrica: ${a}`,
                  }),
                  e.jsx(Se, { dataKey: "value", fill: "#8884d8" }),
                ],
              }),
            }),
          ],
  ...
  Ye = () => {
    const { t } = le(),
      [n, r] = v.useState("all"),
      [o, h] = v.useState("current"),
      [c, d] = v.useState("cards"),
      [a, l] = v.useState(""),
      { metrics: _e, isLoading: G } = he(),
      { values: Me, isLoading: X } = De("default-org"),
      { analytics: Ae, isLoading: Y } = $e("default-org"),
      Z = G || X || Y,
      Q = [
        {
              ...
              children: [
                ...
                c === "cards" &&
                  e.jsx("div", {
                    ...
                    children: N.map((s) =>
                      e.jsx(Te, { metric: s, onClick: () => {} }, s.id),
                    ),
                  }),
                c === "chart" &&
                  e.jsxs(j, {
                    children: [
                      ...
                      e.jsx(p, { children: e.jsx(Pe, { metrics: N }) }),
                    ],
                  }),
                c === "table" &&
                  e.jsxs(j, {
                                      ...
                                      children: [
                                        ...
                                        e.jsx("td", {
                                          ...
                                          children: e.jsxs("div", {
                                            ...
                                            children: [
                                              e.jsx("div", {
                                                className: `w-6 h-6 ${se(s.domain)} rounded flex items-center justify-center`,
