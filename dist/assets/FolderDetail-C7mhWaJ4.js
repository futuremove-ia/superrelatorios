import { u as _, j as e, B as i } from "./index-D2W-YaK1.js";
import { r as o } from "./vendor-BgR6OOld.js";
import { C as d, a as n, b as L, c as P, d as R } from "./card-38iTbfya.js";
import { I as A } from "./input-OAk-x-jG.js";
import { B as F } from "./badge-BXC9IUk2.js";
import { D as j, a as f, b as N, c } from "./dropdown-menu-Cu1C-DPN.js";
import { A as M } from "./AISidebar-uYjyCg4j.js";
import { r as T } from "./mockReports-3cW05Ka2.js";
import { b as $, a as z } from "./router-D2JcpG7e.js";
import {
  Q as E,
  a4 as B,
  p as I,
...
const re = () => {
  ...
  o.useEffect(() => {
    (async () => {
      u(!0);
      try {
        const t = (await T.getAllReports()).slice(0, 4);
        k(t);
      } catch (r) {
        console.error("Error loading folder content:", r);
      } finally {
        u(!1);
      }
    })();
  ...
  const h = C.filter(
    (s) =>
      s.title.toLowerCase().includes(x.toLowerCase()) ||
      s.category.toLowerCase().includes(x.toLowerCase()),
  );
  return D
    ? e.jsxs("div", {
        ...
        children: [
          ...
          e.jsx("div", {
            ...
            children: [1, 2, 3].map((s) =>
              e.jsx("div", { className: "h-48 bg-muted rounded-xl" }, s),
            ),
          }),
        ],
      })
    : e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsxs(i, {
                          variant: "ghost",
                          size: "sm",
                          onClick: () => l("/app/pastas"),
                          children: [
                            e.jsx(E, { className: "h-4 w-4 mr-2" }),
                            a("common.back"),
                          ],
                        }),
                        e.jsxs("div", {
                          children: [
                            e.jsxs("h1", {
                              ...
                              children: [
                                e.jsx(B, { className: "h-6 w-6 text-primary" }),
                            ...
                            e.jsxs("p", {
                              ...
                              children: [
                                a("reports.counter", { count: 12 }),
                                " • ",
                                a("folders.meta.updated_ago", {
                                  time: "2 dias",
                                }),
                              ],
                            }),
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsx(A, {
                            placeholder: a("folders.search_placeholder"),
                            className: "pl-10",
                            value: x,
                      ...
                      children: e.jsxs(n, {
                        ...
                        children: [
                          ...
                          e.jsx("p", {
                            ...
                            children: a("reports.empty.title"),
                          }),
                        ],
                      }),
                    })
                        ...
                        children: h.map((s, r) =>
                          e.jsxs(
                            d,
                            {
                              ...
                              onClick: () => l(`/app/relatorios/${s.id}`),
                              children: [
                                e.jsx("div", {
                                  className: `h-1.5 w-full ${s.category.toLowerCase().includes("finan") ? "bg-blue-500" : "bg-indigo-500"}`,
                                }),
                                e.jsxs(L, {
                        ...
                        children: e.jsx(n, {
                          ...
                          children: e.jsx("div", {
                            ...
                            children: e.jsxs("table", {
                              ...
                              "aria-label": a("reports.table_desc"),
                              children: [
                                e.jsx("thead", {
                                  children: e.jsxs("tr", {
                                    className:
            ...
            e.jsx(M, { context: "reports", className: "hidden xl:block" }),
          ],
        }),
      });
};
