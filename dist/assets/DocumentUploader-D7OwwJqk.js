...
var be = (t, c, r) =>
  c in t
    ? ve(t, c, { enumerable: !0, configurable: !0, writable: !0, value: r })
    : (t[c] = r);
var $ = (t, c, r) => be(t, typeof c != "symbol" ? c + "" : c, r);
import {
  s as y,
  j as e,
  c as C,
...
import { u as de } from "./useMutation-Bxz-XFRa.js";
import {
  a as P,
  e as ee,
  s as se,
  c as Ce,
  p as Ee,
} from "./fileParserService-D6CvYP1B.js";
import { P as Te } from "./progress-B5cgP5cr.js";
import {
  bg as J,
  q as ue,
  U as me,
...
import { C as R, b as z, c as M, d as Y, a as L } from "./card-DZ7cD3I_.js";
import { u as ke } from "./useCurrentOrganization-B2dAq42k.js";
import "./router-Db_Yswnp.js";
import "./useQuery-DdwYXWd4.js";
const Se = "https://api.unstructuredapp.io/general/v0/general",
  re = 3,
  ae = 1e3,
  ie = 6e4;
async function ne(t) {
  return new Promise((c) => setTimeout(c, t));
}
class Fe {
  constructor() {
    $(this, "apiKey");
  ...
  async extractElements(c, r) {
    ...
    for (let i = 1; i <= re; i++)
      try {
        ...
        if ((clearTimeout(x), o.status === 429)) {
          const p = o.headers.get("Retry-After"),
        ...
        if (!o.ok) {
          ...
          throw new Error(`Unstructured API error: ${o.status} - ${p}`);
        }
...
class Ue {
  ...
  async processDocument(c, r, n, l) {
    ...
    try {
      ...
      const m = `${n}/${Date.now()}_${c.name}`,
        { error: j } = await y.storage.from("documents").upload(m, c);
...
`),
      ...
      const K = {
        title:
          ((o = S.summary) == null ? void 0 : o.substring(0, 50)) ||
          "Análise Automática",
  ...
  async processTextInput(c, r, n) {
    ...
    try {
      ...
      const { data: o } = await y
        ...
        m = await P([{ type: "text", content: c }], "Extração de KPIs", p);
      n == null ||
...
const he = new Ue();
function ge(t) {
  const [c, r] = g.useState(null),
    n = de({
      mutationFn: async ({ file: i, userId: a, organizationId: x }) => {
        if (i)
          return he.processDocument(i, a, x, (o) => {
            var d;
            (r(o),
              (d = t == null ? void 0 : t.onProgress) == null || d.call(t, o));
          });
        throw t
    ...
    n = de({
      mutationFn: async ({ text: i, userId: a }) =>
        he.processTextInput(i, a, (x) => {
          var o;
          (r(x),
            (o = t == null ? void 0 : t.onProgress) == null || o.call(t, x));
        }),
      onSuccess: (i) => {
        var a;
        (r(null),
...
const H = ["PDF", "CSV", "XLSX", "TXT"],
  Ie = 50 * 1024 * 1024;
function Re({ userId: t, organizationId: c, onSuccess: r, className: n }) {
  var Z, G, Q;
      ...
      e.jsxs("div", {
        ...
        children: [
          ...
          e.jsxs("div", {
            ...
            children: [o.toLocaleString(), " / ", V.toLocaleString()],
          }),
        ],
      }),
    ],
...
function oe({ currentStage: t, progress: c, className: r }) {
  const n = ce.findIndex((i) => i.key === t),
          ...
          return e.jsxs(
            "div",
            {
              className: C(
                ...
                o && "bg-blue-50 dark:bg-blue-950/20",
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx("p", {
                      className: C(
                        "text-sm font-medium",
                        o && "text-blue-900 dark:text-blue-100",
                        d && "text-green-900 dark:text-green-100",
                        !o && !d && "text-muted-foreground",
                      ),
                      children: i.label,
                    }),
                    e.jsx("p", {
                          ...
                          e.jsx(oe, {
                            currentStage:
                              o.progress.status === "completed"
                                ? "completed"
                                : o.progress.status === "parsing"
                                  ? "parsing"
                                  : o.progress.status === "extracting"
                                    ? "extracting"
                                    : o.progress.status === "mapping"
                                      ? "mapping"
                                      : o.progress.status === "queued"
                                        ? "queued"
                                        : "completed",
                            progress: o.progress.progress,
                          }),
                        d.progress &&
                          !o.progress &&
                          e.jsx(oe, {
