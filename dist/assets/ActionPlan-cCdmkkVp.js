import { u as y, d as k, j as e, B as t } from "./index-BNBvVWlM.js";
import { r as C } from "./router-C2uYhr1z.js";
import { C as l, b as n, c, d as h, a as d } from "./card-ChPN7OiP.js";
import { B as g } from "./badge-BPr2YYbt.js";
import { a as A, E as z, b as o } from "./mockBusiness-fyyBYCal.js";
import {
  af as u,
  f as E,
  Z as b,
...
const I = () => {
  const { t: a } = y(),
                ...
                N({
                  ...
                  action: e.jsxs(t, {
                    ...
                    children: [
                      ...
                      " ",
                      e.jsx(b, { className: "h-3 w-3 text-primary" }),
                    ],
                  }),
                }),
              {
    ...
    m = r.filter((s) => s.status === "completed").length,
    p = Math.round((m / r.length) * 100);
  return e.jsxs("div", {
    className:
              ...
              e.jsxs("h1", {
                ...
                children: [
                  e.jsx("div", {
                    ...
                    children: e.jsx(u, { className: "h-8 w-8 text-primary" }),
                  }),
                  a("action_plan.title"),
                ],
              }),
                          ...
                          e.jsx("div", {
                            ...
                            children: r.map((s) =>
                              e.jsxs(
                                "div",
                                {
                                  className: `group p-6 flex items-start gap-5 transition-all duration-300 ${s.status === "completed" ? "bg-muted/10 opacity-60" : "hover:bg-primary/[0.02] active:bg-primary/[0.04]"}`,
                                  children: [
                                    e.jsx("button", {
                                      onClick: () => _(s.id),
                                      className:
                                    ...
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        e.jsxs("div", {
                                          ...
                                          children: [
                                            e.jsx("h4", {
                                              className: `font-bold text-lg leading-none tracking-tight ${s.status === "completed" ? "line-through text-muted-foreground decoration-2" : ""}`,
                                              children: s.title,
                                            }),
                                            s.status !== "completed" &&
                                              e.jsx(g, {
                                        ...
                                        e.jsx("p", {
                                          className: `text-sm leading-relaxed ${s.status === "completed" ? "text-muted-foreground/60" : "text-muted-foreground"}`,
              ...
              e.jsxs(l, {
                ...
                children: [
                  e.jsx("div", {
                    ...
                    children: e.jsx(j, { className: "h-32 w-32 rotate-12" }),
                  }),
                  e.jsxs(n, {
                    className: "relative",
                    children: [
