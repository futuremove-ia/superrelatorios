-- =====================================================
-- SCRIPT CORRIGIDO - PAINEL DE INDICADORES SUPERRELATÓRIOS
-- Versão simplificada sem ON CONFLICT complexos
-- =====================================================

-- =====================================================
-- PARTE 1: CRIAR TIPOS E TABELAS
-- =====================================================

-- Criar tipos
CREATE TYPE IF NOT EXISTS input_type_enum AS ENUM ('cumulative', 'non_cumulative');
CREATE TYPE IF NOT EXISTS group_data_period_enum AS ENUM ('daily', 'weekly', 'monthly', 'quarterly', 'half_yearly', 'yearly');
CREATE TYPE IF NOT EXISTS total_is_enum AS ENUM ('sum_of_values', 'average_of_values', 'last_value', 'all_time', 'ytd_as_of');
CREATE TYPE IF NOT EXISTS trend_direction_enum AS ENUM ('higher_is_better', 'lower_is_better', 'no_trend');
CREATE TYPE IF NOT EXISTS source_type_enum AS ENUM ('manual', 'report', 'integration');
...
-- =====================================================
-- PARTE 5: INSERIR MÉTRICAS (SEM CONFLICT)
-- =====================================================

-- Verificar se já existem, se não, inserir
DO $$
BEGIN
    -- Financeiras
...
-- =====================================================
-- PARTE 6: INSERIR DADOS DE EXEMPLO
-- =====================================================
...
BEGIN
    ...
    -- Inserir valores de janeiro (verificar se não existem)
...
SELECT 
    '✅ SCRIPT CORRIGIDO EXECUTADO!' as mensagem,
