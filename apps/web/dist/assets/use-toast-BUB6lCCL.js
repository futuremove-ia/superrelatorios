import { r as c } from "./router-XBfdTQ0K.js";
const d = 1,
  p = 1e6;
let i = 0;
function A() {
    ...
    switch (s.type) {
      ...
      case "REMOVE_TOAST":
        return s.toastId === void 0
          ? { ...t, toasts: [] }
          : { ...t, toasts: t.toasts.filter((e) => e.id !== s.toastId) };
    }
  },
  r = [];
let T = { toasts: [] };
...
function E({ ...t }) {
  const s = A(),
    e = (u) => n({ type: "UPDATE_TOAST", toast: { ...u, id: s } }),
...
function _() {
  ...
  return (
    ...
    { ...t, toast: E, dismiss: (e) => n({ type: "DISMISS_TOAST", toastId: e }) }
  );
}
export { _ as u };
