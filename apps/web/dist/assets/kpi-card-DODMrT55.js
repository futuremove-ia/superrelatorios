import { j as e, C as u, g as b, p as a } from "./index-DRWQgA5q.js";
import { B as h } from "./badge-DD2chybY.js";
import { a2 as f, aB as j } from "./utils-Er8ll4su.js";
const v = ({
  title: l,
  value: i,
  icon: d,
  ...
  return e.jsx(u, {
    className: a("card-hover touch-target", m(), n),
    style: o,
    role: x,
    "aria-label": c,
    children: e.jsxs(b, {
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx(d, {
                      className: a("h-4 w-4 sm:h-5 sm:w-5", g()),
                      "aria-hidden": "true",
                    }),
                    e.jsx("p", {
                      className:
