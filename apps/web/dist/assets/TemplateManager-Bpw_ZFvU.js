...
import { r } from "./router-XBfdTQ0K.js";
import { B as c } from "./badge-DD2chybY.js";
import {
  $ as ae,
  ag as D,
  S as te,
...
const je = () => {
  ...
  const y = B.filter((s) => {
      const i =
          ...
          s.description.toLowerCase().includes(d.toLowerCase()) ||
          s.tags.some((Y) => Y.toLowerCase().includes(d.toLowerCase())),
            ...
            children:
              v === "grid"
                ? e.jsx("div", {
                    ...
                    children: y.map((s) => e.jsx(H, { template: s }, s.id)),
                  })
                : e.jsx("div", {
                    className: "space-y-2",
                    children: y.map((s) => e.jsx(J, { template: s }, s.id)),
                  }),
          }),
          y.length === 0 &&
            e.jsxs("div", {
