...
import { r as v, L as b, R as de } from "./router-XBfdTQ0K.js";
import { B as y } from "./badge-DD2chybY.js";
import { K as oe } from "./kpi-card-DODMrT55.js";
import { u as he } from "./useMetricsLibrary-XBP0Fd36.js";
import { u as H } from "./useQuery-pMG9BRxa.js";
import {
  aa as P,
  aC as xe,
  T as L,
...
const De = (t) =>
  ...
  Ke = () => {
    const { t } = re(),
      ...
      { values: Me, isLoading: Y } = De("default-org"),
      { analytics: Re, isLoading: X } = $e("default-org"),
      Z = G || Y || X,
      Q = [
        {
