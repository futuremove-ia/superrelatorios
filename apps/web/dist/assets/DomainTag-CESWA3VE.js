import { j as l, p } from "./index-DRWQgA5q.js";
import "./router-XBfdTQ0K.js";
import {
  ah as d,
  bb as x,
  a8 as u,
...
const s = {
  ...
  T = ({ selected: a, onChange: r, className: i }) => {
    const n = Object.keys(s),
      b = (e) => {
        a.includes(e) ? r(a.filter((t) => t !== e)) : r([...a, e]);
      },
      o = () => {
        r(n);
      },
          ...
          l.jsxs(
            "button",
            {
              ...
              children: [
                (() => {
                  const t = g[s[e].icon];
                  return t ? l.jsx(t, { className: "h-4 w-4" }) : null;
                })(),
                s[e].label,
              ],
            },
