...
- [ ] 2. Implementar/Validar Cálculo de KPIs (Serviços Existentes)
  ...
  - [ ]\* 2.1 Escrever property test — Property 9: Corretude das fórmulas de cálculo de KPIs
    - **Property 9: Corretude das fórmulas de cálculo de KPIs**
  ...
  - [ ]\* 2.4 Escrever testes unitários para casos de borda do cálculo de KPIs
...
- [ ] 8. Checkpoint — Verificar testes unitários e de propriedade dos serviços core
  ...
  - Verificar cobertura de código > 80% para serviços de cálculo de KPIs, `DetectionService`, `useCurrentOrganization`, `useAuth` e `useRadarItems`
