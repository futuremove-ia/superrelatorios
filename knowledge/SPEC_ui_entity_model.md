...
interface DocumentCardProps {
  ...
  fileType: string;
  processingStatus: 'queued' | 'extracting' | 'parsing' | 'mapping' | 'completed' | 'failed';
...
*Documento criado por: Kiro AI Assistant | 2026-04-01*
*Baseado em: schema real Supabase + análise de entidades do design.md*
