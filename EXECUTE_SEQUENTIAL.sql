...
-- Iniciar execução
RAISE NOTICE '=== INICIANDO EXECUÇÃO SEQUENCIAL DAS BIBLIOTECAS ESTRATÉGICAS ===';

-- =====================================================
-- PASSO 1: VERIFICAR E CRIAR TABELAS BASE
-- =====================================================

RAISE NOTICE 'PASSO 1: Verificando e criando tabelas base...';
...
BEGIN
    ...
    IF NOT v_kpi_master_exists OR NOT v_challenges_exists OR NOT v_goals_exists THEN
        ...
        IF NOT v_templates_exists THEN
            ...
            RAISE NOTICE '✅ strategic_templates criada (versão simplificada)';
        END IF;
    END IF;
...
RAISE NOTICE '=== VERIFICAÇÃO PÓS-CRIAÇÃO ===';
SELECT '=== VERIFICAÇÃO PÓS-CRIAÇÃO ===' as step;
SELECT * FROM verify_strategic_structure();

-- =====================================================
-- PASSO 2: EXECUTAR MIGRAÇÃO KPI
-- =====================================================

RAISE NOTICE 'PASSO 2: Executando migração unificada de KPIs...';

-- Executar apenas a parte de criação da tabela unificada
RAISE NOTICE 'Criando tabela kpi_master_unified...';
...
\echo '✅ kpi_master_unified criada com sucesso';

-- =====================================================
-- PASSO 3: POPULAR KPIs ESSENCIAIS (SEM DEPENDÊNCIA)
-- =====================================================
\echo 'PASSO 3: Populando KPIs essenciais PME...'
...
\echo '✅ 25 KPIs essenciais PME populados com sucesso';

-- =====================================================
-- PASSO 4: CRIAR VIEW DE COMPATIBILIDADE
-- =====================================================
\echo 'PASSO 4: Criando view de compatibilidade...'
...
\echo '✅ View de compatibilidade criada com sucesso';
